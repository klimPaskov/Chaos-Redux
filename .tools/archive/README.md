...
- `audit_event6_allocator.py`;
- `audit_event6_country_api.py`;
- `audit_event6_flags.py`;
- `audit_event6_form16.py`;
- `audit_event6_gui_matrix.py`;
- `audit_event6_scenario_matrix.py`;
