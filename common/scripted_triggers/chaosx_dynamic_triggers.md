...
- Event 012 explicit high-chaos actors: `GHP`, `BBS`, `TDM`, `ANW`, `OVN`, `CRR`, `CTL`, `OKP`, `TRM`, `HGD`, and `GHC`
...
- `ZIN`
- `DTH` / original `DTH` / countries with the Death country marker
- Event 012 explicit fictional/supernatural nonhuman actors: `GHP`, `BBS`, `TDM`, `ANW`, `OVN`, `CRR`, `CTL`, `OKP`, `TRM`, `HGD`, and `GHC`
