...
4. For a fictional or impossible portrait, invoke native ImageGen and follow the [ChatGPT Images 2.5 asset workflow](../chaos-redux-event-assets/references/imagegen-2-5-workflow.md) for narrow edits, reference roles, accepted-candidate lineage, and full-resolution/native-size review against the brief and vanilla references.
