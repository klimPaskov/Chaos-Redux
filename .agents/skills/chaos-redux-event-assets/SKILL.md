...
31. Every armed skeletal action identifies its verified Meshy `meshy_animate` or explicitly user-approved professional source, visibly aims, discharges, recoils/reacts, and recovers where applicable, preserves trigger-hand, foregrip/secondary-hand, and shoulder/stock contact, and has reimport evidence. Non-firing armed actions are not assigned particles or gunshot audio merely because the unit is armed.
