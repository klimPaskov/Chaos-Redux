...
The four opening survival milestones remain optional branches, but they are not inert history: counted landing states, audited expedition stores, and restored landing beacons each raise the DHR AI's willingness to request a paid landing, while secured scattered enclaves raise the AI priority of the existing enclave-supply bridge.
