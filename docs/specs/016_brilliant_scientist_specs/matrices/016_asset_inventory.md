...
| Alien Infantry | Reusable 2D unit, counter, equipment, technology, tactic, decision, event, focus, flag, portrait, and country-interface assets are installed and wired; sourced entity audio and reusable muzzle-particle/light definitions are installed but intentionally unbound | Pose-correct V8 generation, remesh, and neutral FBX rig preserve the upright right-hand laser pistol and free left arm. Official Meshy actions 232, 104, and 690 provide no genuine aim/discharge/recoil/recovery sequence, and 690 also violates the one-handed identity. No accepted seven-action set, muzzle node, discharge timestamp, packed model, PDX export/reimport evidence, entity, or synchronized runtime binding exists. |
