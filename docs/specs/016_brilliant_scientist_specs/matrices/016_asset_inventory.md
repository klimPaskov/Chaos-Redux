...
| Alien Infantry | Reusable 2D unit, counter, equipment, technology, tactic, decision, event, focus, flag, portrait, and country-interface assets are installed and wired; sourced entity audio and reusable muzzle-particle/light definitions are installed but intentionally unbound | Pose-correct V8 generation, remesh, and neutral Meshy R2 rig preserve the upright right-hand laser pistol and free left arm. The approved Quaternius CC0 `Pistol_Shoot`, idle, and walk actions now export and actual-byte reimport through the locked adapter. Runtime promotion remains blocked by the missing verified muzzle locator, synchronized particle/light/audio binding, and distinct defend, support-attack, retreat, and death actions. |
