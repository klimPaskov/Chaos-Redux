...
The authoritative workbook row is `FALLOUT-677`.

The dedicated asset package is `docs/assets/677_hungry_battalion/`.

The scheduler activation flags remain unset, the release-floor total remains `0 of 660`, and the exact engine-native all-valid-province thermonuclear sweep remains blocked.
