...
The dedicated generated report art and manifest live under `docs/assets/887_mixed_settlement/`. Runtime art is `gfx/event_pictures/mixed_settlement/report_event_fallout_mixed_settlement.dds` registered as `GFX_report_event_fallout_mixed_settlement`.
