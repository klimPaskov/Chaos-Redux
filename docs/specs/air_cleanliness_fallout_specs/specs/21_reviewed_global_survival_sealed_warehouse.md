...
The report sprite is `GFX_report_event_fallout_sealed_warehouse` in `interface/fallout_consolidated.gfx` and points to `gfx/event_pictures/fallout/report_event_fallout_sealed_warehouse.dds`.
