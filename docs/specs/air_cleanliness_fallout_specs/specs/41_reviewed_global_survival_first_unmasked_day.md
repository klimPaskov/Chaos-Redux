...
The dedicated report asset is registered as `GFX_report_event_fallout_first_unmasked_day` in `interface/fallout_consolidated.gfx` and lives at `gfx/event_pictures/fallout/report_event_fallout_first_unmasked_day.dds`.
