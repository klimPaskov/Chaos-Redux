...
The report sprite is `GFX_report_event_fallout_manual_nobody_read` in `interface/fallout_world_end.gfx` and points to `gfx/event_pictures/fallout_world_end/report_event_fallout_manual_nobody_read.dds`.
