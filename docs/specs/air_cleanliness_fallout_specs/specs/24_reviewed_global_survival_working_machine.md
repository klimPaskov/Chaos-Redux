...
The report sprite is `GFX_report_event_fallout_working_machine` in `interface/fallout_world_end.gfx` and points to `gfx/event_pictures/fallout_world_end/report_event_fallout_working_machine.dds`.
