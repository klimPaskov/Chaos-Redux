...
The report sprite is `GFX_report_event_fallout_dead_city_permit` in `interface/fallout_consolidated.gfx` and points to `gfx/event_pictures/fallout/report_event_fallout_dead_city_permit.dds`.
