...
- strong horror without explaining the hidden leader
...
### Super-event role 2, sealed-unifier network reveal

Use only when the cult connection becomes public through the Event 014 reveal route.

Trigger direction:

- the hidden leader has been revealed
- Evolution III active
- hidden-leader resonance or cult network reaches a high threshold
...
- central sealed-unifier-linked figure or obscured commander if portrait not finalized
- ritual table, military maps, cult officers, explicit fictional gore
- no final likeness unless the reveal-leader asset exists
...
- the hidden leader has been revealed and has enough power
...
- at least one cannibal country controlled significant territory or the hidden leader network was public
...
- hunt the revealed leader if the hidden-leader track provides a target
...
- complete hidden-leader network objectives if available
...
- Hidden Leader Network. Locked until the Event 014 reveal route is active or a test bypass is explicitly allowed.
...
- Maximum. Immediate cannibal country with high chaos opening and global reaction, but no world-end unless the hidden-leader type is selected and allowed.
...
- sealed-unifier network reveal, 457 by 328
...
- sealed-unifier dominion flag only after hidden-leader asset spec confirms it
...
- hidden-leader resonance seal, hidden until the hidden leader has been revealed, 8 to 12 frames, stronger ritual motion, static fallback
...
- cult and hidden-leader text must not use unresearched final cultural references
...
- hidden-leader reveals that do not require the hidden leader to exist yet
- world-end branch gated by chaos and hidden-leader requirements
