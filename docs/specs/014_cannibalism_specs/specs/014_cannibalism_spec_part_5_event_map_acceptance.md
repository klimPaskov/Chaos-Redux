...
| chaosx.nr14.12 | hidden leader unification reveal | super-event gateway | fires when Evolution III network strength allows unification |
| chaosx.nr14.13 | world-end terminal gateway | hidden plus super-event | sets world-end flags and scenario-specific state |
| chaosx.nr14.13b | Wendigo fusion terminal gateway | hidden plus super-event | only if Wendigo exists and fusion branch wins |
...
- Evolution III describes global network behavior, coordinated cannibal countries, and hidden-leader paths
- World-end detail describes the revealed hidden leader turning the cult into a terminal threat
- Wendigo fusion detail stays hidden unless the branch has fired
...
- actor can be the united cannibal country or hidden leader after unification
...
- Evo III should describe global network and hidden-leader paths
- World-End Scenario should describe the hidden-leader-linked terminal route and make clear it is not default
...
6. hidden leader seed state after Evolution II and full reveal state after Evolution III unification
...
- AI behavior
- hidden-leader seed, reveal, and unification paths
- world-end route and Wendigo fusion route
- super-event package
...
- hunger, discipline, cult, fear, spread, containment, island silence, hidden-leader resonance, unification, and Wendigo fusion values are initialized and cleaned
