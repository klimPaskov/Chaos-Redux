...
The event can have up to three evolution stages. It does not need five. Additional stages would add bloat unless a later Event 014 expansion adds a distinct mechanic that justifies another track.
...
- Evolution II has seeded the hidden-leader network
...
- increases cult pressure and hidden-leader resonance
...
- classify as actual nonhuman only after Evolution III or a hidden leader transformation explicitly crosses that line
...
## Evolution III, global hunger network and sealed-leader reveal
...
- Evolution II has seeded the hidden leader and the network strength gate is close to reveal
...
### hidden-leader integration

The hidden-leader connection belongs to Event 014 and should be implemented as part of this chain.

If the hidden leader has been revealed:

- the hidden leader can take command of one cannibal country, become a global event target, or inspire a network without direct control
- the hidden leader can use cannibalism outbreaks as recruitment grounds
- countries that exploited cult terror should receive extra hidden-leader resonance
- the hidden leader-aligned cannibal countries get a hidden or visible focus branch
- a hidden leader takeover super-event can fire once the connection becomes public
- the world-end route requires the hidden leader power plus global cult strength, and no generic substitute should replace this route

If the reveal gate has not fired:

- Evolution III still works as a global cult network
- world-end preparation can be recorded but should not trigger the hidden leader world-end route
- Event 014 should preserve cult variables, cannibal countries, and spread history so the reveal gate can read them later
...
Working label, not final localisation: `Frontline Hunger`.
...
- the hidden leader influence exists
...
- increased cult pressure and hidden-leader resonance
...
Aftermath should matter. A clean containment country can resist future spread better. A secrecy containment country can suffer a later leak. An exploitation country can become a hidden leader recruitment node.
...
- hidden-leader resonance remains hidden until the Event 014 hidden-leader track or a high-chaos reveal
...
- animated hidden-leader reveal state only after the hidden leader has been revealed
