...
| Network defiance | Evolution II | Anti-absorption | Independent survival | War with aligned network | Defiant AI |

The final tuning pass normalizes authored meter and modifier steps to round values while retaining only documented semantic counters, building levels, batch counts, and multiplier encodings as exceptions.

## Unified Hannibal tree, 108 focuses

| Route | Main mechanic | Major payoff | Tradeoff or hard gate |
| --- | --- | --- | --- |
| Convergence and disposition | Submission, resistance, governors, purges, and rivals | Safe host formation and constituent inheritance | Player control and disposition conditions |
| Central command | Standardized hierarchy | Efficient global army | Distant-control burden |
| Host confederation | Regional autonomy | Origin bonuses and commander roster | Slower central action |
| Ritual state | Formal feeding institutions | Long-term population and cell control | Organized resistance |
| Continental Larder | State consumption, transport, and workshop conversion | Global recruitment and supply | Finite population and targetable routes |
| Legions and Bone Guard | Paid zero-start formations | Overpowered main army | Population, Larder, stockpile, and cap gates |
| Naval hunt | Paid hunts, anchorages, and convoy receipts | Ocean-crossing threat | Shipyard, convoy, and fuel needs |
| Air terror | Air-program foundation and interdiction | Cell support and front collapse | Captured-aircraft and stockpile gates |
| Global cells | Foreign infiltration | Internal collapse before war | Exposure and counterintelligence |
| Global campaign | Scored targets, border incidents, ultimata, and integration | Route-aware expansion | Physical reach, target locks, and World Hostility |
| Counterwar | Coalition-hub attacks and hostility conversion | Pressure relief and authority | Paid operation proof |
| Ordinary terminal | Four Last Table operation packages | Global conquest state | Chaos greater than 1000 and all operational packages |

The unified tree's short, normal, and terminal cadences are 21, 35, and 56 days. Its four terminal proof packages require successful paid Larder, army, expansion, cell, integration, and counterwar operations rather than focus completion alone.

## Wendigo overlay, 28 focuses

| Route | Main mechanic | Major payoff | Counterplay or limit before lock |
| --- | --- | --- | --- |
...
| Alternate terminal | Pulse-owned world end | Effective invincibility | No intended counterplay after lock |

No focus was added for the closure remediation. The 28 existing focuses were rewired to open the receipt ledger, paid Pack operations, structural Pack and inherited-template stages, inherited winter cells, scored priorities, and the terminal-hunt family.
