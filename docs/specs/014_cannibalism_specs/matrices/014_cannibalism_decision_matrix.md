...
| Evolution I | suppression, deprogramming, chaplain or political officer, secrecy, exploitation if allowed | cult cell events, courier routes, future Hannibal resonance | show posture-specific decisions first |
...
| Evolution III | global courier hunt, allied warnings, terror unit dismantling, world-threat response | Hannibal takeover hooks, world-end preparation | hide ordinary low-impact decisions |
...
| Exploitation | stability, war support, condemnation, cult pressure, Hannibal resonance, future betrayal | safe bonuses |
...
| Dismantle terror units | exploit country | remove or convert units, stability cost | 90 to 150 days | lowers Hannibal resonance | units defect | AI uses only if not on exploitation path |
