...
| Bespoke unit counters and equipment art | 9 counter triplets (27 DDS); no equipment art | Nine inactive custom subunits expose stable sprite tokens and locked-template consumers | Gameplay/CXT registration and the 27 counter DDS/registry consumers are present. Feast Guard, Feast Cohort, Bone Guard, Siege Eaters, and March Predation Column have parent-installed mesh, eight action exports, material maps, entity/GFX bindings, and seven-role 44.1 kHz sound packages; Bone Riders, Island Reavers, Scavenger Warband, and Network Cadre remain blocked or pending their documented geometry/action/provider gates. Scavenged Elephant Column uses installed vanilla `elephantry` and adds no custom elephant token | No additional reveal surface exists; all custom tokens remain Event 014-gated |
