...
2. hidden-leader network reveal, generated cult command scene with no pre-reveal final likeness, plus final revealed portrait direction
...
- council route
- warlord route
- hidden-leader route, concealed until Evolution III reveal
- supply and economy
- depot raids
- prisoner ledger
...
- Hidden Leader Dominion flag for Evolution III unification
- generic cannibal warlord portraits, 156 by 210, bloody bald men in rough tribal or scavenged war clothing
- hidden leader reveal portrait, 156 by 210, generated fictional person
- Wendigo fusion portrait change, 156 by 210 or animated portrait package
...
- hidden-leader resonance seal, 8 to 12 frames, hidden until Evolution II seed strength exists and stronger after Evolution III reveal
- Wendigo fusion portrait overlay, 12 frames, fused cannibal and Wendigo visual state
...
## Pre-reveal secrecy and power notes

Do not put the hidden leader true name or direct identity into asset filenames intended for public-facing handoff, visible sprite names, achievement icon names, or pre-reveal localisation notes. Use hidden-leader or concealed-unifier working labels. Assets for the cannibal country should not look like a harmless minor. Generic warlords should look brutal and dangerous. The hidden-leader reveal and Wendigo fusion assets should look like high-chaos terminal identities with explicit fictional gore.
