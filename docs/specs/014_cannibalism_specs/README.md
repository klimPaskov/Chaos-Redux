...
- Presentation: four action super-events, eight unique 44.1 kHz super-event source/runtime audio files (four runtime WAVs), 21 closure assets, two real-frame leader portrait animations rooted in the exact canonical `hannibal.dds` and `hannibal_wendigo.dds` files, a full 56-portrait regional refresh, and 195 flat image-generated flag files.
