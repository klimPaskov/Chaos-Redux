...
- Presentation: four action super-events, eight 44.1 kHz runtime audio files (four OGG and four WAV), 21 closure assets, two real-frame leader portrait animations rooted in the exact canonical `hannibal.dds` and `hannibal_wendigo.dds` files, a full 56-portrait regional refresh, and 195 flat image-generated flag files.
