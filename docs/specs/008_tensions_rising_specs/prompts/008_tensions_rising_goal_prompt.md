...
Non-negotiables: Event 8 stays Minor Repeatable. Baseline Calm World firing is +100 world tension and only fires below 100% WT. Stage I: +10 chaos/+100 WT and can fire at 100% WT. Stage II: +15 chaos/+200 WT. Stage III: +25 chaos/+500 WT. Stage IV: +50 chaos/+1000 WT. No super-event or world-end scenario. Add capped temporary timer pressure, timed relation shocks, delayed follow-up incidents, rare safe non-transfer high-stage border wars, event-log/evolution detail wiring, AI posture hooks, assets, achievements, and docs as specified. No direct war goals, countries, focus trees, cores, or formables.
