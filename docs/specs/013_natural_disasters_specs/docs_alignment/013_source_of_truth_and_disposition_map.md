...
| Super-event research | `matrices/013_super_event_research_handoff_matrix.md`, `prompts/natural_disasters_super_event_prompt.md` | Keep all titles, remarks, quotes, cultural references, and audio blocked until researched and documented through the super-event workflow. |
...
This package is ready for implementation planning, not implementation completion. A coding agent still needs live repository mapping, vanilla references, offline wiki checks, subagent passes, asset production, super-event research, localisation, docs, spreadsheet work, and a completion audit before marking Event 013 complete.
