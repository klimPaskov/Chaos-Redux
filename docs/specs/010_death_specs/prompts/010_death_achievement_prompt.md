...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `death_no_one_heard_the_first_boat` | No One Heard the First Boat | Hidden | Any report recipient | Discover Death and declare war before mainland reveal. | Death reveals itself first. | Hard | Survey boat at empty pier. |
| `death_not_on_my_continent` | Not on My Continent | Visible | Continental neighbor/nearby country | Defeat Death after reveal before it consumes three mainland states on your continent. | Black Oath. | Medium-hard | Barricaded coastline. |
...
| `death_last_ferry` | The Last Ferry | Visible | Island/coastal country | Evacuate at least five threatened island/coastal states before Death consumes them and survive reveal. | Become Herald. | Hard | Ferry leaving black shore. |
| `death_counted_every_name` | Counted Every Name | Hidden | Compact leader/major | Use compact/census actions to delay ghost tier and defeat Death before 800-tier ghosts appear. | High black-method exposure. | Very hard | Empty ledger. |
...
| `death_before_the_name` | Before the Name | Hidden | Any country | Defeat Death before public reveal super-event. | Trigger reveal or maximum manual scenario. | Very hard | Covered map label with black stain. |
