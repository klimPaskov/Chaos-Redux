...
| `chaosx_020_one_crown_many_tails` | One Crown, Many Tails | base Rat Nation | absorb 5 rival Rat Nations, win Evolution IV candidacy, become Rat King | another candidate crowned | visible to rat actor | extreme | absorbed tags, candidate score, transfer identity | five entwined tails below a dark crown |
...
| `chaosx_020_crown_one_continent` | Crown of One Continent | Rat King | continent control verified, Evolution V recorded, terminal scenario not yet triggered | loses control before award check, world_end already active | visible to rat actor | extreme | continent target, control percentage, capital list, Evolution V | continent silhouette beneath a tail crown |
