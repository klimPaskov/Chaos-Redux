...
| III, Rat Nation carrier | 600 | connected infection basin, state collapse, large deaths, weak containment | 120 to 210 days | rat emergence pressure, reusable `RTA` carrier, no plague removal | stronger basin pressure after spread, no immediate rat at firing | RTA carrier, internal brood markers, brood pulse, rat tree, dominance, anti-rat actions | destroy broods, liberate and quarantine, clear burrows and disease | `RTA` carrier |
| IV, Rat King | 800 | several internal broods or absorbed marker, valid high-dominance candidate, proto-sentience | 90 to 180 days | separate `RTX` Rat King tag unifies rat states and units | permission is available, but requires the RTA carrier and candidate | deep tree, sentient government, coronation super-event, royal pulse | strike crown, divide network, global cooperation | `RTX` Rat King |
