...
Implement the full Event 20 decision and mission system from the accepted spec and `matrices/decision_mission_matrix.md`. Read `AGENTS.md`, `chaos-redux-events`, and `chaos-redux-decisions-missions` first. Inspect the live shared biological warfare and disease category before editing.
