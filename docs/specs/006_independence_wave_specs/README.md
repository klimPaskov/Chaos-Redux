...
The current non-portrait asset authority is the 2026-08-29 source-repair handoff `../../plans/006_independence_wave_plans/subagent_handoffs/006_event6_asset_source_repairs_2026-08-29.md` at commit `49d9a577c`, plus the 2026-08-30 rights and path handoffs `../../plans/006_independence_wave_plans/subagent_handoffs/006_event6_asset_rights_research_2026-08-30.md` and `../../plans/006_independence_wave_plans/subagent_handoffs/006_event6_asset_docs_path_reconcile_2026-08-30.md`. ASSET-004 strict grayscale is repaired with zero unequal RGB pixels; AEX collision, NWE alias, ASSET-046 emblem, BWX/chunk-3 source, animation-manifest, and super-event rights issues remain open, and no GFX registry edit is claimed by this documentation reconciliation.
