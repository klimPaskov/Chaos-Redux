...
The current registry gap map is `../../../plans/006_independence_wave_plans/subagent_handoffs/006_current_registry_gap_map_2026_08_15.md`. It confirms that IW-046 CHU, IW-049 BWX, IW-051 YAK, IW-052 BYA, and IW-057 FER remain outside gameplay and central admission until their identity, map, package, asset, and probability contracts are complete; no package-count authority is widened by that research disposition.
