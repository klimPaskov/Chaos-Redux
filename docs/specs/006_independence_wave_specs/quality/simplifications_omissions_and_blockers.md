...
The current registry gap map is `../../../plans/006_independence_wave_plans/subagent_handoffs/006_current_registry_gap_map_2026_08_15.md`. It confirms that IW-046 CHU, IW-049 BWX, and IW-057 FER remain outside gameplay and central admission until their identity, map, package, asset, and probability contracts are complete. IW-051 YAK and IW-052 BYA now have package-local implementations but remain outside central admission behind their identity, asset, map/origin, and probability gates; no package-count authority is widened by that research disposition.
