...
As of 2026-08-24, the latest portrait wiring evidence remains dated 2026-08-22, with no newer portrait wiring handoff or runtime portrait binary change observed. The 2026-08-24 research-table schema repair and static refresh cover fixed-width table parsing and the FORM-48, FORM-01/02/04, FORM-03, and IW-035 cost-localisation checks, but remain source/static evidence and do not close live event, GUI, tooltip, probability, balance, or whole-event gates.
