...
The 2026-08-28 portrait-consumer revalidation remains dated evidence for 110 supplied PNG/DDS pairs, 70 Event 006 runtime DDS files, 38 exact supplied runtime matches, and 64 unique Event 006 GFX portrait pairs. Its 47 resolved character-registry-reference count is superseded by the current 58-block source inspection and `../../../plans/006_independence_wave_plans/subagent_handoffs/006_event6_portrait_consumer_reconciliation_2026-08-29.md`, recorded by commit `3dbf918b5`. NAV Aguirre and GLC Castelao remain the only current `styled_final` consumers, GLC Bóveda remains an unmapped supplied styled output, and the eleven reconciled consumers remain grounded `source_placeholder` aliases without new art or binaries. The 2026-08-24 research-table schema repair and static refresh remain source/static evidence and do not close live event, GUI, tooltip, probability, balance, or whole-event gates.
