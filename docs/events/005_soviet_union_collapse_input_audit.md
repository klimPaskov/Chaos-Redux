...
| `tmp/error.log` | missing | 0 | 0 | n/a |
| `tmp/text.log` | missing | 0 | 0 | n/a |
...
The exact requested log files `tmp/error.log` and `tmp/text.log` were not present. The latest recovery search was:
