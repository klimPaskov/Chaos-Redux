...
| Runtime focus trees for republics and breakaways | Focus counts after duplicate pruning: Ukraine 81, Belarus 38, Kazakhstan 57, fallback breakaway 36, Baltic 36, Caucasus 40, Central Asia 45, Moldova 23, internal republic 50 | Implemented for these trees |
...
| Non-linear focus structure, route locks, branch zones, focus filters, AI behavior | Focus files use route-specific branches, `search_filters`, `ai_will_do`, and mutual exclusions. Latest non-Python focus checks cover 892 focus blocks across 30 trees, with zero duplicate IDs in the Event 005 focus files. The current Moldova, internal republic, fallback breakaway, Caucasus, and Central Asian tag-specific branch passes also check focus references, localisation, icons, coordinates, rewards, and AI weights directly. | Implemented for current focus trees |
...
PASS event005_focus_integrity_surface: focuses=892 bad_shape= missing_refs=
PASS focus_reward_variety_surface: material=529 focus_helpers=287 idea_only=37
PASS focus_ai_surface: contextual_ai=216
...
focus_reward_variety_surface material=529 focus_helpers=287 idea_only=37
focus_ai_surface contextual_ai=216
...
focus_surface_audit focuses 892
...
```text
focus_paths
common/national_focus/005_soviet_collapse_republics.txt 406
...
banned_low_dynamic_baseline_phrase_hits 0
focus_blocks 892 duplicate_ids 0
...
focus_blocks 892
focus_with_ai 892 missing_ai 0
focus_dynamic_ai 250 flat_ai 894
route_or_gate_focuses 278 dynamic 224 flat 54
mutually_exclusive_focuses 114 dynamic 114 flat 0
available_gate_focuses 135 dynamic 81 flat 54
...
- focus counts and branch maps: 892 retained focus blocks across the Event 005 runtime focus files, with no duplicate IDs or invalid focus references.
