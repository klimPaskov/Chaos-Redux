...
| Runtime focus trees for republics and breakaways | Focus counts after duplicate pruning: Ukraine 81, Belarus 38, Kazakhstan 57, fallback breakaway 36, Baltic 36, Caucasus 40, Central Asia 45, Moldova 23, internal republic 41 | Implemented for these trees |
...
| Non-linear focus structure, route locks, branch zones, focus filters, AI behavior | Focus files use route-specific branches, `search_filters`, `ai_will_do`, and mutual exclusions. Latest non-Python focus checks cover 883 focus blocks across 30 trees, with zero duplicate IDs in the Event 005 focus files. The current Moldova, internal republic, fallback breakaway, Caucasus, and Central Asian tag-specific branch passes also check focus references, localisation, icons, coordinates, rewards, and AI weights directly. | Implemented for current focus trees |
...
PASS event005_focus_integrity_surface: focuses=883 bad_shape= missing_refs=
PASS focus_reward_variety_surface: material=520 focus_helpers=278 idea_only=37
PASS focus_ai_surface: contextual_ai=207
...
focus_reward_variety_surface material=520 focus_helpers=278 idea_only=37
focus_ai_surface contextual_ai=207
...
focus_surface_audit focuses 883
...
```text
focus_paths
common/national_focus/005_soviet_collapse_republics.txt 397
...
banned_low_dynamic_baseline_phrase_hits 0
focus_blocks 883 duplicate_ids 0
...
focus_blocks 883
focus_with_ai 883 missing_ai 0
focus_dynamic_ai 241 flat_ai 894
route_or_gate_focuses 269 dynamic 215 flat 54
mutually_exclusive_focuses 114 dynamic 114 flat 0
available_gate_focuses 126 dynamic 72 flat 54
ai_pressure_ref_counts soviet_collapse_total_collapse_threat:11,soviet_collapse_moscow_authority:45,soviet_collapse_republic_confidence:2,soviet_collapse_military_obedience:12,soviet_collapse_depot_vulnerability:17,soviet_collapse_foreign_appetite:36,soviet_collapse_league_cohesion:0,soviet_collapse_old_movement_pressure:49
ai_condition_counts has_war:61,has_war_with:54,stability:73,war_support:1,faction:5,country_flags:102,global_flags:84,SOV_scoped:163,check_variable:172,factor_zero:80
```
...
- focus counts and branch maps: 883 retained focus blocks across the Event 005 runtime focus files, with no duplicate IDs or invalid focus references.
