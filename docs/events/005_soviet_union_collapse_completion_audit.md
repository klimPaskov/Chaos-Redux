...
| Non-linear focus structure, route locks, branch zones, focus filters, AI behavior | Focus files use route-specific branches, `search_filters`, `ai_will_do`, and mutual exclusions. Latest non-Python focus checks cover 934 focus blocks across 30 trees, with zero duplicate IDs in the Event 005 focus files. The current Moldova, internal republic, fallback breakaway, Caucasus, Central Asian, Far Eastern Republic Revival, Siberian Zemstvo Authority, Idel-Ural League, Birobidzhan Autonomous Commune, and Arctic Naval Directorate tag-specific branch passes also check focus references, localisation, icons, coordinates, rewards, and AI weights directly. | Implemented for current focus trees |
...
PASS event005_focus_integrity_surface: focuses=934 bad_shape= missing_refs=
PASS focus_reward_variety_surface: material=637 focus_helpers=423 idea_only=37
PASS focus_ai_surface: contextual_ai=348
...
focus_reward_variety_surface material=637 focus_helpers=423 idea_only=37
focus_ai_surface contextual_ai=348
...
focus_surface_audit focuses 934
...
common/national_focus/005_soviet_collapse_custom_splinters.txt 434
focuses 934
duplicates 0
missing_prereq 0
self_prereq 0
...
banned_low_dynamic_baseline_phrase_hits 0
focus_blocks 934 duplicate_ids 0
...
focus_blocks 934
focus_with_ai 934 missing_ai 0
focus_dynamic_ai 292 flat_ai 642
route_or_gate_focuses 320 dynamic 266 flat 54
...
- focus counts and branch maps: 934 retained focus blocks across the Event 005 runtime focus files, with no duplicate IDs or invalid focus references.
