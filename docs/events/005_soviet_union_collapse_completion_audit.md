...
| Runtime focus trees for republics and breakaways | Focus counts after duplicate pruning: Ukraine 81, Belarus 38, Kazakhstan 57, fallback breakaway 36, Baltic 36, Caucasus 34, Central Asia 45, Moldova 23, internal republic 41 | Implemented for these trees |
...
| Non-linear focus structure, route locks, branch zones, focus filters, AI behavior | Focus files use route-specific branches, `search_filters`, `ai_will_do`, and mutual exclusions. Latest non-Python focus checks cover 877 focus blocks across 30 trees, with zero duplicate IDs in the Event 005 focus files. The current Moldova, internal republic, fallback breakaway, and Central Asian tag-specific branch passes also check focus references, localisation, icons, coordinates, rewards, and AI weights directly. | Implemented for current focus trees |
...
PASS event005_focus_integrity_surface: focuses=877 bad_shape= missing_refs=
PASS focus_reward_variety_surface: material=514 focus_helpers=272 idea_only=37
PASS focus_ai_surface: contextual_ai=201
...
focus_reward_variety_surface material=514 focus_helpers=272 idea_only=37
focus_ai_surface contextual_ai=201
...
focus_surface_audit focuses 877
...
```text
focus_paths
common/national_focus/005_soviet_collapse_republics.txt 391
...
banned_low_dynamic_baseline_phrase_hits 0
focus_blocks 877 duplicate_ids 0
...
focus_blocks 877
focus_with_ai 877 missing_ai 0
focus_dynamic_ai 235 flat_ai 894
route_or_gate_focuses 263 dynamic 209 flat 54
mutually_exclusive_focuses 114 dynamic 114 flat 0
available_gate_focuses 120 dynamic 66 flat 54
ai_pressure_ref_counts soviet_collapse_total_collapse_threat:11,soviet_collapse_moscow_authority:45,soviet_collapse_republic_confidence:2,soviet_collapse_military_obedience:12,soviet_collapse_depot_vulnerability:17,soviet_collapse_foreign_appetite:34,soviet_collapse_league_cohesion:0,soviet_collapse_old_movement_pressure:49
ai_condition_counts has_war:60,has_war_with:52,stability:72,war_support:1,faction:5,country_flags:102,global_flags:84,SOV_scoped:161,check_variable:170,factor_zero:80
```
...
- focus counts and branch maps: 877 retained focus blocks across the Event 005 runtime focus files, with no duplicate IDs or invalid focus references.
