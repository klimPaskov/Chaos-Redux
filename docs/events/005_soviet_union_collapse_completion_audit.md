...
| Non-linear focus structure, route locks, branch zones, focus filters, AI behavior | Focus files use route-specific branches, `search_filters`, `ai_will_do`, and mutual exclusions. Latest non-Python focus checks cover 904 focus blocks across 30 trees, with zero duplicate IDs in the Event 005 focus files. The current Moldova, internal republic, fallback breakaway, Caucasus, and Central Asian tag-specific branch passes also check focus references, localisation, icons, coordinates, rewards, and AI weights directly. | Implemented for current focus trees |
...
PASS event005_focus_integrity_surface: focuses=904 bad_shape= missing_refs=
PASS focus_reward_variety_surface: material=607 focus_helpers=393 idea_only=37
PASS focus_ai_surface: contextual_ai=318
...
focus_reward_variety_surface material=607 focus_helpers=393 idea_only=37
focus_ai_surface contextual_ai=318
...
focus_surface_audit focuses 904
...
banned_low_dynamic_baseline_phrase_hits 0
focus_blocks 904 duplicate_ids 0
...
focus_blocks 904
focus_with_ai 904 missing_ai 0
focus_dynamic_ai 262 flat_ai 642
route_or_gate_focuses 290 dynamic 236 flat 54
...
- focus counts and branch maps: 904 retained focus blocks across the Event 005 runtime focus files, with no duplicate IDs or invalid focus references.
