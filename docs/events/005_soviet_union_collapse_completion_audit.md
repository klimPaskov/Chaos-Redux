...
| Runtime focus trees for republics and breakaways | Focus counts after duplicate pruning: Ukraine 81, Belarus 38, Kazakhstan 57, fallback breakaway 36, Baltic 36, Caucasus 34, Central Asia 41, Moldova 23, internal republic 41 | Implemented for these trees |
...
| Non-linear focus structure, route locks, branch zones, focus filters, AI behavior | Focus files use route-specific branches, `search_filters`, `ai_will_do`, and mutual exclusions. Latest non-Python focus checks cover 873 focus blocks across 30 trees, with zero duplicate IDs in the Event 005 focus files. The current Moldova, internal republic, fallback breakaway, and Central Asian tag-specific branch passes also check focus references, localisation, icons, coordinates, rewards, and AI weights directly. | Implemented for current focus trees |
...
soviet_collapse_central_asia_focus_tree 41
...
PASS event005_focus_integrity_surface: focuses=873 bad_shape= missing_refs=
PASS focus_reward_variety_surface: material=510 focus_helpers=268 idea_only=37
PASS focus_ai_surface: contextual_ai=197
...
focus_reward_variety_surface material=510 focus_helpers=268 idea_only=37
focus_ai_surface contextual_ai=197
...
focus_surface_audit focuses 873
...
```text
focus_paths
common/national_focus/005_soviet_collapse_republics.txt 387
...
banned_low_dynamic_baseline_phrase_hits 0
focus_blocks 873 duplicate_ids 0
...
focus_blocks 873
focus_with_ai 873 missing_ai 0
focus_dynamic_ai 231 flat_ai 894
route_or_gate_focuses 259 dynamic 205 flat 54
mutually_exclusive_focuses 114 dynamic 114 flat 0
available_gate_focuses 116 dynamic 62 flat 54
ai_pressure_ref_counts soviet_collapse_total_collapse_threat:11,soviet_collapse_moscow_authority:45,soviet_collapse_republic_confidence:2,soviet_collapse_military_obedience:12,soviet_collapse_depot_vulnerability:16,soviet_collapse_foreign_appetite:34,soviet_collapse_league_cohesion:0,soviet_collapse_old_movement_pressure:49
...
- focus counts and branch maps: 866 retained focus blocks across the Event 005 runtime focus files, with no duplicate IDs or invalid focus references.
