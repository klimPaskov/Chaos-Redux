...
| Runtime focus trees for republics and breakaways | Focus counts after duplicate pruning: Ukraine 81, Belarus 53, Kazakhstan 57, fallback breakaway 36, Baltic 42, Caucasus 40, Central Asia 45, Moldova 23, internal republic 62. The Belarus count now includes military-transit, rail-neutrality, rail-war, forest-command, and League freight branches; the Baltic count includes tag-gated Estonia, Latvia, and Lithuania branch pairs. | Implemented for these trees |
