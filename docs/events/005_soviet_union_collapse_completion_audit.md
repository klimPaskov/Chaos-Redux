...
| Non-linear focus structure, route locks, branch zones, focus filters, AI behavior | Focus files use route-specific branches, `search_filters`, `ai_will_do`, and mutual exclusions. Latest non-Python focus checks cover 995 focus blocks across 30 trees, with zero duplicate IDs in the Event 005 focus files. The current Moldova, internal republic, fallback breakaway, Caucasus, Central Asian, Kronstadt Free Soviet, Free Territory of Huliaipole, Black Banner Host, Basmachi Confederation, Turkestan National Council, Alash Restoration Authority, Union Defense Committee, Security Directorate Zone, Green Army Congress, Don Host Emergency Circle, Far Eastern Republic Revival, Siberian Zemstvo Authority, Idel-Ural League, Birobidzhan Autonomous Commune, and Arctic Naval Directorate tag-specific branch passes also check focus references, localisation, icons, coordinates, rewards, and AI weights directly. | Implemented for current focus trees |
...
PASS event005_focus_integrity_surface: focuses=995 bad_shape= missing_refs=
PASS focus_reward_variety_surface: material_at_least=658 focus_helpers=476 idea_only_upper_scan=57
PASS focus_ai_surface: contextual_ai_at_least=335
...
focus_surface_audit focuses 995
...
common/national_focus/005_soviet_collapse_custom_splinters.txt 495
focuses 995
duplicates 0
missing_prereq 0
self_prereq 0
...
banned_low_dynamic_baseline_phrase_hits 0
focus_blocks 995 duplicate_ids 0
...
focus_blocks 995
focus_with_ai 995 missing_ai 0
focus_dynamic_ai 383 flat_ai 612
...
- focus counts and branch maps: 995 retained focus blocks across the Event 005 runtime focus files, with no duplicate IDs or invalid focus references.
