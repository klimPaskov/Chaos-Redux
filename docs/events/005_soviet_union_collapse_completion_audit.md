...
| Non-linear focus structure, route locks, branch zones, focus filters, AI behavior | Focus files use route-specific branches, `search_filters`, `ai_will_do`, and mutual exclusions. Latest non-Python focus checks cover 922 focus blocks across 30 trees, with zero duplicate IDs in the Event 005 focus files. The current Moldova, internal republic, fallback breakaway, Caucasus, Central Asian, Far Eastern Republic Revival, Siberian Zemstvo Authority, and Idel-Ural League tag-specific branch passes also check focus references, localisation, icons, coordinates, rewards, and AI weights directly. | Implemented for current focus trees |
...
PASS event005_focus_integrity_surface: focuses=922 bad_shape= missing_refs=
PASS focus_reward_variety_surface: material=625 focus_helpers=411 idea_only=37
PASS focus_ai_surface: contextual_ai=336
...
focus_reward_variety_surface material=625 focus_helpers=411 idea_only=37
focus_ai_surface contextual_ai=336
...
focus_surface_audit focuses 922
...
common/national_focus/005_soviet_collapse_custom_splinters.txt 422
focuses 922
duplicates 0
missing_prereq 0
self_prereq 0
...
banned_low_dynamic_baseline_phrase_hits 0
focus_blocks 922 duplicate_ids 0
...
focus_blocks 922
focus_with_ai 922 missing_ai 0
focus_dynamic_ai 280 flat_ai 642
route_or_gate_focuses 308 dynamic 254 flat 54
...
- focus counts and branch maps: 922 retained focus blocks across the Event 005 runtime focus files, with no duplicate IDs or invalid focus references.
