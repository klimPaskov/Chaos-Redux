...
This file is the current mechanic and registration overview, not standalone completion proof. `docs/plans/011_secret_alliance_plans/subagent_handoffs/decision_mission_audit.md` is the clean strict re-audit that resolves DM-01 through DM-14 and RA-01 through RA-02. `docs/plans/011_secret_alliance_plans/subagent_handoffs/localisation_audit.md` is the clean strict re-audit that resolves LOC-011-01 through LOC-011-08. Their audited Event 011 implementation hashes still match the current files. These reports supersede the earlier incomplete audit snapshots and confirm the workbook mirrors used by the final localisation pass.
