...
This file is the mechanic and registration overview for gameplay candidate `c4bb10ce439ba72f5ddb6d686199524120240895`. Whole-event completion proof comes from the final audit. `docs/plans/011_secret_alliance_plans/subagent_handoffs/decision_mission_audit.md` is a clean scoped freeze at `b7965b7e3743b43c643f0a3ef10c2d57ad723665`. `docs/plans/011_secret_alliance_plans/subagent_handoffs/localisation_audit.md` is a clean scoped freeze at `087d66ab4b3950b7854ee242343f5f0154c7906f`. The later commitment-causality work, operation-dossier causality, and Preparedness-scaled aftermath wording mean those report hashes are historical evidence rather than a current freeze.

The asset, achievement, super-event, scenario, workbook, and implementation documentation records are reconciled to the gameplay candidate. The final completion audit is still running against the full five-part specification, so no current whole-event CLEAN verdict is recorded here.
