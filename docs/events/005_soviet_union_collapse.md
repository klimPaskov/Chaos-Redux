...
- `common/scripted_triggers/005_soviet_collapse_triggers.txt` adds active-crisis, breakaway, patron, cost, recovered-capital, and second-wave quieting triggers.
...
- `common/decisions/005_soviet_collapse_decisions.txt` adds four non-political-power Soviet response decisions, twenty-two opening goal-style missions, four breakaway emergency actions, and seven targeted foreign patron decisions.
...
- Expand the Soviet objective board beyond the first twenty-two missions while preserving the ten-active cap.
