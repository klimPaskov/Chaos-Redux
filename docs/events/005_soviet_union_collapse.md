...
- `common/scripted_triggers/005_soviet_collapse_triggers.txt` adds active-crisis, breakaway, patron, cost, recovered-capital, second-wave quieting, provincial office, and emergency procurator triggers.
...
- `common/decisions/005_soviet_collapse_decisions.txt` adds four non-political-power Soviet response decisions, twenty-four opening goal-style missions, four breakaway emergency actions, and seven targeted foreign patron decisions.
...
- Expand the Soviet objective board beyond the first twenty-four missions while preserving the ten-active cap.
