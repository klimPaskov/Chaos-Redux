...
Foreign influence feeds both the consolidated staged `External Support` republic spirit and family-specific visible support spirits. Recognition, arms/logistics, reconstruction, volunteers, advisers, and patronage risk each mature through four stages inside `soviet_collapse_update_consolidated_republic_ideas`, while the consolidated support stage still reads total influence plus active sponsor count. Balanced support improves independence resilience and reduces patronage risk, while one-sided dominance increases dependency pressure and can surface sponsor-dominated risk stages.
...
Local leagues now operate as the regional layer below the Free Republics' League. The regional faction category exposes the Baltic League, Caucasus League, and Central Asian League founding decisions to eligible breakaways before they already have a faction flag. Founders recruit aligned partners, apply regional commitments, pick shared goals, settle tension, and can call a high-threat defensive war that clears the progressive release cooldown and checks the MTTH release scheduler. Active regional goals now resolve through explicit success or failure checks for defense, recognition, logistics, cohesion, tension, patron pressure, and depot control. Kazakhstan remains locked out of the Central Asian League and progressive Central Asian pressure until at least three smaller Central Asian republics are free. Full notes live in `docs/events/005_soviet_union_collapse_local_leagues.md`, with the source checklist in `docs/events/005_soviet_collapse_faction_goal_audit.md`.

No new icons are required for this slice. The consolidated staged republic spirits and the family-specific foreign support stages reuse existing idea pictures already registered by `interface/005_soviet_collapse_icons.gfx`: `emergency_union_authority`, `defensive_coordination`, `legal_restoration_claim`, `captured_soviet_depots`, `foreign_volunteers`, `military_defense_council`, and `old_underground_networks`.
...
Progressive republic releases use MTTH variables for the monthly release roll. The release weight rises with total threat, republic confidence, weak Moscow authority, weak military obedience, breakaway cascade count, depot vulnerability, foreign appetite, League cohesion, old-movement pressure, failed objectives, war pressure, regional cascade pressure, and chaos tier. The miss weight rises in a calm strong-center window and falls as those pressures mature, so additional republics can appear over time without forcing a fixed release every month.
...
7. `soviet_collapse_moldova_focus_tree`: 48 focuses for Moldova Chisinau ministry, raion food-board, independent republic, Dniester bridge/depot, Romanian-alignment, union-debate, Prut relief, Ukrainian grain-road, Odessa contact, Eastern Buffer, neutral bridge, League observer, high-chaos border committee, river-state, and republic-of-crossings routes.
...
10. `CFR_soviet_collapse_focus_tree`: 47 focuses for Civilian Factory of Russia construction-board tree with cooperative, planner, contract-board, concrete-committee, builder-state, border construction, and reconstruction protectorate routes.
11. `MFR_soviet_collapse_focus_tree`: 58 focuses for Military Factory of Russia arsenal-board tree with officer, worker, merchant, unsafe-output, production, foreign-contract, factory-guard, armored-train, rival-factory, protectorate, war-market, and arsenal-state routes.
12. `KRS_soviet_collapse_focus_tree`: 47 focuses for Kronstadt Free Soviet sailor assembly, Baltic worker letters, free Soviet couriers, Petrograd signal watch, Baltic observer missions, anti-party soviet clauses, free-port liaison rooms, sailor-worker defense councils, free Soviet congresses, dockyard repair crews, icebound supply ledgers, radio-room workshops, convoy escort ledgers, fortress hospitals, naval infantry oaths, Red Fleet signal posts, gulf mine watch, coastal air patrols, port guard schools, Every Harbor a Soviet, fortress-store, naval-militia, free-port conference, port-council, and port-sovereignty routes.
13. `FTH_soviet_collapse_focus_tree`: 47 focuses for Free Territory of Huliaipole commune, depot-raiding, League bargain, free-soviet registers, village delegate roads, commune supply ledgers, hidden workshop cells, grain-and-rifle stores, Ukrainian border letters, Dnieper watch, Don steppe contacts, Crimean port whispers, Free Territory Defense Council, commune courts, tachanka column oaths, black-flag signal posts, steppe airstrips, anti-puppet commune clauses, free schools, bread-and-rifle ledgers, roaming foreign mediation, communes without capitals, Black International, and anti-capital routes.
14. `BBH_soviet_collapse_focus_tree`: 47 focuses for Black Banner Host mobile-column, commune-war, anti-protectorate letters, temporary free-city pacts, no-masters clauses, foreign-fear mediation, war councils, no-hostage committees, mobile courts, armored-car raids, prison-break networks, roving artillery crews, scorched prison roads, captured rail stores, column supply ledgers, workshop cells, red-and-black depots, field hospital columns, black column registers, railway-state sabotage, borderless column schools, banner without borders, non-domination pacts, and anti-prison endgame routes.
15. `BSC_soviet_collapse_focus_tree`: 47 focuses for Basmachi Confederation oasis, pass-guard, caravan-store, road-control, caravan officer school, road-and-water guarantees, oasis council registers, desert pass offices, road-and-well ledgers, caravan supply hubs, hidden road depots, mountain route envoys, Kyrgyz/Tajik/Turkmen contacts, Central Asian defense council, tribal court registers, raiding-column oaths, desert airstrips, anti-puppet caravan clause, water-and-rifle ledger, foreign route mediation, and Steppe Federation news routes.
16. `TNC_soviet_collapse_focus_tree`: 47 focuses for Turkestan National Council civic-office, railway-guard, Tashkent emergency ministries, Samarkand-Bukhara legitimacy, cotton-rail republic, irrigation boards, canal guard posts, oasis supply hubs, southern pass offices, Kyrgyz/Tajik/Turkmen contacts, Central Asian defense council, station courts, city militia charter, anti-puppet charter clause, water-and-bread ledger, foreign mediation, and New Turkestan routes.
17. `ALA_soviet_collapse_focus_tree`: 47 focuses for Alash Restoration Authority congress, cavalry-guard, Alash officer schools, rail-station, steppe communications, district registers, southern rail, resource-town councils, southern republic contacts, Central Asian League drafting, mobile airstrips, supply hubs, anti-puppet statutes, the Steppe Republic Charter, recognition, and modernization/endgame routes.
18. `UDC_soviet_collapse_focus_tree`: 47 focuses for Union Defense Committee loyal-district, provisional-command, signature-force, staff-recognition, emergency staff college, front dispatch, military district passes, mobile order columns, counter-secession cells, radio command posts, loyal depot ledgers, staff car workshops, command bunker vaults, League observer corridors, officer amnesty boards, emergency court dockets, directory of Union command, winter order routes, and emergency command routes.
19. `SDZ_soviet_collapse_focus_tree`: 47 focuses for Security Directorate Zone archive, directorate, signature-force, custody-recognition, internal troop school, informant cipher, checkpoint, internal troop convoy, black-site transfer, radio intercept, sealed depot, document workshop, archive bunker, League inspection, witness protection, secure docket, directory of state memory, winter file-route, and security-state routes.
20. `GAC_soviet_collapse_focus_tree`: 47 focuses for Green Army Congress village, land-and-bread, peasant guard, forest-column, food-recognition, village delegate registers, grain passage papers, free republic market days, harvest observer missions, food-for-autonomy clauses, rural congress charters, village federation congresses, rail-siding ambushes, green column oaths, captured artillery caches, forest radio runners, partisan airstrip meadows, no-requisition borders, every-village-a-front routes, hidden mill ledgers, blacksmith carts, forest depot clearings, seed-and-rifle stores, field hospital barns, winter hay roads, harvest-truce, and rural federation routes.
21. `DHC_soviet_collapse_focus_tree`: 47 focuses for Don Host Emergency Circle host-circle, Novocherkassk field staff, host-court registers, river customs, cavalry remount yards, grain-convoy escorts, southern crossing batteries, Rostov workshops, steppe watch posts, winter road columns, Manych rear-area logistics, Kuban letters, League passage bargaining, stanitsa autonomy statutes, river-steppe compact, Don endurance, and host-command routes.
22. `KHC_soviet_collapse_focus_tree`: 47 focuses for Kuban Host Provisional Council crossing-council, Ekaterinodar field staff, crossing-court registers, Kuban river customs, cavalry remount yards, grain-corridor escorts, mountain crossing batteries, Krasnodar workshops, steppe watch posts, winter corridor columns, Laba rear-area logistics, Ukrainian letters, League corridor bargaining, stanitsa autonomy statutes, steppe-mountain compact, Kuban endurance, and Kuban Line routes.
23. `FEV_soviet_collapse_focus_tree`: 47 focuses for Far Eastern Republic Revival buffer, Khabarovsk assembly records, Amur field staff, Ussuri rail court, port customs ledgers, railway militia, Trans-Siberian dispatch, harbor fortress lines, Nikolsk workshops, Sikhote-Alin watch posts, winter rail columns, Razdolnoye rear area, Siberian factory letters, Amur river ports, Sakhalin ferry protocols, Pacific city compact, and non-extreme harbor authority routes.
24. `SZA_soviet_collapse_focus_tree`: 47 focuses for Siberian Zemstvo Authority regional assembly, Tomsk legal records, Omsk field staff, Novosibirsk rail courts, city guard, Trans-Siberian depot control, station fortress lines, Kuznetsk workshops, Angara timber levies, Baikal rear areas, Ural and Far Eastern transit diplomacy, League of Distant Cities, non-extreme railhead authority, and Siberian survival routes.
25. `UWD_soviet_collapse_focus_tree`: 47 focuses for Ural Workers Directorate factory committee, worker battalion, arsenal autonomy, Sverdlovsk factory records, Perm field staff, Tagil machine-tool ledgers, Magnitogorsk steel quotas, rail-yard repair trusts, blast-furnace guards, Chelyabinsk airwatch, canteen compacts, foundry contracts, Trans-Ural dispatch, League arsenal bargaining, armored rail-belt patrols, shipment-control hardliners, committee staff maps, industrial neutrality, factory endurance, and arsenal autonomy mandate routes.
26. `MRC_soviet_collapse_focus_tree`: 47 focuses for Mountain Republic of the Caucasus elder council, pass closure, Vladikavkaz legal records, Terek field staff, lowland depot raids, pass-court logistics, teip mediation, pack-train supply, village autonomy, Caucasus negotiation, Black Sea transit, League of Passes, anti-border-troop, mountain staff, and mandate routes.
27. `IUL_soviet_collapse_focus_tree`: 47 focuses for Idel-Ural League Volga-Ural office, Kazan emergency registers, Ufa field commissars, Samara crossing ledgers, Tatar-Bashkir courier boards, Bolghar memory, Kama workshop trusts, Volga fortified crossings, Bashkir cavalry roads, oilfield security, river-port customs, Kazan-Ufa signal lines, requisition vote controls, rail-and-river patrols, Volga trade letters, League corridor bargaining, Bashkir rear camps, corridor staff maps, the Bolghar question, federal corridor compact, Volga-Ural endurance, and federal corridor mandate routes.
28. `BAC_soviet_collapse_focus_tree`: 47 focuses for Birobidzhan Autonomous Commune settlement, militia, autonomous office, Birobidzhan council records, Amur field staff, settlement court registers, Yiddish school boards, river customs, relief escorts, crossing batteries, workshop contracts, taiga watch posts, winter road columns, Obluchye rear areas, Far Eastern letters, volunteer commune schools, river-port tolls, League relief bargaining, autonomy statutes, Amur commune endurance, and autonomous commune mandate routes.
29. `ARD_soviet_collapse_focus_tree`: 47 focuses for Arctic Naval Directorate port directorate, Murmansk port records, Kola field staff, convoy court registers, Ice Watch boards, White Sea customs, naval infantry yards, fuel escorts, Kola battery posts, Murmansk dockyard contracts, tundra watch posts, winter convoy columns, Kandalaksha rear areas, foreign fleet letters, volunteer port schools, White Sea tolls, League convoy bargaining, hardline fleet-commissar route, directorate staff maps, port neutrality statutes, Arctic port endurance, and port-neutrality mandate routes.
30. `NLC_soviet_collapse_focus_tree`: 47 focuses for Northern Lights Commune polar survival, Aurora council records, weather-station staff, station courts, greenhouse boards, Ice Watch training, ice-road customs, ration-and-signal escorts, station batteries, heated workshops, tundra watch posts, winter road columns, Apatity rear area, foreign science letters, volunteer station schools, ice-port tolls, League weather bargaining, hardline anti-commissar planning, polar neutrality, polar endurance, and post-capital routes.
...
Part 7 news/report coverage is tracked in `docs/events/005_soviet_collapse_news_report_audit.md`. The current source surface adds dedicated normal-presentation hooks for one-member liaison offices (`chaosx.nr5.45`), terminal subject release aftermath (`chaosx.nr5.46`), dynamic starting-unit explanations (`chaosx.nr5.47`), republics joining regional league tables (`chaosx.nr5.48`), public foreign recognition (`chaosx.nr5.49`), and internal republic sovereignty (`chaosx.nr5.95`). These are news/report events, not super-events.
...
- `CFR_soviet_collapse_focus_tree` reuses the existing 33 Civilian Factory focus sprites in `interface/005_soviet_collapse_factory_ancient_icons.gfx` across 47 focuses. No new CFR focus art is required for this slice.
- `MFR_soviet_collapse_focus_tree` reuses and extends the existing Military Factory focus sprite definitions in `interface/005_soviet_collapse_factory_ancient_icons.gfx` across 58 focuses. No new MFR focus art is required for this slice.
