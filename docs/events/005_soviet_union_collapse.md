...
2. `soviet_collapse_belarus_focus_tree`: 39 focuses, replacing the compact skeleton with the clean-spec Minsk opening, rail map, forest committees, corridor guard, evacuation choice, route locks for the National Council, socialist autonomy, military transit, and foreign corridor administration, plus first route side focuses, the Belarusian Question Answered political finisher, the first rail-sovereignty branch covering nationalized schedules, guarded junctions, corridor switchmen, depot seizures, railway guard regiments, timetable-state consolidation, rail neutrality or rail-war choices, League supply timetables, Brest aid, and emergency evacuation by train, and the first forest-defense branch covering forest staff, guide companies, village warnings, swamp-road denial, regular or decentralized defense choices, green-border corridors, and forest-state governance. The remaining corridor, diplomacy, League logistics, and high-chaos rows still need expansion to reach the 83-focus clean-spec target.
...
- Continue the Belarus replacement from 39 focuses to the 83-focus clean-spec target, then expand Kazakhstan, regional, and contingency breakaway runtime focus trees into full country packages with the larger focus counts mapped in the final clean specification.
