...
8. `soviet_collapse_internal_republic_focus_tree`: 46 focuses for Karelia, Komi, Crimea, Tatarstan, Bashkiria, Far East, Yakutia, Buryatia, and Tuva with regional survival, deeper Komi Syktyvkar/Pechora/mine-and-timber/exile-camp/northern-accord content, industry, defense, tag-specific border/resource/port/military branches, foreign-channel, high-chaos, and common-front routes.
