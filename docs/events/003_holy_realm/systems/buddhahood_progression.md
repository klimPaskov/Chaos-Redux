...
- `THR_touch_sun_moon_focus` is the anti-chaos capstone and requires the full named-power lattice before it can complete.
...
The achievement file defines all 12 Buddhahood achievement ids from the spec with gameplay-facing unlock conditions. `No Empire of the Wheel` uses the spec's allowed equivalent clean-route focus path: `Vow Against Annihilation`, Final Silence renunciation, no ordinary offensive conquest abuse, and a recorded anti-chaos victory.

`The Sun and Moon Were Within Reach` records `holy_realm_sun_moon_crisis_proof` when Touching the Sun and Moon is activated during world-collapse chaos while at least two active chaos enemies exist, or while the targeted chaos source is a major or controls a major capital.
...
- `The Awakened One`: slot 7, `GFX_super_event_buddha_mandate`, `sound/003_holy_realm/super_event_7_buddha_mandate.wav`, `sound/003_holy_realm/super_event_7_buddha_mandate.wav`.
- `The Final Silence` non-terminal: slot 8, `GFX_super_event_final_silence`, `sound/003_holy_realm/super_event_8_final_silence.wav`, `sound/003_holy_realm/super_event_8_final_silence.wav`.
- `The Final Silence` terminal: slot 9, `GFX_super_event_final_silence_terminal`, `sound/003_holy_realm/super_event_9_final_silence_thermonuclear.wav`, `sound/003_holy_realm/super_event_9_final_silence_thermonuclear.wav`.
- `Powers of the Awakened`: slot 61, `GFX_super_event_powers_of_the_awakened`, `sound/003_holy_realm/super_event_31_powers_of_the_awakened.wav`, `sound/003_holy_realm/super_event_31_powers_of_the_awakened.wav`.

The `Powers of the Awakened` super-event uses bespoke generated monochrome battlefield art at `gfx/super_events/003_holy_realm/super_event_powers_of_the_awakened.dds`. The former source, prompt, processed PNG, and handoff archive `docs/assets/003_holy_realm_buddhahood/super_event_images/` was deleted by Git commit `87d441ac75`. The runtime texture remains, but no current source archive is recorded in this doc set.
...
Current runtime audio rights records are in `docs/super_events/super_event_audio_packages.md`. The former research file `docs/assets/003_holy_realm_buddhahood/audio_research/holy_realm_buddhahood_super_event_audio_research.md` was deleted by Git commit `87d441ac75`. Earlier package notes described the other Holy Realm Buddhahood super-event recordings as CC0. That statement is historical licensing evidence. The current catalog records track-specific licenses and attribution for current use, including the `Powers of the Awakened` recording as CC BY 3.0 with attribution required.

The final completed, grey, and not-eligible DDS triplets remain under `gfx/achievements/003_holy_realm_*.dds` and are registered in `interface/chaosx_achievements.gfx`. The former achievement archive `docs/assets/003_holy_realm_buddhahood/achievement_icons/`, package manifest `docs/assets/003_holy_realm_buddhahood/manifest.md`, and GFX handoff `docs/assets/003_holy_realm_buddhahood/gfx_handoff.md` were deleted by Git commit `87d441ac75`. Those paths remain historical evidence, and no replacement source archive is recorded in this doc set.
...
These retained proposals have unresolved current acceptance. The Final Silence audio recommendation below must be reconciled with the overview's current terminal handoff to Fallout before it becomes an implementation instruction. Its source and licensing details remain historical evidence.
...
- The runtime static fallback Mandala and leader portrait DDS files remain wired. An earlier asset note records animated frame sheets for all Mandala states plus the Buddha Mandate and Empty Seat leader portraits. That note remains historical presentation evidence. The old asset workspace was deleted in Git commit `87d441ac75`, and current animated presentation still needs owner or MCP revalidation.
