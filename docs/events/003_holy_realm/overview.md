...
- Event logs: event ID 3 has a dedicated event-detail description and four Holy Realm evolution preview entries covering the Pattern of Suffering, Relic Mandala, False Buddha Schism, and Wrathful Protection. The evolution list row shows the short evolution name and chaos tier; the detailed panes keep the evolution stage. Event Details also lists The Final Silence as a clickable public world-end row with an independent automatic-selection checkbox.
