...
- Routed those internal republic tags to `soviet_collapse_internal_republic_focus_tree`, a 41-focus shared tree with legal, security, liaison, northern forest, Volga-Ural, Crimea, Siberian/Far Eastern/inner Asian, tag-specific Karelian, Komi, Tatar, Bashkir, Crimean, Far Eastern, Yakut, Buryat, and Tuvan branches, high-chaos old-name, and common-front branches.
