...
- Routed those internal republic tags to `soviet_collapse_internal_republic_focus_tree`, a 46-focus shared tree with legal, security, liaison, northern forest, deeper Komi Syktyvkar/Pechora/mine-and-timber/exile-camp/northern-accord content, Volga-Ural, Crimea, Siberian/Far Eastern/inner Asian, tag-specific Karelian, Tatar, Bashkir, Crimean, Far Eastern, Yakut, Buryat, and Tuvan branches, high-chaos old-name, and common-front branches.
