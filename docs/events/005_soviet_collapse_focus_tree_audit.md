...
The current shell recount counts 995 total focuses across 30 trees.
...
- Event 005 focus recount: 995 focuses across the Event 005 focus files after the Don Host Emergency Circle route expansion.
