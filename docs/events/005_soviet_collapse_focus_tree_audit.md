...
| `common/national_focus/005_soviet_collapse_republics.txt` | `soviet_collapse_central_asia_focus_tree` | 41 |
...
The current shell recount counts 873 total focuses across 30 trees.
...
- Event 005 focus recount: 873 focuses across the Event 005 focus files after the Tajik and Kyrgyz mountain-route expansion.
...
- Central Asian tree recount: 41 focuses, 41 completion rewards, and 41 `ai_will_do` blocks.
...
- Internal republic tree recount: 41 focuses, 41 completion rewards, and 41 `ai_will_do` blocks.
