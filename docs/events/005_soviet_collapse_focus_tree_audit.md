...
The current shell recount counts 904 total focuses across 30 trees.
...
- Event 005 focus recount: 904 focuses across the Event 005 focus files after the eastern internal-route expansion.
