...
The current shell recount counts 983 total focuses across 30 trees.
...
- Event 005 focus recount: 983 focuses across the Event 005 focus files after the Security Directorate Zone route expansion.
