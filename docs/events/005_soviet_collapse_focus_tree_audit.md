...
| `common/national_focus/005_soviet_collapse_republics.txt` | `soviet_collapse_central_asia_focus_tree` | 37 |
...
The current shell recount counts 869 total focuses across 30 trees.
...
- Event 005 focus recount: 869 focuses across the Event 005 focus files after the Turkmen desert-route expansion.
...
- Central Asian tree recount: 37 focuses, 37 completion rewards, and 37 `ai_will_do` blocks.
