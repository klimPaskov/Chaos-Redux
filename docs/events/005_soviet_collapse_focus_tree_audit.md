...
| `common/national_focus/005_soviet_collapse_republics.txt` | `soviet_collapse_internal_republic_focus_tree` | 46 |
...
The current shell recount counts 888 total focuses across 30 trees.
...
- Internal republic tree recount: 46 focuses, 46 completion rewards, and 46 `ai_will_do` blocks.
