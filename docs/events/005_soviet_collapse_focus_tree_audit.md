...
| `common/national_focus/005_soviet_collapse_republics.txt` | `soviet_collapse_internal_republic_focus_tree` | 54 |
...
The current shell recount counts 896 total focuses across 30 trees.
...
- Internal republic tree recount: 54 focuses, 54 completion rewards, and 54 `ai_will_do` blocks.
