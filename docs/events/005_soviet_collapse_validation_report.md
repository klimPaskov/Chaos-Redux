...
Event 005 focus integrity covers 934 focus blocks with icons, coordinates, completion rewards, AI weights, and resolved focus prerequisite/mutual-exclusion references.
Event 005 focus reward variety covers 637 material reward focuses, 423 shared focus-helper reward focuses, and only 37 idea-only focuses.
Event 005 focus AI checks cover 348 focuses with contextual `ai_will_do` modifiers.
