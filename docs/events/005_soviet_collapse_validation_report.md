...
Event 005 focus integrity covers 965 focus blocks with icons, coordinates, completion rewards, AI weights, and resolved focus prerequisite/mutual-exclusion references.
Event 005 focus reward variety covers at least 656 material reward focuses, 451 shared focus-helper reward focuses, and only 37 idea-only focuses.
Event 005 focus AI checks cover 379 focuses with contextual `ai_will_do` modifiers.
