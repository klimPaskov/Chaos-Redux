...
Event 005 focus integrity covers 995 focus blocks with icons, coordinates, completion rewards, AI weights, and resolved focus prerequisite/mutual-exclusion references.
Event 005 focus reward variety covers at least 658 material reward focuses in the conservative direct shell scan, 476 shared focus-helper reward focuses, and no more than 57 focuses in the conservative add-ideas-without-material scan.
Event 005 focus AI checks cover at least 335 focuses with contextual `ai_will_do` modifiers in the conservative direct shell scan.
