...
Event 005 focus integrity covers 971 focus blocks with icons, coordinates, completion rewards, AI weights, and resolved focus prerequisite/mutual-exclusion references.
Event 005 focus reward variety covers at least 658 material reward focuses, 456 shared focus-helper reward focuses, and only 37 idea-only focuses.
Event 005 focus AI checks cover 385 focuses with contextual `ai_will_do` modifiers.
