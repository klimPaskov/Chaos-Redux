...
Event 005 focus integrity covers 1114 focus blocks with icons, coordinates, completion rewards, AI weights, and resolved focus prerequisite/mutual-exclusion references.
...
The Ural Workers Directorate tree has 27 focus IDs, 27 completion rewards, 27 AI blocks, no duplicate UWD focus IDs, no unresolved UWD prerequisites, no layout coordinate collisions, and current localisation coverage for recognition through production, factory security school, rail-belt campaign planning, shift council mediation, output guarantees, and endgame focuses.
