...
The current SCN-008 mode authority is eight player-facing modes by four intensities, or 32 acceptance cells. Six numeric families remain in source, and Universal Belligerence contributes the three separately selectable rules named in localisation and the catalog mirror. Formable completion now exposes the post-formation shared focus branch for carriers that already own the Event 006 framework without replacing a meaningful vanilla tree; the IW-022 and IW-025 adapters deliberately leave the meaningful vanilla YUG tree untouched, IW-035 leaves the meaningful LIT tree untouched, and IW-059 observes the formed Mesopotamian carrier without replacing its original tree. Eight other exact vanilla route-overlay hooks, safe living-tree insertion, and live formation evidence remain open. The dated matrix reconciliation is `docs/plans/006_independence_wave_plans/subagent_handoffs/006_documentation_curator_scn008_mode_cardinality_2026_07_28.md`.
