...
| Host campaign | 51 host playbooks, with 22 full and 29 compact signatures | Active evidence | Three exact host exceptions remain blocked in the acceptance ledger, and compact promotion remains fail-closed until at least two of its six documented campaign criteria have accepted gameplay writers; whole-event runtime acceptance is open. |
