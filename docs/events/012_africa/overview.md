...
| Event 13 disaster calls | Event 12-only selected-enemy disaster wrapper call is audited against the unchanged Event 13 public contract, with strength derived from promotion, constitutional, ecological, war-readiness, payment, and target-size receipts | Accepted release-candidate evidence | Exact target and result outputs are verified; no Event 13 source change was made. Severity never derives from ethnicity, a tribal label, or an unreviewed cultural stereotype. |
