...
The same retained context now continues through the four evolution reports, all host-facing foreign-operation reports, and the containment deadline and settlement reports. Evolution AI weights favor open, industrial, security, or supervised responses according to the host archetype. Containment reports also name the recorded Evolution IV sovereignty policy before describing release, exile, confinement, shutdown, defection, uprising, rebellion, charter, takeover, or non-country crisis. These are bounded presentation and existing-option weighting extensions; they add no evolution, project reward, meter, receipt, asset, or model.
