...
- Defeat/remnant and broader country-specific flavor content remains queued after the core runtime milestone, and no dedicated Kruger triggerable scenario is required by the accepted design. The six mapped public milestone headlines and three institutional report scenes are now bounded presentation layers; the qualifying defeat news and family-specific breakthrough variants remain separately art-gated.
