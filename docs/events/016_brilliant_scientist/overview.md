...
- The clone infantry model/entity package is installed and reusable for generic consumers, and Portal Raider counter art is complete and wired. The Portal Raider runtime model/entity, actions, and sounds remain rejected and unwired pending user-approved paid recovery; the remaining route-specific model packages remain a production and runtime-wiring backlog. This is not a model, final GUI, or whole-event completion claim.
