...
- The report, super-event, portrait, animation, icon, flag, achievement, and Directorate UI packages are registered and have static consumer checks. Ten generated report scenes now serve the laboratory briefing, assistant conflict, loyalty dossier, two breakthrough families, the incident family groups, the shared archive hearing, and four project-family remnant hearings. The incident, breakthrough, and remnant reports route through scripted localisation; the Directorate dossier remains the defined default for unresolved families and prototype-only remnant records. Live presentation acceptance remains user-owned.
