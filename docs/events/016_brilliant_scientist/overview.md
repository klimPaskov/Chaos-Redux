...
When accident pressure activates a family-specific recovery mission, `chaosx.nr16.13` presents one ordinary incident report before the deadline clock matters. It names the affected family and scales its wording to standard, major, or severe pressure. Public notice, state security cordon, and Kruger-led cordon are distinct first-response postures that move the existing causal values and leave a containment-score receipt. Concrete resources, factory time, repair, damage, timeout, and AI recovery remain in the project mission layer. The report reuses the Directorate dossier art and is not an additional evolution or event-log entry.
...
- The report, super-event, portrait, animation, icon, flag, achievement, and Directorate UI packages are registered and have static consumer checks. Six generated report scenes now serve the laboratory briefing, assistant conflict, loyalty dossier, computation or electronics breakthrough, materials or rocketry breakthrough, and remnant hearings. The shared breakthrough report routes those two scenes through scripted localisation and keeps the Directorate dossier as its safe default for every other family. Live presentation acceptance remains user-owned.
...
- Broader country-specific flavor content remains queued after the core runtime milestone, and no dedicated Kruger triggerable scenario is required by the accepted design. The seven mapped news headlines, five institutional or breakthrough report scenes, and one dedicated remnant-hearing report scene are now bounded presentation layers; project-specific defeat-remnant variants remain separately art-gated.
