...
The accepted addendum promotes four conditional choices inside the existing assistant-conflict event `chaosx.nr16.5`. The generic `.5.a`, `.5.b`, and `.5.c` options remain unchanged. The national options are `chaosx.nr16.5.d_eng` for `ENG` in public-science or distributed-research context, `chaosx.nr16.5.e_usa` for `USA` in industrial-mobilization or distributed-research context, `chaosx.nr16.5.f_sov` for `SOV` in strategic-security or industrial-mobilization context, and `chaosx.nr16.5.g_jap` for `JAP` in strategic-security or industrial-mobilization context. `GER`, `FRA`, `ITA`, `CHI`, `POL`, `CZE`, and unnamed countries retain the complete generic option pool.
