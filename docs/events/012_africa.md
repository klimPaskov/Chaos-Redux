...
The subsystem documents remain separate rather than being deleted or merged: `docs/events/012_africa_charter_autonomy_and_focus_ai.md`, `docs/events/012_africa_evolutions.md`, and `docs/events/012_africa_world_order.md` cover the Charter relationship and focus AI layer, the evolution clock and visual contract, and Scramble/world-order behavior respectively.
