...
| Walloon reserve commander | `GFX_portrait_AFX_walloon_reserve_commander` | `gfx/leaders/006_independence_wave/portrait_AFX_walloon_reserve_commander.dds` | source-blocked; Herman Baltia trial 01 failed likeness and stable-consumer transfer, the stale Marcel Delcourt identity/DDS is not accepted, Jules-Joseph Pire and the strongest divisional-command alternatives are active vanilla owners or lack rights-clear archival masters, and the completed alternative sweep authorizes no substitute |
