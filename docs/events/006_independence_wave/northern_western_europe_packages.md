...
The current portrait-shelf authority is 83 original-size PNG masters in the flat shelf recorded by the current source map, with all 83 indexed or explicitly recorded in the manifests. No normalized 156x210 shelf files, advisor portraits, dossier derivatives, or small consumers are authorized. CHU Karim Tinchurin v3, the other CHU evidence rows, the two MNT masters, and ASY Haydo remain `needs_user_review` rights/date or provenance evidence; ASY Barsoum v93 passes its independent audit and v94 promotes only the existing concordat-council DDS consumer, without wider IW-058 admission.

Current shelf-index override (2026-08-03): all 83 physical masters are now indexed or explicitly recorded in the two flat-shelf manifests. The indexed rows are traceability-only and do not change any rights, provenance, role, or runtime admission gates.

The current Event 006 authority is `docs/plans/006_independence_wave_plans/006_source_of_truth_map.md` and the current resume packet, with the owner-promoted IW-026 MAC and IW-029 BOS tranche as the latest package-count delta. Nine Northern and Western Europe packages are statically content-attested: IW-001, IW-002, IW-004, IW-006, IW-007, IW-008, IW-009, IW-010, and IW-012, across their compatible reservation groups. Event-wide, the current allocator boundary is 23 content-attested packages across 22 compatible reservation groups, with IW-014 CAT, IW-026 MAC, IW-029 BOS, IW-033 KAR, IW-041 CRI, and IW-070 ARM, IW-071 GEO, and IW-072 AZR added after the dated IW-023 TRA snapshot. The central dispatcher exposes 32 package adapters, with nine adapter-only fail-closed rows. IW-013 NAV, IW-015 GLC, IW-020 ATX, IW-030 MNT, IW-043 CHU, IW-058 ASY, IW-093 DOX, IW-098 SOK, IW-177 FIJ, and IW-179 FSM remain **HOLD / fail-closed** outside that set; the shared IW-046 CHU overlay row is also unadmitted. FORM-07 and FORM-16 remain separate fail-closed formable surfaces. The dated 63-master/68-file shelf paragraph remains historical traceability only; the current 83-master shelf is indexed or explicitly recorded with no normalized, advisor, dossier, or small derivatives. The two Montenegro masters remain `needs_user_review` rights/provenance evidence only.
