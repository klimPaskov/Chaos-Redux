...
The current whole-event authority is 27 content-attested packages across 25 compatible reservation groups with 166 selectable rows still unattested. Older arithmetic in the dated regional snapshots below is historical traceability only. IW-030 Montenegro is the latest package promotion outside this region.
...
The current Event 006 authority is `docs/plans/006_independence_wave_plans/006_source_of_truth_map.md` and the current resume packet. Nine Northern and Western Europe packages are statically content-attested: IW-001, IW-002, IW-004, IW-006, IW-007, IW-008, IW-009, IW-010, and IW-012, across their compatible reservation groups. Event-wide, the current allocator boundary is 27 content-attested packages across 25 compatible reservation groups. The central dispatcher exposes 35 package adapters, with eight adapter-only fail-closed rows: IW-013 NAV, IW-015 GLC, IW-043 CHU, IW-058 ASY, IW-093 DOX, IW-098 SOK, IW-177 FIJ, and IW-179 FSM. IW-030 MNT is admitted under its vanilla-carrier package contract and sourced-placeholder roster. FORM-07 and FORM-16 remain separate fail-closed formable surfaces. The dated portrait-shelf paragraphs remain historical traceability only and do not override the current package and portrait authorities.
