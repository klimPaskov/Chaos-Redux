...
The current Event 006 authority is `docs/plans/006_independence_wave_plans/006_source_of_truth_map.md` together with the current resume packet. Nine Northern and Western Europe packages are statically content-attested: IW-001, IW-002, IW-004, IW-006, IW-007, IW-008, IW-009, IW-010, and IW-012, across their compatible reservation groups. The allocator source audit records 149 publishers, 126 automatic/high-chaos selectable packages, 138 SCN-008 ranked packages, the doubled 6/8/10/14/20 ladder, and thirteen attested packages across twelve compatible groups and thirteen distinct anchors event-wide. The IW-014 Catalonia package remains an implementation draft outside this attestation set pending its formable or valid Mediterranean carrier adapter. The flat portrait shelf contains 63 original-size masters with no normalized, advisor, dossier, or small derivatives; the two Montenegro masters remain rights-gated evidence only.
