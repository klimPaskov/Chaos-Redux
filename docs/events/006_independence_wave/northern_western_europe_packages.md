...
## Current regional admission snapshot (2026-08-03; v106 plus IW-023 admission)
...
The current Event 006 authority is `docs/plans/006_independence_wave_plans/006_source_of_truth_map.md` and the current resume packet, with the post-TRA admission handoff as the package delta. Nine Northern and Western Europe packages are statically content-attested: IW-001, IW-002, IW-004, IW-006, IW-007, IW-008, IW-009, IW-010, and IW-012, across their compatible reservation groups. Event-wide, the current allocator source audit records 149 publishers, 126 automatic/high-chaos selectable packages, 138 SCN-008 ranked packages, the doubled 6/8/10/14/20 ladder, and fifteen attested packages across fourteen compatible groups and fifteen distinct anchors, with IW-023 TRA as the latest admitted package. IW-014 Catalonia, IW-020 ATX, IW-043 CHU, IW-058 ASY, IW-093 DOX, IW-098 SOK, IW-179 FSM, IW-030 MNT, and IW-177 FIJ remain **HOLD / fail-closed** outside that set; the shared IW-046 CHU overlay row is also unadmitted. The IW-014 Catalonia package remains an implementation draft pending its formable or valid Mediterranean carrier adapter. The dated 63-master/68-file shelf paragraph remains historical traceability only; the current 83-master shelf is indexed or explicitly recorded with no normalized, advisor, dossier, or small derivatives. The two Montenegro masters remain `needs_user_review` rights/provenance evidence only.
