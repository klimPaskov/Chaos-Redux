...
The exact compile-time content-attestation set is IW-001 Scotland, IW-002 Wales, IW-004 Brittany, IW-006 Wallonia, IW-007 Frisia, IW-008 Rhineland, IW-009 Bavaria, IW-010 Saar, IW-012 Iceland, IW-017 Corsica, IW-019 Sicily, IW-173 Hawai'i, and IW-184 California. These thirteen packages span twelve compatible reservation groups and thirteen distinct anchors and retain the current static attestation evidence; bounded package-audit limitations, including the v66 COR limitations, do not close the whole-event gate.
...
006 portrait shelf now records exactly 63 original-size pre-resize masters directly
in one flat directory, with no nested folders, no normalized 156x210 PNGs, and no
advisor or small/dossier derivatives. Galimzhan Ibrahimov's independently approved
...
The canonical content gate now gives unadmitted automatic candidates zero weight and rejects a direct or stale reservation before anchor allocation. Thirteen attested IDs across twelve compatible reservation groups and thirteen distinct anchors provide a source-level exact-ten path: IW-008 RHI and IW-010 AJX share `RG-RHINE-SAAR` but are the only reciprocal pair admitted at that group's capacity of two, with distinct anchors 51 and 42. The current design decision doubles the automatic ladder to 6/8/10/14/20, including a twenty-country World Collapse band. The 6/8/10 bands are conditionally viable only when their source-level host, anchor, reservation, Event 005 collision, force, chaos-band, and transaction preflight checks pass; the 14/20 design targets have no currently admitted package or reservation capacity route and remain source fail-closed until the pool and disjoint reservation capacity are expanded. Live execution, save/load, and player-owned transaction evidence are optional future QA.
...
| Content attestation | The exact set remains thirteen IDs across twelve compatible groups and thirteen distinct anchors. | Retain the set; no new package is admitted from an adapter, shell, portrait, or bounded audit. |
...
The automatic wave counts are 6, 8, 10, 14, and 20. World Collapse is also 20; its force level, instability, package rarity, and regional ambition rise with the count instead of replacing it. The repaired planner applies the canonical content-attestation trigger during weight calculation and anchor reservation, so unadmitted candidates receive zero automatic weight and a direct stale reservation fails before any host, country, or state is reserved. The 6/8/10 bands are conditionally viable from the thirteen attested IDs across twelve compatible reservation groups and thirteen distinct anchors when all source-level host, country, state, reservation, force, chaos-band, and transaction preflight checks pass; IW-008 RHI and IW-010 AJX share RG-RHINE-SAAR but are the only reciprocal pair permitted at capacity two, with distinct anchors 51 and 42; all other groups remain one-package-only. The 14/20 bands remain source fail-closed until the attested pool, reservation groups, same-host protected-remnant cases, Event 005 collisions, rollback, and synchronized source evidence are expanded. Live execution, save/load, and player-owned transaction observation are optional future QA. Overlay-only, community-variant-only, formable-or-route-only, scenario-variant-only, and unbound rows remain available only through their explicit owning systems; Open Sovereignty cannot promote them merely to fill a wave.
