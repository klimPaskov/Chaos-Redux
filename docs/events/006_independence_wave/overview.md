...
006 portrait shelf authority records 75 original-size pre-resize PNG masters directly
in one directory after the CHU Bolgar v90 v1/v2 original-size repaint copies; the
folder contains 77 files including its README and manifest. The shelf remains
reference-only, with no normalized 156x210 PNGs, advisor portraits,
