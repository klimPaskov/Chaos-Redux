...
| Shared dynamic systems | Country values, former-host relations, patron, Network, League, rival bloc, decision and mission cleanup, and the standard security cost contract have source-closed initializer, reader, writer, threshold, recompute, and generation-reset coverage. | Country-specific route writers, package AI, package balance, and package admission remain open. |
