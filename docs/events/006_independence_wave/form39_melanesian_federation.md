...
+ `common/scripted_triggers/006_independence_wave_formable_registry_triggers.txt` owns the FORM-39 exact carrier/member eligibility, frozen three-row ledger checks, research gates, MFX identity proofs, AI consent, autonomous-member state, and material project cost checks.
