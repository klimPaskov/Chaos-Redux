...
- Gameplay: `common/scripted_triggers/006_independence_wave_balkan_package_triggers.txt` (Bosnia source block), `common/scripted_effects/006_independence_wave_balkan_package_effects.txt` (Bosnia source block), `common/decisions/006_independence_wave_balkan_decisions.txt` (Bosnia source block), `common/ideas/006_independence_wave_ideas_registry.txt`, `common/script_constants/006_independence_wave_constants_registry.txt`, `common/characters/006_independence_wave_characters_registry.txt`, `common/ai_strategy/006_independence_wave_ai_strategy_registry.txt`.
- Runtime portrait consumer: `interface/006_independence_wave_portraits_registry.gfx`, sprite `GFX_portrait_BOS_independence_wave_mehmed_spaho`, texture `gfx/leaders/006_independence_wave/portrait_BOS_independence_wave_mehmed_spaho.dds`.
...
- Localisation: `localisation/english/006_independence_wave_balkan_l_english.yml` (Bosnia section).
