...
High-chaos package surfaces include Gorilla Highlands, Chimpanzee Telegraph League, Okapi Court, Crocodile Rivers, Baobab Senate, Termite Citadel Engineers, Honeyguide Commons, Great Herds, Tidemark Dominion, Ananse Web, and Orisha/Vodun Nature Courts.
...
Each tag has country registration, a country file, a history file, direct display-name localisation, generated symbolic root/medium/small flag families, focus loading, AI strategy coverage, setup hooks from `012_africa_effects.txt`, dynamic starting guard counts, and at least one focus-based reinforcement path. The ten regional authority histories use direct institutional leader names and distinct generated human/council leader portraits rather than the generic African portrait. Regional authority tags are marked as event-managed special countries, while high-chaos actors are also marked as nonhuman where appropriate. All 11 high-chaos actors receive package-specific target actions from the unifier decision layer, with actor-side flags recording whether the actor has performed its guard, crossing, arbitration, convoy, audit, court, relay, shadow-dossier, engineering, aid-route, or relief-column action. The expanded actor actions fire visible consequence events `chaosx.nr12.40` through `chaosx.nr12.44`; those are local action reports, not final variant super-events.

The 21 created tags use direct public display identities: West African Congress, Sahel Caravan, Maghreb Coast, Nile-Horn League, East African Railway Congress, Great Lakes Council, Congo Basin Charter, Zambezi-Stone Cities, South African Liberation Congress, Indian Ocean Congress, Gorilla Highlands, Baobab Senate, Tidemark Dominion, Ananse Web, Orisha/Vodun Nature Courts, Crocodile Rivers, Chimpanzee Telegraph League, Okapi Court, Termite Citadel Engineers, Honeyguide Commons, and Great Herds. Party names may still use congresses, councils, assemblies, or other internal bodies where they represent factions rather than the country identity.
