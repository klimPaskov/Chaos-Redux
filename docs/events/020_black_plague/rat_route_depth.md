...
Further depth can add route-specific report text and crisis art without changing the decision contract. The shared rat model package remains a separate parent-owned runtime handoff, with sound-definition wiring, counter review, and live in-game validation still open.
