...
`events/fallout_world_end_events.txt` owns the namespace `chaosx.fallout`. The current Air Winter pilot contains 46 manually authored event blocks, 137 options, 136 effect-bearing options, and 48 delayed-result schedules:

- 43 phase, regional, seasonal, crisis, delayed-result, government, and recovery blocks.
- 2 terminal response result blocks for abandonment and decontamination.
- 1 stale-choice recovery block.

The pilot covers every phase, all nine presentation classes through regional routing, city, food, transport, shelter, disease, seed and livestock policy, mountain-capital tunnel schools, hydroelectric dams, oil and synthetic refineries, coal workings and heavy industry, reactors, government continuity, recovery, and several delayed deterministic results. The Phase 2 seed ledger diverts local factory availability for guarded storage and returns after 45 days with flourishing or failed trial plots, fixed herd depletion, or a conditional breeding-stock result. The tunnel-school chain trades temporary local factory availability for shelter and a durable Deaths reduction. The Phase 3 infrastructure chains use state coal and oil output, operational factory counts, repairable building damage, state energy demand, the country energy ratio, low reactor-accident fallout, and civilian losses through the Deaths system. The recurring seasonal layer records first frost, dark harvest, ash thaw, second winter, and terminal season. Event text uses state names and government-aware authority terms.
...
- Forty-six manually authored Air Winter pilot events, including five durable seasonal recurrence families, the seed-ledger continuation, the mountain-capital tunnel-school chain, and four Phase 3 infrastructure chains.
