...
| Report events | `GFX_report_event_air_winter_phase_1` through `GFX_report_event_air_winter_phase_6`, `GFX_report_event_air_winter_recovery`, and `GFX_report_event_air_winter_island_refugee_harbor` | `gfx/event_pictures/fallout/air_winter/` | `interface/air_cleanliness_winter.gfx` |
...
- Forty-eight manually authored Air Winter pilot events, including five durable seasonal recurrence families, the island-refugee migration chain, the seed-ledger continuation, the mountain-capital tunnel-school chain, and four Phase 3 infrastructure chains.
