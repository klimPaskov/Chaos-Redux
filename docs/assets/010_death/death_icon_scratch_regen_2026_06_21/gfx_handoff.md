# Event 010 Death Icon Scratch Regeneration GFX Handoff

No `.gfx` edits are required. Existing sprite registrations and achievement file lookups already point at the preserved live DDS filenames.

## Focus Icons

Existing `.gfx` file: `interface/010_death.gfx`

The base focus sprites and matching `_shine` sprites reuse these DDS files automatically:

- `GFX_focus_death_empty_supply` -> `gfx/interface/goals/death/focus_death_empty_supply.dds`
- `GFX_focus_death_every_road_slows` -> `gfx/interface/goals/death/focus_death_every_road_slows.dds`
- `GFX_focus_death_last_shores` -> `gfx/interface/goals/death/focus_death_last_shores.dds`
- `GFX_focus_death_mourning_host` -> `gfx/interface/goals/death/focus_death_mourning_host.dds`
- `GFX_focus_death_orders_without_breath` -> `gfx/interface/goals/death/focus_death_orders_without_breath.dds`
- `GFX_focus_death_ruin_host` -> `gfx/interface/goals/death/focus_death_ruin_host.dds`
- `GFX_focus_death_state_without_state` -> `gfx/interface/goals/death/focus_death_state_without_state.dds`
- `GFX_focus_death_world_consumed` -> `gfx/interface/goals/death/focus_death_world_consumed.dds`

## Achievement Icons

Existing `.gfx` file: `interface/chaosx_achievements.gfx`

Each achievement family has these live files:
