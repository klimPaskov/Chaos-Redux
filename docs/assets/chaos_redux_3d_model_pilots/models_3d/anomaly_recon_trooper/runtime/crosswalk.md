...
| Vanilla unit scale | Read-only `western_european_infantry.mesh` source height 7.351824; pilot mesh target 1.8379560709; neutral pilot entity scale 1.0; expected effective pilot height 1.837956 | `chaosx_anomaly_recon_trooper_entity` | corrected; pending live check |
