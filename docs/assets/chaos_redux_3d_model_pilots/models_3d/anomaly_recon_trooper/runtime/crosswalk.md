...
| PDX material channels | `blender/reports/textures_dds.json`, `blender/reports/pdx_material_pack.json`; gamma-lifted runtime diffuse, PDX normal map, and PDX packed specular layout | `texture_0.dds`, `texture_normal.dds`, `texture_specular.dds`; GFX object `Mesh_0.001` | complete |
...
| Vanilla unit scale | Read-only `western_european_infantry.mesh` source height 7.351824; pilot mesh target 7.3518242835; pilot entity scale 0.8; expected effective pilot height 5.8814594268 | `chaosx_anomaly_recon_trooper_entity` | corrected; pending live check |
...
| Transform agreement | Mesh data absorbs the 94.7711071693 mesh-to-armature scale ratio before parenting; export bakes the remaining uniform armature object scale 0.0408434682 into armature data and emits unit-scale bind matrices | Blender checkpoints and `.mesh` export | complete |
