...
| Live runtime placement | `common/scripted_effects/chaosx_3d_model_pilot_showcase_effects.txt`; `common/on_actions/chaosx_3d_model_pilot_showcase_on_actions.txt`; `map/buildings.txt`; `history/states/64-Brandenburg.txt` | Troop in Germany province 6521; beacon in Brandenburg state 64, province 9560 at map coordinate `2998, 9.70, 1552` using the `anomaly_signal_beacon_pilot_spawn` spawn-point row and registered `building_anomaly_signal_beacon_pilot_spawn` entity | wired; pending live check |
