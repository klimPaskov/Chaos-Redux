...
| Super-event | `GFX_super_event_union_unmade`, `GFX_super_event_map_larger_than_union`, `GFX_super_event_steppe_beyond_history`, `GFX_super_event_corridors_decide`, `GFX_super_event_bread_state` | sourced and wired for active super-event use; retired league/federation source packages are preserved below only for traceability |
...
| `PRA` | `gfx/interface/goals/soviet_collapse/005_pra_custom_splinter_focus.dds` | `gfx/interface/ideas/soviet_collapse/005_pra_custom_splinter_idea.dds` | `gfx/interface/decisions/soviet_collapse/005_pra_custom_splinter_decision.dds` | `gfx/leaders/005_soviet_collapse/PRA_leader.dds` | wired, generated reuse |
