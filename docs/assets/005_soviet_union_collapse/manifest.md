...
- Final generated shared breakaway and Black Banner focus icons: `complete` for the active 53-focus shared fallback tree through deliberate reuse of the 22 wired shared sprites, and for Ukrainian Black Banner contingency focuses.
