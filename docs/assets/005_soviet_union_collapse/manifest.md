...
| Super-event | `GFX_super_event_union_unmade`, `GFX_super_event_map_larger_than_union`, `GFX_super_event_steppe_beyond_history`, `GFX_super_event_corridors_decide`, `GFX_super_event_bread_state`, `GFX_super_event_league_equal_republics`, `GFX_super_event_steppe_federation` | sourced and wired for active super-event use |
