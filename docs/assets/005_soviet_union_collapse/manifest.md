...
| `DSC` | `docs/assets/005_soviet_union_collapse/processed_png/flags/DSC_normal.png` | `gfx/flags/DSC.tga` | `gfx/flags/medium/DSC.tga` | `gfx/flags/small/DSC.tga` | wired, generated reuse |
...
- Final generated shared breakaway and Black Banner focus icons: `complete` for the active 53-focus shared fallback tree through deliberate reuse of the 22 wired shared sprites, for Ukrainian Black Banner contingency focuses, and for the 24-focus `FTH`, `BBH`, `BSC`, `TNC`, `ALA`, `UDC`, `SDZ`, `RMC`, `RCD`, `ILU`, `PRA`, `TSC`, `BLT`, `NRF`, `GAC`, `DHC`, `KHC`, `FEV`, `SZA`, `UWD`, `MRC`, `IUL`, `BAC`, `ARD`, `TRS`, `NLC`, `SEP`, `DSC`, `COU`, `BEC`, `RLD`, `LID`, and `IRA` custom-splinter trees through their existing per-tag custom focus sprites.
- Custom tag flags: `complete` for `FTH`, `KRS`, `BSC`, `UDC`, `SDZ`, `RMC`, `RCD`, `ILU`, `PRA`, `TSC`, `BLT`, `NRF`, `GAC`, `DHC`, `KHC`, `FEV`, `SZA`, `UWD`, `MRC`, `IUL`, and `BAC`; `wired, generated reuse` for `TNC`, `ALA`, `ARD`, `BBH`, `TRS`, `ICD`, `NLC`, `SEP`, `DSC`, `COU`, `BEC`, `RLD`, `LID`, and `IRA`.
- Custom tag focus icons, idea icons, decision icons, faction-style emblems, and fictional leader portraits: `complete` for the implemented custom tags. `TNC`, `ALA`, `ARD`, `BBH`, `TRS`, `ICD`, `NLC`, `SEP`, and `DSC` remain wired through generated reuse pending bespoke Turkestan, Alash, Arctic Naval Directorate, Black Banner Host, Third Rome Emergency Synod, Iron Commissariat of the Dead, Northern Lights Commune, Sepulchre Soviet, and Dead Soldiers' Congress art.
