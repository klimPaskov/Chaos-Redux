...
- Final generated shared breakaway and Black Banner focus icons: `complete` for the active 53-focus shared fallback tree through deliberate reuse of the 22 wired shared sprites, for Ukrainian Black Banner contingency focuses, and for the 24-focus `FTH`, `BBH`, `BSC`, `TNC`, `ALA`, `UDC`, `SDZ`, `RMC`, `RCD`, `ILU`, `PRA`, `TSC`, `BLT`, `NRF`, `GAC`, `DHC`, `KHC`, `FEV`, `SZA`, and `UWD` custom-splinter trees through their existing per-tag custom focus sprites.
- Custom tag flags: `complete` for `FTH`, `KRS`, `BSC`, `UDC`, `SDZ`, `RMC`, `RCD`, `ILU`, `PRA`, `TSC`, `BLT`, `NRF`, `GAC`, `DHC`, `KHC`, `FEV`, `SZA`, and `UWD`; `wired, generated reuse` for `MRC`, `TNC`, `ALA`, `IUL`, `BAC`, `ARD`, `BBH`, `TRS`, `ICD`, `NLC`, `SEP`, and `DSC`.
- Custom tag focus icons, idea icons, decision icons, faction-style emblems, and fictional leader portraits: `complete` for the implemented custom tags. `MRC`, `TNC`, `ALA`, `IUL`, `BAC`, `ARD`, `BBH`, `TRS`, `ICD`, `NLC`, `SEP`, and `DSC` remain wired through generated reuse pending bespoke Mountain Republic, Turkestan, Alash, Idel-Ural, Birobidzhan, Arctic Naval Directorate, Black Banner Host, Third Rome Emergency Synod, Iron Commissariat of the Dead, Northern Lights Commune, Sepulchre Soviet, and Dead Soldiers' Congress art.
