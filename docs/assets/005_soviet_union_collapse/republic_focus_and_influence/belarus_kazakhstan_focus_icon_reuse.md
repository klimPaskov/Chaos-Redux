...
- Kazakhstan: 16 focuses in `common/national_focus/005_soviet_collapse_republics.txt`, covering the clean-spec Alma-Ata opening, southern-wire crisis, first route-lock block, and decentralization convergence.
...
| federation | 4 | `GFX_kaz_soviet_collapse_federation` | `gfx/interface/goals/kaz_soviet_collapse_federation.dds` | Steppe congress art fits Alma-Ata, southern wires, Turkestan mandate, and oasis-steppe congress focuses. |
| resources | 3 | `GFX_kaz_soviet_collapse_resources` | `gfx/interface/goals/kaz_soviet_collapse_resources.dds` | Factory-defense art fits resource-town guards, the directorate, and engineers holding the state. |
| foreign | 1 | `GFX_kaz_soviet_collapse_foreign` | `gfx/interface/goals/kaz_soviet_collapse_foreign.dds` | External mission art fits southern guarantee diplomacy. |
...
| military | 1 | `GFX_kaz_soviet_collapse_military` | `gfx/interface/goals/kaz_soviet_collapse_military.dds` | Field battalion art fits district inventory and mobile-stock accounting. |
...
- Kazakhstan has 16 focus blocks.
- Together, the two trees have 99 implemented focuses with wired branch sprites.
