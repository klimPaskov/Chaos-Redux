...
- Belarus: 16 focuses in `common/national_focus/005_soviet_collapse_republics.txt`, currently covering the clean-spec Minsk opening and first political route-lock block.
...
| --- | ---: | --- | --- | --- |
| rail | 1 | `GFX_blr_soviet_collapse_rail` | `gfx/interface/goals/blr_soviet_collapse_rail.dds` | Common timetable art fits Minsk junction authority. |
...
| corridor | 2 | `GFX_blr_soviet_collapse_corridor` | `gfx/interface/goals/blr_soviet_collapse_corridor.dds` | Border-line art fits western passage and corridor-state outcomes. |
...
| socialist | 1 | `GFX_blr_soviet_collapse_socialist` | `gfx/interface/goals/blr_soviet_collapse_socialist.dds` | Socialist sovereignty art fits workers' councils. |
| foreign_transit | 1 | `GFX_blr_soviet_collapse_foreign_transit` | `gfx/interface/goals/blr_soviet_collapse_foreign_transit.dds` | External mission art fits observer and relief transit. |
...
| civic | 2 | `GFX_blr_soviet_collapse_civic` | `gfx/interface/goals/blr_soviet_collapse_civic.dds` | First-orders art fits citizenship and post-corridor identity. |
...
- Belarus has 16 focus blocks.
- Kazakhstan has 12 focus blocks.
- Together, the two trees have 28 implemented focuses with wired branch sprites.
