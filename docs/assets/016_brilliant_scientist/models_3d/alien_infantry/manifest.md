...
- Source animation binary: `Animations/fbx/Rig_Medium/Rig_Medium_CombatRanged.fbx`, copied for the adapter as `provider/downloads/kaykit_rig_medium_combat_ranged.fbx`, SHA-256 `B70E1D5EF64FAFAAD5C50CA2225C238F33EC9622876014F38478DEEB10EE2BA4`.
...
- A mirrored-left/right KayKit mapping probe (`Rig_Medium|Ranged_1H_Shoot.002`, `blender/checkpoints/alien_infantry_kaykit_mirrored_shoot_probe.blend`) also transferred without adapter warnings but lost the pistol/hand contact in the frame-17 preview. It is evidence-only under `evidence/professional_animation/kaykit_ranged_1h_shoot_mirrored_provenance.json` and is not a semantic alias.
