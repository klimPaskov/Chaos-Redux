...
- Seven reusable project-force 3D entity packages remain deferred outside the current no-model scope. Their exact consumers and generic reuse contracts are documented in `docs/plans/016_brilliant_scientist_plans/016_event19_generic_unit_family_3d_model_backlog.md`; they are not a current blocker or acceptance gate.
