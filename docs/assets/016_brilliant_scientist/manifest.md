...
| Alien Infantry 3D model package | 1 entity; 7 genuine actions; synchronized sourced audio | 0 accepted runtime outputs | Meshy 7 task `01a02497-1fb9-7a1b-bec6-ec388d54a016` was rejected because the generated mesh omitted the required rifle. No fallback entity, action, export, reimport proof, or sound binding is wired. |
