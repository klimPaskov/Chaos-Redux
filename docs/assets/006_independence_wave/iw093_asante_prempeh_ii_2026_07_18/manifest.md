...
## Retry-2 source-locked repaint (2026-08-02)

The retry-2 ImageGen repaint was generated from the exact archival
head-and-shoulders crop after the first repaint failed the independent likeness
and style audit. It is retained as a source master and flat shelf copy only.
The independent audit records a conditional near-pass for identity, regalia,
framing, and HOI4 style, with minor eye/nose/jaw drift and ornate framing still
noted. Metadata and the exact prompt are in
`metadata/portrait_DOX_prempeh_ii_hoi4_2026_08_02_retry2.json` and
`prompts/portrait_DOX_prempeh_ii_imagegen_retry2_prompt.md`.

| Artifact | Dimensions | SHA-256 | Runtime disposition |
|---|---:|---|---|
| Retry-2 ImageGen master and flat shelf copy | 1081x1455 RGB | `1F4DE5280DC4F5050E11159D48FC672A2A0E65CFAF1F10C3A13579ECAE32D01F` | Evidence-only pending final acceptance |
| Retry-2 deterministic candidate | 156x210 RGBA | `E55BC4D3D79502E6AA5049CF554616C263FDAA00336433A4E1179119FEBDA833` | No DDS/GFX promotion; conditional near-pass only |

The comparison sheet is `contact_sheets/portrait_DOX_prempeh_ii_retry2_review.png`
(SHA-256 `5A5AE59A56F3A431F5A141D774E35BF0C47B3290B706F7152EA52FBA43CBECC5`).

The existing runtime DDS and sprite remain historical consumer wiring. No
advisor or alternate portrait was created.
