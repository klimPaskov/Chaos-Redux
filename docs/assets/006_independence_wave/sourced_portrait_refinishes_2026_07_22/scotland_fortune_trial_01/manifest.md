...
- Finish command: skill-local `retired_advisor_card_processor_REMOVED leader`, source kind `real`, explicit result crop `(0, 0, 1086, 1448)`, canonical vanilla leader review directory.
