# IW-002 Wales J. H. Thomas portrait trial 01

Status: `rejected_and_unwired_2026_07_25`.

The independent audit failed the non-compensable identity-likeness gate.
...
The package does not claim that he historically chaired the Event 6 Welsh National Council.
...
| Prompt SHA-256 | `EFF8E8FCCC2B5ABBB4793A31B632D90F73CE6E4CC32EFF16E58DB9B0009F901E` |
| Raw repaint | `imagegen_results/WLS_j_h_thomas_identity_preserve_trial_01.png` |
| Raw dimensions | `1082x1454` |
| Raw SHA-256 | `2EFE615FDEC12CDCCD811A87E6B9F123E24B15C3A002589364FBDEF42A0F22F4` |
| Original ImageGen cache | `C:/Users/klimp/.codex/generated_images/019f6059-0778-7992-8f0d-f7582beecbeb/call_ngjy7keRcrNmi00w92Q21UEt.png` |
...
| Role family | `leader` |
| Source kind | `real` |
| Raw repaint crop | `(1,0,1081,1454)` |
| Candidate | `processed_png/portrait_WLS_independence_wave_national_council.png` |
| Candidate dimensions | `156x210` |
| Candidate SHA-256 | `4412D588370735206A7A4A7ABFBBD8E2D1D349AA29C8B8014AA21A556F813680` |
| Candidate decoded RGBA SHA-256 | `298B494097C9134B8FEE0273747F7A083BD537362286C3BDDE8BD1EBE38EA330` |
| Metadata | `processed_png/portrait_WLS_independence_wave_national_council.png.json` |
| Metadata SHA-256 | `EE0094F984BAEB0482B28F55B903150D394A00DDB0489EA6DA788D855A62549B` |
| Style sheet | `review/WLS_j_h_thomas_leader_style_sheet.png` |
| Style-sheet SHA-256 | `242D5C2BDFFA8DC863DF3CE160C4D8632E0DB1377F4126DE9E19FF9175A02E5C` |
...
The authoritative result is `docs/plans/006_independence_wave_plans/subagent_handoffs/006_wales_jh_thomas_trial01_independent_portrait_audit_2026_07_25.md`.

Decision: **FAIL** / `blocked` / `export-only`.

Source attribution, rights, exact crop equality, male civic role, HOI4 painted style, `156x210` framing, ownership, stable-consumer declaration, and absence of advisor, dossier, operative, commander-small, and `_small` derivatives passed.

Identity likeness failed because the repaint regularized unequal eyes and gaze, softened and broadened the nose, made the moustache bushier, more symmetrical, and more upturned, filled and smoothed the cheeks and lower-face planes, rounded the jaw and chin, softened ear asymmetry, reduced source age texture, and made the expression more neutral.

Style quality cannot compensate for those changes.

This candidate must not replace the current player-facing identity or existing runtime texture.

A later retry must start again from the unchanged archival crop and preserve the source-specific unequal eyelid openings and gaze, brow-weight asymmetry, long narrow rounded-tip nose, broad drooping asymmetric moustache, long facial planes, cheek hollowness, jaw and chin geometry, ear exposure, source age texture, stern expression, and slight head angle.
