...
| CHU Bolgar civic presidium | Musa Dzhalil | `CHU_independence_wave_bolgar_civic_presidium` | `GFX_portrait_CHU_independence_wave_bolgar_civic_presidium` | `gfx/leaders/006_independence_wave/portrait_CHU_independence_wave_bolgar_civic_presidium.dds` | `needs_user_review`; independent visual audit passed, but author/licence evidence remains open; Shamil Usmanov remains rejected at 187x250 |
| CHU river security directorate | Ahmet Zeki Velidi Togan | `CHU_independence_wave_river_security_directorate` | `GFX_portrait_CHU_independence_wave_river_security_directorate` | `gfx/leaders/006_independence_wave/portrait_CHU_independence_wave_river_security_directorate.dds` | `needs_user_review`; independent visual audit passed, but source institution/date and Bashkir-to-CHU role review remain open |
...
- Do not wire the Musa Dzhalil candidate until the Commons/museum author and licence evidence is explicitly resolved; its visual audit passed, but the candidate remains evidence-only.
- Do not wire the Ahmet Zeki Velidi Togan candidate until the museum/Commons source-rights evidence and Bashkir-to-CHU river-security role transfer are explicitly resolved; its visual audit passed, but the candidate remains evidence-only.
