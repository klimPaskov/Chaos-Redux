...
There are intentionally no processed PNG previews, final DDS files, contact
sheets, advisor assets, or `.gfx` snippets in this retry. The parent may advance
only after an independent review closes the Solinas rights/era/low-resolution
questions. The ARX crown/council role must remain blocked until a new
