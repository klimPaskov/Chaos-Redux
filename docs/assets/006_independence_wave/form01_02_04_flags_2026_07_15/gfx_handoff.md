...
These are shared alternate-history base flags. They are not ideology variants,
route variants, historical reconstructions, or cosmetic-route recolours.
...
The accepted research supports one shared design per tag. Do not add
`_communism`, `_democratic`, `_fascism`, `_neutrality`, route, or cosmetic
recolour files from this package. The parent implementation owns any later tag
registration or identity-adapter call and must preserve this one-design rule.
