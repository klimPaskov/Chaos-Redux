...
- Sub-unit: `mutant_zombies`.
- Mesh stem: `chaosx_mutant_zombies`.
- Entity: `chaosx_mutant_zombies_entity`.
- PDX mesh: `chaosx_mutant_zombies_mesh`.
...
- Mesh: `export/mesh/chaosx_mutant_zombies.mesh` and `gfx/models/units/chaosx_mutant_zombies/chaosx_mutant_zombies.mesh`.
- Actions: `export/anim/chaosx_mutant_zombies_{idle,move,attack,death}.anim` and matching runtime files.
...
- Reimport evidence: `validation/reimport_chaosx_mutant_zombies_*.json`.
- Entity/GFX: `gfx/entities/chaosx_mutant_zombies.asset` and `gfx/entities/chaosx_mutant_zombies.gfx`.
- Unit binding: `common/units/zombies.txt#mutant_zombies` uses `sprite = chaosx_mutant_zombies`.
