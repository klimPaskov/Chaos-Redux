# Infected Zombies model manifest
...
- Sub-unit: `infected_zombies`.
- Mesh stem: `chaosx_infected_zombies`.
- Entity: `chaosx_infected_zombies_entity`.
- PDX mesh: `chaosx_infected_zombies_mesh`.
...
- Mesh: `export/mesh/chaosx_infected_zombies.mesh` and `gfx/models/units/chaosx_infected_zombies/chaosx_infected_zombies.mesh`.
- Actions: `export/anim/chaosx_infected_zombies_{idle,move,attack,death}.anim` and matching runtime files.
...
- Reimport evidence: `validation/reimport_chaosx_infected_zombies_*.json`.
- Entity/GFX: `gfx/entities/chaosx_infected_zombies.asset` and `gfx/entities/chaosx_infected_zombies.gfx`.
- Unit binding: `common/units/zombies.txt#infected_zombies` uses `sprite = chaosx_infected_zombies`.
