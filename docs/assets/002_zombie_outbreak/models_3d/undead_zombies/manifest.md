...
- Sub-unit: `undead_zombies`.
- Mesh stem: `chaosx_undead_zombies`.
...
- Mesh: `export/mesh/chaosx_undead_zombies.mesh` and `gfx/models/units/chaosx_undead_zombies/chaosx_undead_zombies.mesh`.
- Actions: `export/anim/chaosx_undead_zombies_{idle,move,attack,death}.anim` and matching runtime files.
...
- Reimport evidence: `validation/reimport_chaosx_undead_zombies_*.json`.
- Entity/GFX: `gfx/entities/chaosx_undead_zombies.asset` and `gfx/entities/chaosx_undead_zombies.gfx`.
- Unit binding: `common/units/zombies.txt#undead_zombies` uses `sprite = chaosx_undead_zombies`.
