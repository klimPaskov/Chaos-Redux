# Necrotic Zombies model manifest
...
- Sub-unit: `necrotic_zombies`.
- Mesh stem: `chaosx_necrotic_zombies`.
- Entity: `chaosx_necrotic_zombies_entity`.
- PDX mesh: `chaosx_necrotic_zombies_mesh`.
...
- Mesh: `export/mesh/chaosx_necrotic_zombies.mesh` and `gfx/models/units/chaosx_necrotic_zombies/chaosx_necrotic_zombies.mesh`.
- Actions: `export/anim/chaosx_necrotic_zombies_{idle,move,attack,death}.anim` and matching runtime files.
...
- Reimport evidence: `validation/reimport_chaosx_necrotic_zombies_*.json`.
- Entity/GFX: `gfx/entities/chaosx_necrotic_zombies.asset` and `gfx/entities/chaosx_necrotic_zombies.gfx`.
- Unit binding: `common/units/zombies.txt#necrotic_zombies` uses `sprite = chaosx_necrotic_zombies`.
