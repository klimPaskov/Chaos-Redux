...
| Vanilla-calibrated scale | `validation/reimport_vanilla_infantry_calibration.json`, `evidence/geometry_gate.json` | scale evidence complete; entity scale `0.8` pending parent wiring |
...
| Runtime registration | `runtime/handoff.md` | parent-owned and pending |
