# The Nile Pump Congress asset handoff
...
The sprite is registered as `GFX_report_event_fallout_nile_pump_congress` in `interface/fallout_world_end.gfx` and consumed by events 579 through 585.
