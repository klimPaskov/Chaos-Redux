...
| --- | --- | --- | --- | --- | --- |
| `670.work_for_rations.report_event` | Fallout report-event card showing a Food Compact harvest crew working for ration allocation | source PNG to processed PNG | `gfx/event_pictures/fallout_world_end/report_event_fallout_work_for_rations.dds`, sprite `GFX_report_event_fallout_work_for_rations` | Candidate 670 report-event picture consumer | wired |
...
- Related localisation key: `chaosx.fallout.670.t`
- Related event/UI id: candidate `670`, Work for Rations. Gameplay wiring is recorded in the event source and localisation files
