# Event 014 Static GUI and Non-Portrait Animation Production Brief
...
Leader portrait production is outside this archive. The authoritative ordinary, warlord, and transformed portrait sources, animations, manifests, and runtime handoffs live under `../leader_portraits_refresh/`.
