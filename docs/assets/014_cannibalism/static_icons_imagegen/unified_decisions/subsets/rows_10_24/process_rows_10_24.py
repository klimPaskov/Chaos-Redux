...
ASSETS = [
    ...
    (21, "cannibalism_unified_recruit_lockhouse_column", "Recruit a Lockhouse Column", "war_machine", "A compact wheeled prison cage with a heavy barred door and padlock, its axle and floorboards streaked with blood."),
