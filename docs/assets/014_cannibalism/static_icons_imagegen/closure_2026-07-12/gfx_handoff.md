# Event 014 closure GFX handoff

All 21 textures were preregistered before production. No GFX edit is required and this asset task did not modify any GFX file.
...
| GFX_decision_category_cannibalism_achievement_tracker | gfx/interface/decisions/014_cannibalism/decision_category_cannibalism_achievement_tracker.dds |
| GFX_cannibalism_achievement_tracker_category_panel | gfx/interface/decisions/014_cannibalism/cannibalism_achievement_tracker_category_panel.dds |
| GFX_decision_cannibalism_wendigo_launch_terminal_hunt | gfx/interface/decisions/014_cannibalism/decision_cannibalism_wendigo_launch_terminal_hunt.dds |
| GFX_decision_cannibalism_wendigo_terminal_hunt_mission | gfx/interface/decisions/014_cannibalism/decision_cannibalism_wendigo_terminal_hunt_mission.dds |
| GFX_decision_cannibalism_wendigo_press_terminal_hunt | gfx/interface/decisions/014_cannibalism/decision_cannibalism_wendigo_press_terminal_hunt.dds |
| GFX_decision_cannibalism_break_wendigo_terminal_hunt | gfx/interface/decisions/014_cannibalism/decision_cannibalism_break_wendigo_terminal_hunt.dds |
| GFX_decision_cannibalism_muster_wendigo_pack_from_enemy_death_receipt | gfx/interface/decisions/014_cannibalism/decision_cannibalism_muster_wendigo_pack_from_enemy_death_receipt.dds |
| GFX_decision_cannibalism_activate_inherited_winter_cell | gfx/interface/decisions/014_cannibalism/decision_cannibalism_activate_inherited_winter_cell.dds |

No sprite-name, texture-path, frame-count, or target-file uncertainty remains.
