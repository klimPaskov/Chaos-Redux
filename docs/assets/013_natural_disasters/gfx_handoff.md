...
Authoritative target `.gfx` file: `interface/013_natural_disasters.gfx`
...
The two remaining abnormal identities are registered in the shared general super-event presentation at slots 71 and 72 through `interface/chaosx_super_events.gfx`. They are intentionally outside the direct Event 013 aftermath and abnormal-map GUI.

| Sprite | Live DDS path |
| --- | --- |
| `GFX_super_event_nd_abnormal_disaster_age` | `gfx/super_events/013_natural_disasters/super_event_nd_abnormal_disaster_age.dds` (slot 71) |
| `GFX_super_event_nd_delayed_tsunami_chain` | `gfx/super_events/013_natural_disasters/super_event_nd_delayed_tsunami_chain.dds` (slot 72) |
