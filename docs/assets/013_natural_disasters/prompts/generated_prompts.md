...
- `idea_013_disaster_aftermath_source`: shattered masonry, cracked ground, broken roof beams, smoke-dusted rubble, compact HOI4 national-spirit icon, solid chroma-key source background, no text, no frame, no circular badge, no purple/magenta/green/white matte.
- `idea_013_refugee_pressure_source`: displaced civilians with bundles and a handcart near damaged shelter canvas, compact HOI4 national-spirit icon, solid chroma-key source background, no text, no frame, no circular badge, no purple/magenta/green/white matte.
- `idea_013_famine_pressure_source`: empty ration bowl, cracked spoon, torn ration coupons, dry wheat stalks, compact HOI4 national-spirit icon, solid chroma-key source background, no text, no frame, no circular badge, no purple/magenta/green/white matte.
- `idea_013_broken_infrastructure_source`: twisted railway track, snapped telegraph pole, cracked road slab, broken bridge timber, compact HOI4 national-spirit icon, solid chroma-key source background, no text, no frame, no circular badge, no purple/magenta/green/white matte.
- `idea_013_disaster_recovery_mobilization_source`: crossed engineer shovel and stretcher pole, rolled blueprint, supply crate, emergency armband, compact HOI4 national-spirit icon, solid chroma-key source background, no text, no frame, no circular badge, no purple/magenta/green/white matte.
