...
- One 1120 by 760 muster-board background is processed under `processed_png/gui/` and `gfx/interface/019_infantry_spawn/`.
...
- GUI review: `contact_sheets/event_019_gui_background_contact_sheet.png`.
