# Utopia Balance to Choice — Animation Brief

- Asset: `utopia_balance_to_choice`
- In-game use: state-driven threshold transition toward Choice in the Commonwealth Ledger.
...
- Anchor: center; the instrument body and camera remain fixed while its branching mechanism changes state.
- Static fallback: processed frame 007, the completed Choice state.
- Static sprite: `GFX_utopia_balance_to_choice_static`.
- Animated sprite: `GFX_utopia_balance_to_choice_animated`.
- Subject classification: symbolic, people-free, text-free late-1930s civic instrument.
- Visual action: a restrained brass-and-blackened-steel measuring rail physically unlatches into branching civic paths while loose brass tokens gain independent routes.
...
- Final PNG sheet: `docs/assets/015_utopia_manifesto/animations/utopia_balance_to_choice/sheets/utopia_balance_to_choice_sheet.png`.
- Final static PNG: `docs/assets/015_utopia_manifesto/animations/utopia_balance_to_choice/sheets/utopia_balance_to_choice_static.png`.
- Final sheet DDS: `gfx/interface/015_utopia_manifesto/utopia_balance_to_choice_sheet.dds`.
- Final static DDS: `gfx/interface/015_utopia_manifesto/utopia_balance_to_choice_static.dds`.
