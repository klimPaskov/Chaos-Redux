# Utopia Balance to Choice — GFX and GUI Handoff
...
```txt
spriteType = {
	name = "GFX_utopia_balance_to_choice_static"
	texturefile = "gfx/interface/015_utopia_manifesto/utopia_balance_to_choice_static.dds"
}

frameAnimatedSpriteType = {
	name = "GFX_utopia_balance_to_choice_animated"
	texturefile = "gfx/interface/015_utopia_manifesto/utopia_balance_to_choice_sheet.dds"
	noOfFrames = 8
...
- Show `GFX_utopia_balance_to_choice_animated` on the state transition into Choice.
- After the non-looping transition, show `GFX_utopia_balance_to_choice_static` while the Choice state remains reached.
