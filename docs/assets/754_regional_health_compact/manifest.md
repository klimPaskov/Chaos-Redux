# Regional Health Compact asset manifest

Regional Health Compact uses one dedicated report image. It shows fictional medical teams exchanging clinic ledgers and medicine on a guarded ash road between the North Gate Health Corridor and Ash Ward. It contains no real people, flags, or readable text, and it is not reused by another Fallout chain.
...
The DDS is an uncompressed A8R8G8B8 210 x 176 texture generated from the processed PNG. The documentation copy and runtime copy use the same file hash.
