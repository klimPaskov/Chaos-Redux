...
| Air Winter dead-city salvage | `chaosx.fallout.47` and `chaosx.fallout.48` | Lamp-lit municipal salvage route beneath collapsed ash and ice covered city blocks | Built-in `$imagegen`, fictional period documentary | `source_png/report_events/report_event_air_winter_dead_city_salvage_source.png` | `processed_png/report_events/report_event_air_winter_dead_city_salvage.png` | `gfx/event_pictures/fallout/air_winter/report_event_air_winter_dead_city_salvage.dds` | `GFX_report_event_air_winter_dead_city_salvage` | `interface/air_cleanliness_winter.gfx` | `complete` |
...
The existing Phase 1 asset covers all five regional openings and their shared return, events 1 through 6. The regional return tranche creates no new source PNG, processed PNG, DDS, sprite, audio, or runtime path.
...
#### Air Winter island refugee harbor

```text
Use case: historical-scene
Asset type: fictional Hearts of Iron IV report-event source photograph
Primary request: civilian refugee boats crowding a small island harbor or improvised anchorage during the Air Winter in the early 1940s
Scene/backdrop: a low rocky island shoreline under cold rain, rough winter surf beyond the harbor mouth, a cramped improvised quay, simple quarantine sheds close to the water, and dim overcast winter daylight
Subject: several civilian fishing boats and two small coastal freighters riding visibly low with bundled civilian passengers and baggage, packed tightly in the anchorage while a compact period patrol launch approaches to control arrivals
Style/medium: photorealistic period documentary photograph made with 1936 to 1945 photographic technology, authentic black-and-white press photography, natural film grain, modest dynamic range, unstaged field-reporting realism
Composition/framing: landscape 3:2 mid-wide view from shore level, crowded low-riding boats form the central story, patrol launch and quarantine sheds remain clearly readable, important subjects kept away from extreme edges for a later 4:3 cover crop, no decorative border
Lighting/mood: dim winter light, slanting cold rain, rough gray water, urgency and overcrowding without graphic suffering
Constraints: fictional unnamed people only, period-accurate civilian clothing, fishing craft, coastal freighters, patrol launch, harbor structures and baggage, physically plausible sea and weather, no readable text, no signage, no flags, no logos, no watermark, no colorized treatment, no modern objects, no UI, no map, no split panel, no collage, no frame, no card treatment, no zombies, no supernatural creatures
```

#### Air Winter dead-city salvage

```text
Use case: historical-scene
Asset type: fictional Hearts of Iron IV report-event source photograph
Primary request: night salvage crews crossing an ice and ash covered urban service street beneath collapsed building facades during an unnatural deep winter in the early 1940s
Scene and backdrop: a dense unnamed Eurasian industrial city district, broken tram conduits, partially collapsed masonry blocks, sagging utility galleries, frozen pipes, black ash mixed with snow, and one period cargo truck guarded at a cordon
Subject: fictional municipal engineers, firefighters, railway workers, and utility crews carrying hooded lamps, timber braces, hand tools, cable reels, and numbered equipment crates along one carefully marked route
Style and medium: photorealistic period documentary photograph made with 1936 to 1945 photographic technology, authentic black and white press photography, natural grain, modest dynamic range, and physically plausible cold and structural damage
Composition and framing: landscape 3:2 mid-wide view, crews and braced route clearly readable, guarded truck in the middle distance, collapsed facades framing the service street, important subjects away from extreme edges for a later 4:3 cover crop, and no decorative border
Lighting and mood: dim night, lamps and shielded truck lights cutting through ash and frost, disciplined dangerous work, and no heroic pose
Constraints: fictional people only, period-accurate clothing, vehicles, architecture, and tools, no readable text, no signage, no watermark, no modern objects, no UI, no map, no split panel, no collage, no frame, no card treatment, no supernatural creature, no mutant figure, no zombie motif, no gore, no logo
```
