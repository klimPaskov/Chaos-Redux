...
| `archetype_choking_chemical_air_payload` | `GFX_archetype_choking_chemical_air_payload_medium` | 131x52 | `gfx/interface/technologies/stage_6_chemical_delivery/equipment/archetype_choking_chemical_air_payload.dds` | `interface/cbrn_chemical_delivery.gfx` | `archetype_choking_chemical_air_payload` |
| `archetype_blister_chemical_air_payload` | `GFX_archetype_blister_chemical_air_payload_medium` | 131x52 | `gfx/interface/technologies/stage_6_chemical_delivery/equipment/archetype_blister_chemical_air_payload.dds` | `interface/cbrn_chemical_delivery.gfx` | `archetype_blister_chemical_air_payload` |
| `archetype_nerve_chemical_air_payload` | `GFX_archetype_nerve_chemical_air_payload_medium` | 131x52 | `gfx/interface/technologies/stage_6_chemical_delivery/equipment/archetype_nerve_chemical_air_payload.dds` | `interface/cbrn_chemical_delivery.gfx` | `archetype_nerve_chemical_air_payload` |
| `archetype_incapacitating_chemical_air_payload` | `GFX_archetype_incapacitating_chemical_air_payload_medium` | 131x52 | `gfx/interface/technologies/stage_6_chemical_delivery/equipment/archetype_incapacitating_chemical_air_payload.dds` | `interface/cbrn_chemical_delivery.gfx` | `archetype_incapacitating_chemical_air_payload` |
| `cbrn_chemical_air_operation` | `GFX_raid_type_icon_cbrn_chemical_air_operation` | 32x32 | `gfx/interface/raids/stage_6_chemical_delivery/cbrn_chemical_air_operation.dds` | `interface/cbrn_chemical_delivery.gfx` | `cbrn_chemical_air_operation` |
...
The 21 equipment declarations and the raid declaration follow the same one-line `spriteType` form with the exact sprite and texture pairs listed above. No new sprite name or DDS path is proposed.
...
| `archetype_choking_chemical_air_payload` | `source_png/equipment/archetype_choking_chemical_air_payload_source.png` | `processed_png/equipment/archetype_choking_chemical_air_payload.png` | `dds/equipment/archetype_choking_chemical_air_payload.dds` | `gfx/interface/technologies/stage_6_chemical_delivery/equipment/archetype_choking_chemical_air_payload.dds` |
| `archetype_blister_chemical_air_payload` | `source_png/equipment/archetype_blister_chemical_air_payload_source.png` | `processed_png/equipment/archetype_blister_chemical_air_payload.png` | `dds/equipment/archetype_blister_chemical_air_payload.dds` | `gfx/interface/technologies/stage_6_chemical_delivery/equipment/archetype_blister_chemical_air_payload.dds` |
| `archetype_nerve_chemical_air_payload` | `source_png/equipment/archetype_nerve_chemical_air_payload_source.png` | `processed_png/equipment/archetype_nerve_chemical_air_payload.png` | `dds/equipment/archetype_nerve_chemical_air_payload.dds` | `gfx/interface/technologies/stage_6_chemical_delivery/equipment/archetype_nerve_chemical_air_payload.dds` |
| `archetype_incapacitating_chemical_air_payload` | `source_png/equipment/archetype_incapacitating_chemical_air_payload_source.png` | `processed_png/equipment/archetype_incapacitating_chemical_air_payload.png` | `dds/equipment/archetype_incapacitating_chemical_air_payload.dds` | `gfx/interface/technologies/stage_6_chemical_delivery/equipment/archetype_incapacitating_chemical_air_payload.dds` |
| `cbrn_chemical_air_operation` | `source_png/raids/cbrn_chemical_air_operation_source.png` | `processed_png/raids/cbrn_chemical_air_operation.png` | `dds/raids/cbrn_chemical_air_operation.dds` | `gfx/interface/raids/stage_6_chemical_delivery/cbrn_chemical_air_operation.dds` |
...
- `contact_sheets/equipment_archetype_additions_checker.png`
- `contact_sheets/idea_cbrn_first_chemical_shock_checker.png`
- `contact_sheets/raid_cbrn_chemical_air_operation_checker.png`
- `gfx_handoff.md`

## Source provenance and visual review

All source PNGs are generated masters from two built-in imagegen runs stored temporarily under `C:/Users/klimp/.codex/generated_images/019f5f49-4f90-7fe0-a28e-04445a687699/` and `C:/Users/klimp/.codex/generated_images/019f5faa-fa33-7402-b2d3-b9a97e98f224/`; package-local source files are the preserved handoff artifacts. The four archetype concepts were generated independently by payload class, and the raid icon was generated independently as an aircraft/droplet/target map emblem. The idea icon remains a separate prior asset. The processed contact sheets show transparent corners over checkerboard backgrounds and retain separate silhouettes at final-size review scale.

## Validation evidence

- 21 equipment source PNGs, 21 equipment processed PNGs, 21 equipment archive DDS files, and 21 equipment runtime DDS files exist after this addition.
- The four new equipment processed PNGs are exact `131x52` RGBA images with alpha range `0..255` and transparent corners; the new raid preview is an exact `32x32` RGBA image with alpha range `0..255` and transparent corners.
- The four new equipment DDS files are exact `131x52` files of `27,376` bytes; the new raid DDS is exact `32x32` and `4,224` bytes. All use `DDS ` magic, 124-byte legacy headers, flags `65` (`RGB | ALPHAPIXELS`), 32-bit BGRA masks, `DDSCAPS_TEXTURE`, and zero mip levels.
- New source SHA-256 values are unique across all five masters; new processed PNG and archive DDS SHA-256 values are also unique. Archive/runtime hashes match byte-for-byte for all five new assets.
- The five runtime paths and sprite IDs are present in the parent declarations in `interface/cbrn_chemical_delivery.gfx`; no `.gfx` edit was made here.
- 1 idea source PNG, 1 idea processed PNG, 1 idea archive DDS, and 1 idea runtime DDS exist.
- Existing package validation remains: the idea preview is exact `64x64` RGBA with transparent corners and real alpha; the existing 17 equipment/runtime pairs are retained.
- No source concept is a resized or recolored copy of another requested asset; the raid icon is a separate imagegen output and not a resized equipment icon.

New-asset hash ledger:

| Asset ID | Source PNG SHA-256 | Processed PNG SHA-256 | Archive/runtime DDS SHA-256 |
|---|---|---|---|
| `archetype_choking_chemical_air_payload` | `cc7b05fb92762ce5f6d467cdaff55aa76798aed3f0649089309a2d5fa601755d` | `7983a7d732ca69e57d8d61045859a410fd4972d99946514db8c4c6d4a19e6c5d` | `064f3d89642be933e8473f3cd3241d8d72f10413da0346fd7a70bd081e2d3edd` |
| `archetype_blister_chemical_air_payload` | `d00ae922fb3dddf588678aab58ed0c17b9ea27a60184e392dd70a576033d3209` | `3f1c61c781804d51cb503277459871c776471ab9b3eb9fb50e95a59e0335b374` | `461a43ed43aea53106001adab95e7524552a8991d084b4a7c68fdfa17618d27e` |
| `archetype_nerve_chemical_air_payload` | `89d1f261740adfcb05114325c7253bb28b448c4e2a517f00964165716df85063` | `6e4fae7ddeebbb41cc3a8f0423a7207f7d7b49fa0ea30181c23c856cac131e5b` | `b19b698789a4d7a89ab26535ffaa97f511809676aa7dc16a4acb65b53ab5336c` |
| `archetype_incapacitating_chemical_air_payload` | `addcecac683c22d46a4789a6d8e16743882133edb0db6c2a6fa9da38fdcd0c26` | `a1dc9d6027be7aee874d34059ceb8378e15f0a22a571b6431bd330e5a30b8cb8` | `ce29723d7508ed95f7f36ac19b4e37f29c04b671cc40bf8b3ebaf60703f05fa9` |
| `cbrn_chemical_air_operation` | `6464e2fb99595b9a921541c428f69b35514a4b9a1ac04b77ddd67dbab00b589c` | `ebee934b67a1de615bed3ed92881e774fc2707379e1b6c12c24c80782ca37b3a` | `5d7bd24b26fc3df3a3980de4140763d83b6ada5b913cec7c0c121bc15073a81a` |

## Changed path families

- New source masters: `source_png/equipment/` (four) and `source_png/raids/` (one).
- New processed previews: `processed_png/equipment/` (four) and `processed_png/raids/` (one).
- New archive DDS copies: `dds/equipment/` (four) and `dds/raids/` (one).
- New runtime DDS outputs: `gfx/interface/technologies/stage_6_chemical_delivery/equipment/` (four) and `gfx/interface/raids/stage_6_chemical_delivery/` (one).
- New review sheets: `contact_sheets/equipment_archetype_additions_checker.png` and `contact_sheets/raid_cbrn_chemical_air_operation_checker.png`.
- Updated package records: `manifest.md`, `prompts/stage_6_prompts.md`, and `gfx_handoff.md`.

## Unresolved risk

No asset is blocked. The only remaining non-blocking review risks are normal in-game UI scaling/colour-management variation and the small raid emblem's expected readability variation at 32x32; the checkerboard sheets provide final-size review evidence. This handoff does not claim the wider chemical-delivery system complete.
