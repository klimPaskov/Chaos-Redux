...
| Chemical facility identity | `refs/briefs/meshy_input_prompt.md` | `cw_facility_mesh` | complete |
...
| `.mesh` export and reimport | `export/mesh/`, `validation/` | `gfx/models/buildings/cw_facility.mesh` | exported and reimported |
| Runtime building consumer | `common/buildings/chaosx_buildings.txt`, `gfx/entities/chaosx_buildings.asset`, `gfx/entities/chaosx_buildings.gfx` | `cw_facility` | wired and deduplicated |
