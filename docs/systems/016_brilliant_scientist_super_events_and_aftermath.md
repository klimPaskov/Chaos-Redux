...
The six final OGG files live under `sound/016_brilliant_scientist/`, with shared sound, music, scripted-localisation, and settings-aware playback mappings for visible IDs `90` through `95`.
