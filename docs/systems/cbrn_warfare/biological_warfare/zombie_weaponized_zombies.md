...
- Hostile deployments register strategic bioweapon condemnation in the public biological bucket with `weaponized_zombies` context. Existing biological integrated-operations reductions scale the source gain before it enters the shared condemnation system described in `docs/systems/cbrn_warfare/condemnation/condemnation_sanctions.md`.
