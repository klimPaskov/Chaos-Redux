...
- Composer / creator: Ludwig van Beethoven.
- Performer / recording: Czech National Symphony Orchestra via Musopen and Wikimedia Commons.
...
- License: CC0 recording, public domain composition.
- Duration: 1:48 final cue.
- Conversion notes: prepared from the source OGG with loudness normalization and fade-out. OGG and WAV are rendered from the same source.
...
- Composer / creator: Gustav Holst.
- Performer / recording: Gustav Holst conducting the New Queen's Hall Light Orchestra, 1923 recording via Wikimedia Commons.
...
- License: public domain recording, public domain composition.
