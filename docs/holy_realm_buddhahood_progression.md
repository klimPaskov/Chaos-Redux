...
- Add animated frame-sheet variants for the remaining Mandala states and leader portrait stages. Static fallback Mandala and leader portrait stage DDS files are already wired; awakened and Final Silence Mandala states have animated frame sheets.
