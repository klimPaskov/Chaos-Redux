...
| `chemical_warfare_folder` | `Screenshot 2026-09-20 172056.png` | 40 nodes | Check all 40 placements before comparing the visible section, including the separate `mobile_cbrn_hospitals` gridbox and connector routing. |
