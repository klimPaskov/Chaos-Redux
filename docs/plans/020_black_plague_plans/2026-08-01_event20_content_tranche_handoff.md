...
- The RTX court's Royal Strike is now a state-targeted wartime operation. It selects a human-controlled enemy state, spends Dominion and Brood Mass, reserves one civilian factory for 45 days, applies the canonical Rat Occupation exposure, and sets separate country and state cooldowns for 90 days.
