...
- Super-events and audio: Death super-event ids 62-65 are wired through scripted localisation, `interface/chaosx_super_events.gfx`, `sound/chaosx_sound.asset`. Audio files exist and `ffprobe` reports valid 44.1 kHz WAV streams for the four Death super-event tracks.
