...
- Fresh actual-byte preview proofs later succeeded from byte-identical temporary copies without modifying runtime. Mesh, attack, and death contact sheets are `F1E258E8E826FB0A49F6A551A2C977D39CD0197BE59F60F67B042F6EE8DA04D9`, `8B4F516607373D74D83E464A3685D8FBB87BDE304FFF17839EF78C27105D997C`, and `D726E978A44FFD0C7687F449BC20DCAE6706B6A55C055C363F81E7764704D08A`; visual review found a coherent textured silhouette, grounded strike, and grounded collapse without visible clipping or shear.
- Idle quarter request `c3231525b22440b6bb02d50b6324dc28` sampled frames 1/13/25/37/49 with ground contact from `-0.0000001863` to `+0.0000121742`. Decoded front-view RGBA pixels at frames 1/25/49 share SHA-256 `8B07975634E686A3AA35200BB135B201012E405BBFC56AB67656F03E9E74798F`; frame 13 is `8BC073279891613E1084278D289FA609E3F0E932EFBE7D6E4836D884FD339F2E` and frame 37 is `F465AFD73EB3692AB0BF285F6BB03BED56B4A244C4C86D2A68B52D602556E02C`. The loop therefore has visible quarter-phase motion and returns exactly to neutral at midpoint and end.
...
1. Audible review of the seven mechanically converted licensed WAVs, especially movement-contact balance and idle overlap, was not performed; source provenance, recipes, static signal evidence, sound definitions, and entity hooks are complete.
2. Live in-game validation of the copied model, actions, sound hooks, and counters was explicitly waived by the user. Source-to-runtime hashes, static bindings, actual-byte reimports, model/action visual evidence, and counter review are complete, but no in-game claim is made.
3. Preserve `docs/plans/018_resources_found_plans/subagent_handoffs/event018_cave_audio_recipe_reconstruction_2026-08-10.md` as the durable normalized-command and six-exact-plus-one-LSB reproduction record.
