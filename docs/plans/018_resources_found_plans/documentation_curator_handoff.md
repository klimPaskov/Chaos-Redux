...
| Visual and audio package | `docs/events/018_resources_found/assets.md`, `docs/super_events/018_resources_found/overview.md`, and permanent specialist handoffs | Current. Runtime files, registrations, provenance conclusions, licensing, and handoff evidence are preserved after temporary-workspace cleanup. |
| Static icon provenance | `docs/events/018_resources_found/assets.md`, `subagent_handoffs/icon_provenance_repair_handoff.md`, and `subagent_handoffs/event018_two_focus_icons_2026-08-09.md` | Current. The original 150 generated focus, idea/state, decision, and category assets plus the two later hierarchy focus icons have durable source-to-runtime audit conclusions and registrations. |
...
| `subagent_handoffs/focus_tree_auditor_handoff.md` | Its gameplay and original 65-focus audit remains valid as a historical checkpoint. The later current tree contains 67 focuses because Count Every Vein and Chamber Autonomy were restored as standalone hierarchy mechanics; current MCP and final audit evidence supersede its exact-count conclusion. Its then-pending idea/state GFX dependency is closed by the country-package audit and durable asset record. |
...
The durable asset record states that the visual and audio package is complete and wired. Its current inventory includes 10 report images, 6 news images, 3 super-event images, the Oth-Kesh portrait and flag packages, 67 focus icons, 36 unique idea/state icons, 39 decision-family icons mapped across 125 visible decisions and missions, 5 category icons, 5 category pictures, 15 complete achievement triplets, and the selected-field UI package with five real-frame animation families and required static fallbacks. The original provenance audit records 150 unique generated static icons and category assets with one-to-one source, processed, runtime, and registration evidence; the two later hierarchy focus icons have separate permanent round-trip and registration evidence.
