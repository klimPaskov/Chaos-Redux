...
> Historical completion report dated 2026-08-22. It records the bounded tranche and its dated validation limits. Later concurrent changes and the current documentation batch require the status ledger in [`documentation_state.md`](documentation_state.md) for current task routing. This report does not certify current gameplay behavior or repository-wide completion.
...
The cleanup-owned localisation paths were [`localisation/english/chaosx_gui_l_english.yml`](../../../localisation/english/chaosx_gui_l_english.yml), [`localisation/english/condemnation_sanctions_l_english.yml`](../../../localisation/english/condemnation_sanctions_l_english.yml), [`localisation/english/fallout_consolidated_l_english.yml`](../../../localisation/english/fallout_consolidated_l_english.yml), `localisation/english/006_independence_wave_evolution_incidents_l_english.yml`, [`localisation/english/016_brilliant_scientist_foreign_l_english.yml`](../../../localisation/english/016_brilliant_scientist_foreign_l_english.yml), and [`localisation/english/018_resources_found_decisions_l_english.yml`](../../../localisation/english/018_resources_found_decisions_l_english.yml).
The dated Event 006 path above is retained as historical text. The original target is absent in the current tree. A related current path exists at [`localisation/english/006_independence_wave_evolution_l_english.yml`](../../../localisation/english/006_independence_wave_evolution_l_english.yml), and this report does not infer a rename or equivalence.
...
The changed-file list retains the dated Event 006 path. The original target is absent in the current tree. The related current path is [`localisation/english/006_independence_wave_evolution_l_english.yml`](../../../localisation/english/006_independence_wave_evolution_l_english.yml), with no rename or equivalence inferred.
