...
The five cells used the concise premise wording recorded in `localisation/english/chaosx_gui_l_english.yml` for that pass, with paragraph breaks preserved as in-game detail text.
