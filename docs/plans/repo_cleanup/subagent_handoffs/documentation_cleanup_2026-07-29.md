...
| Event 002 overview main-file list | Implemented documentation correction | Replaced deleted aggregate paths with `events/002_zombie_outbreak.txt`, the two Event 002 scripted helpers, `002_zombie_constants.txt`, the actual localisation file, and `docs/systems/events_log_evolutions_and_clusters.md`. |
