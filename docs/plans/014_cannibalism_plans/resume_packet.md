...
5. The four super-event audio registrations are closed. The four remaining unit families now have 26 source-derived runtime WAVs and sound definitions, and CBA-CBH/CBL country-level infantry idle voices are registered; Bone Riders playback, action synchronization, entity binding, and live validation remain open.
...
3. Audit parent-owned entity/action/sound wiring against the current nine-family and no-toggle contracts; the four super-event audio registrations are already reconciled.
