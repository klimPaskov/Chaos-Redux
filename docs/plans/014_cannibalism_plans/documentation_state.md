...
| Catalog workbook | `docs/spreadsheets/chaos_redux_events_catalog.xlsx`, refreshed exports, and `subagent_handoffs/event014_spreadsheet_final_2026-08-26.md` | `Events!N15` and `Scenarios!F10` remain `Needs Testing`; Event 014 detail wording is synchronized in `Events!C15` | Spreadsheet audit corrected the Event 014 detail cell and reran the required CSV exporter; statuses remain intentionally unpromoted while runtime evidence gates are open. |
...
- A fourth narrow normal-state retry succeeded for `cannibalism_wendigo_command_window` under scenario `event014_targeted_wendigo_normal_2026_08_26`; its attributable artifact is `hoi4-agent://workspace/mod_chaos_redux_ea3b2d67c2c0/artifact/5dca062f0ceea5b6be78543b2af1390a739f0896c5517587b74aaa42190738c7/c1147862a72d029d8758fa6001bf4fb06b1b452fe027cf599528d524fb451000/cannibalism_wendigo_command_window-full.svg`.
- This retry returned `GUI_RENDERED`, `status = ok`, no blockers, and no source changes; its wire response was truncated with no retained validation checks, so it improves attributable normal-state coverage only.
- A fifth narrow normal-state retry succeeded for `cannibalism_early_header_window` under scenario `event014_targeted_early_normal_2026_08_26`; its attributable artifact is `hoi4-agent://workspace/mod_chaos_redux_ea3b2d67c2c0/artifact/fcfae968916de2c03f1a02f42bf5dc720fcc83c255414d77af125652efc1ea15/8125dc30b9ff7c09aef73f58932d0b39e5103b80b2f839b2bcb203bb5e0bdf73/cannibalism_early_header_window-full.svg`.
- This retry returned `GUI_RENDERED`, `status = ok`, no blockers, and no source changes; its wire response was truncated with no retained validation checks, so all five Event 014 windows now have attributable normal-state render artifacts, while the broader state/resolution/click-region/comparison matrix remains open.

- A fresh narrow `hoi4_gui_inspect` retry for `cannibalism_network_window` with scenario `{id: event014_targeted_network_hover_2026_08_26}` returned `GUI_INSPECTED`, `status = ok`, and `inspectedElementCount = 27`. Artifact: `hoi4-agent://workspace/mod_chaos_redux_ea3b2d67c2c0/artifact/998f36cf25d3ab144ea082ba6a0da12c72a120d746c9fd334e56e444358d6069/0e79a5d3002790e375dd8e96e39b0a297d2076b785abefb1cd4c7570b757ee3a/gui-inspect.ab952c5cac7a12e5.json`.
- The linked inspect reports `complete = true` for the selected window, but its global graph contains 74,038 nodes, 158,241 edges, and 25,332 elements. Validation remains false because the fixed diagnostic ceiling is saturated by unrelated workspace errors; retained validation counts include 24 accidental-clipping, 21 child-outside-clipped-parent, 11 visible-overlap, eight missing-button-trigger, one click-bounds-mismatch, one text-overflow, and one inconsistent-spacing finding without an attributable Event 014 path in the retained stream. Fidelity counts for this selected window are 246 modelled, 10 approximated, 33 ignored, three missing, 16 unsupported, and three unresolved.
- A matching single-state hover `hoi4_gui_render` request for the same window, scenario, and `1920x1080` resolution timed out after 180 seconds without an attributable artifact. No GUI source rewrite was justified.

## 2026-08-26 fresh probability evidence

- `hoi4_probability_inspect` with `mission_ai_will_do` on `common/decisions/014_cannibalism_decisions.txt` returned `PROBABILITY_SOURCE_DISCOVERED`, `requested_adapter_empty`, and a typed `decision_ai_will_do` suggestion with 95 available candidates and no inspect diagnostics. Artifact: `hoi4-agent://workspace/mod_chaos_redux_ea3b2d67c2c0/artifact/e529c12a3f5b45887c288ec56145eeed67378032799ce1e58afffac7d6cc1de6/d3a4c054808ed857f0cc76fa7962ad8bef1ff599391322fc0b7e93af14ba1bd7/probability-inspect-40b350276492.json`.
- The matching `decision_ai_will_do` inspection returned `PROBABILITY_SOURCE_INSPECTED` with 95 candidates, 32 required inputs, zero inspect-unresolved inputs, and an incomplete runtime pool. Artifact: `hoi4-agent://workspace/mod_chaos_redux_ea3b2d67c2c0/artifact/1d502c78394be13ad03f542f7baefe069381879a4b5fa0fa51f20c86811c1d72/45f22084101c85608664eb494bce43bcc2b8413c77825bbf0abdbc6bc2f2f07a/probability-inspect-40b350276492.json`.
- `event_option_ai_chance` on `events/014_cannibalism.txt` returned `PROBABILITY_SOURCE_INSPECTED` with 40 candidates, 15 required inputs, one unresolved input, and an incomplete runtime pool. Artifact: `hoi4-agent://workspace/mod_chaos_redux_ea3b2d67c2c0/artifact/214213b7cfba3676e6e02adfb7d1d8818ddcba83f0833ec758834067c56edf65/084a40155020222f014f686a91d6f1cc70d162cef56566bc1a039c37a28b9a6/probability-inspect-43741ef93efa.json`.
- `random_list` on `common/scripted_effects/014_cannibalism_effects.txt` returned `PROBABILITY_SOURCE_INSPECTED` with 42 candidates, five required inputs, one unresolved input, and an incomplete runtime pool. Artifact: `hoi4-agent://workspace/mod_chaos_redux_ea3b2d67c2c0/artifact/a58c096a3ab1c57e5399f2126a4d90eb0a4e9dd998143abbdd6369f32ba25f54/250d92690d505abed14e21b2b62c46d1799389430974ac791dce0ce9e543ddd9/probability-inspect-bcfa8fcbd350.json`.
- `national_focus_ai_will_do` on `common/national_focus/014_cannibalism_focus.txt` returned `PROBABILITY_SOURCE_INSPECTED` with 204 candidates, 15 required inputs, zero inspect-unresolved inputs, and an incomplete runtime pool. Artifact: `hoi4-agent://workspace/mod_chaos_redux_ea3b2d67c2c0/artifact/ecc8437cffc2de4f677e83d43dd75c3e9fc686b12b5db43d4f8bacbce2c0c274/6dfe05690939890a490316ec7d53834ee6d575dc084a09544a28a1aa1ec8ddf1/probability-inspect-54cd8e05f959.json`.
- `ai_strategy_factor` on `common/ai_strategy/014_cannibalism_warlords.txt` returned `PROBABILITY_SOURCE_DISCOVERED` with `no_weighted_surfaces` and no unresolved inputs. Artifact: `hoi4-agent://workspace/mod_chaos_redux_ea3b2d67c2c0/artifact/7e3e67ba2e29ec9e55f74f63c46bc2e37e1bfa7989d35e97f63b4adbedd3310d/224a2352d89414068d1db128947b03b86be15684d51db253d4efdd138dce8171/probability-inspect-02bd4b54a3b6.json`.
- These fresh calls are read-only source/adapter evidence. They do not certify campaign frequencies, deterministic host/state selectors, lifecycle cadence, mission probabilities, or before/after balance comparisons; the documented probability sign-off remains incomplete where the adapter cannot type those inputs.

## 2026-08-26 fresh Event 014 event-inspect evidence

- A refreshed `hoi4_event_inspect` lint request for `{kind: event, eventId: chaosx.nr14.1}` returned `EVENT_INSPECTED_PARTIAL` at revision `744cd12bca3e5b1a25d3d012a4e58a1e2c4e3623c268724b38679e806883d9`, graph hash `4b0d98848c436e8f6c8363056e3ae62cfad7785e4b2f1396ac9f1439f91de8df`, and zero blocking diagnostics in the selected Event 014 boundary. Artifact: `hoi4-agent://workspace/mod_chaos_redux_ea3b2d67c2c0/artifact/d31c9081de10ac6c6aa7b9aa1ab060509893ac110b68a4465613e24ae0f0a364/056668f52e7c52b7c9589b121dd0a1c51ee1ab41b891d3e174c365790c93d1ce/event-lint-744cd12bca3e.json`.
- The partial adapter report covered 9,513 events, 14,705 options, 1,075 entries, 8,314 unresolved nodes, 7,651 terminals, 37,146 edges, 28,243 state accesses, and 2,130 issues. Its only surfaced diagnostic was informational `MCP_INLINE_FILES_TRUNCATED`; workspace-wide helper and lifecycle projections remain deferred by the large repository, so this is not a claim of full-workspace validation or live gameplay completion.
