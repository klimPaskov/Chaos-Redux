...
- The four OGG files and four WAV files are unique and match the hashes recorded in `docs/super_events/014_cannibalism_super_event_audio_research.md`.
- `ffprobe` identified all eight files as stereo 44.1 kHz audio. OGG/WAV durations were 114.0/114.0 seconds for ID 49, 120.0/120.0 for ID 50, 116.1/116.001 for ID 52, and 118.0/118.0 for ID 53.
