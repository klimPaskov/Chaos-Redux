...
| P1-05, slots 69 and 70 lacked researched cultural remarks | Closed | Slot 69 now uses "Who is able to stand?" at `localisation/english/013_natural_disasters_l_english.yml:353`, matching `docs/super_events/013_natural_disasters/archive/text_research.md:200-204`. Slot 70 now uses "Here's a night pities neither wise men nor fools." at line 357, matching the researched direction at lines 268-277. |
...
The selected-country and selected-state API documentation matches the live proof contract. `docs/events/013_natural_disasters/overview.md:37` names both regular event targets and both `*_supplied` proofs. The validator checks those pairs at `common/scripted_effects/013_natural_disasters_effects.txt:326-380`, and public inputs are reset at lines 466-467.
