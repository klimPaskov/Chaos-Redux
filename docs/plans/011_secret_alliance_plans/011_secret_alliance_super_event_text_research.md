...
## Superseded working plan

This early working plan is superseded by the authoritative source specification and the completed implementation handoff.
...
- main quote `All warfare is based on deception.` from Sun Tzu's *The Art of War* in Lionel Giles's 1910 translation
- button fragment `Look about you.` from Artemidorus's warning in Shakespeare's *Julius Caesar*, Act II, Scene III

Do not implement the retired Luke and Hamlet package from repository history.
