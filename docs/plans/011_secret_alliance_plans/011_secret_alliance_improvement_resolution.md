...
- Hidden collapse presents four aftermath choices based on preserved evidence and suspect snapshots: publish the case, seal the files, clear innocent names, or retain one year of counterintelligence methods.
