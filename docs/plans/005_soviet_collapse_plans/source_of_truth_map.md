...
| `subagent_handoffs/2026_06_05_focus_tree_auditor_post_cfr_current_audit_pathline_patch.md` | Latest full post-CFR focus audit baseline: 41 trees, 1698 focuses, 0 duplicate focus IDs, 0 coordinate duplicates, 0 direct focus idea effects, 520 pathline risks, and 1,127 helper-only or nearly helper-only reward findings. | Current focus-risk baseline. It made one bounded CFR coordinate patch. |
