...
| Custom splinter full trees | FTH, AEX, TNC, AAX, BBH, AOX, UDC, SDZ, GAC, DHC, KHC, FEV, SZA, UWD, MRC, IUL, ADX, ARD, NLC | Partial | Most are 47-focus trees, but many are template-like. Several have no direct decision unlocks and too many rewards are generic equipment/building/value packages. |
...
| Ancient restorations | APX, SOG, ANX, ABX | Incomplete for major-tree standard | Each has 16 focuses. They have claims and some decisions/buildings, but not enough depth for identity-driven long-lived countries unless parent explicitly classifies them as compact restorations. |
...
- Ancient restoration trees have only 16 focuses each: `APX_soviet_collapse_ancient_focus_tree`, `SOG_soviet_collapse_ancient_focus_tree`, `ANX_soviet_collapse_ancient_focus_tree`, `ABX_soviet_collapse_ancient_focus_tree`.
...
4. OGB and ancient restorations depth plan. Either expand OGB/APX/SOG/ANX/ABX or explicitly classify them as compact restoration trees with narrower expectations.
