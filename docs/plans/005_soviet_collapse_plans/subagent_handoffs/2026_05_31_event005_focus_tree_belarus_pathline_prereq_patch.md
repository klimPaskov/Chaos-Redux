...
| Ancient restorations should have real depth | APX/SOG/ANX/ABX ancient focus trees | Needs broader work | 16-focus trees have claims and decision hooks, but remain shallow compared with the spec. Broader branch additions should be parent-owned. |
