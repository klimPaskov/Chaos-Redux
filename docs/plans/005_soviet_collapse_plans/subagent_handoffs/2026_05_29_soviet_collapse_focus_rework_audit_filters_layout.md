...
| `AEX_soviet_collapse_focus_tree` | 22 | `AEX_first_guard`, `AEX_stores`, `AEX_rival`, `AEX_doctrine`, `AEX_special_arm`, `AEX_caravan_officer_schools`, `AEX_supply`, `AEX_enemy_front`, `AEX_war_plan`, `AEX_desert_pass_offices`, `AEX_caravan_supply_hubs`, `AEX_well_guard_posts`, `AEX_hidden_road_depots`, `AEX_kyrgyz_raid_watch`, `AEX_central_asian_defense_council`, `AEX_raiding_column_oaths`, `AEX_pack_train_signals`, `AEX_desert_airstrips`, `AEX_radical_turn`, `AEX_hidden_doctrine`, `AEX_extreme_gate`, `AEX_extreme_path` |
...
| `AAX_soviet_collapse_focus_tree` | 20 | `AAX_first_guard`, `AAX_stores`, `AAX_rival`, `AAX_doctrine`, `AAX_special_arm`, `AAX_alash_officer_schools`, `AAX_supply`, `AAX_enemy_front`, `AAX_war_plan`, `AAX_rail_spine_to_south`, `AAX_kyrgyz_pass_guards`, `AAX_depot_cavalry_columns`, `AAX_mobile_airstrips`, `AAX_steppe_supply_hubs`, `AAX_officer_oath_boards`, `AAX_border_minority_patrols`, `AAX_radical_turn`, `AAX_hidden_doctrine`, `AAX_extreme_gate`, `AAX_extreme_path` |
...
| `AOX_soviet_collapse_focus_tree` | 19 | `AOX_first_guard`, `AOX_stores`, `AOX_rival`, `AOX_doctrine`, `AOX_special_arm`, `AOX_enemy_front`, `AOX_war_plan`, `AOX_petrograd_signal_watch`, `AOX_sailor_worker_defense_council`, `AOX_convoy_escort_ledger`, `AOX_fortress_hospital_stations`, `AOX_gulf_battery_posts`, `AOX_naval_infantry_oaths`, `AOX_red_fleet_signal_posts`, `AOX_gulf_mine_watch`, `AOX_coastal_air_patrols`, `AOX_port_guard_schools`, `AOX_every_harbor_a_soviet`, `AOX_endgame` |
...
| `ADX_soviet_collapse_focus_tree` | 24 | `ADX_first_guard`, `ADX_stores`, `ADX_rival`, `ADX_doctrine`, `ADX_special_arm`, `ADX_supply`, `ADX_enemy_front`, `ADX_radical_turn`, `ADX_war_plan`, `ADX_birobidzhan_archive_workshops`, `ADX_amur_relief_posts`, `ADX_amur_field_staff`, `ADX_militia_training_yards`, `ADX_grain_and_relief_escorts`, `ADX_border_crossing_batteries`, `ADX_taiga_watch_posts`, `ADX_winter_road_columns`, `ADX_obluchye_rear_area`, `ADX_hardline_against_border_troops`, `ADX_commune_staff_map`, `ADX_hidden_doctrine`, `ADX_extreme_gate`, `ADX_extreme_path`, `ADX_endgame` |
...
| custom splinters | `FTH`, `AEX`, `TNC`, `AAX`, `BBH`, `AOX`, `UDC`, `SDZ`, `GAC`, `DHC`, `KHC`, `FEV`, `SZA`, `UWD`, `MRC`, `IUL`, `ADX`, `ARD`, `NLC` focus trees | 47 each | Present but structurally templated; needs bespoke dangerous behavior, expansion, decisions, AI, and postwar handling. |
