...
- `common/national_focus/005_soviet_collapse_ancient_restorations.txt:945` - `ANX_canal_recognition_letters`
...
- `common/national_focus/005_soviet_collapse_ancient_restorations.txt:1354` - `ABX_mountain_envoy_guarantees`
  - Problem: same visible envoy reward density pattern as SOG/ANX.
...
- `common/national_focus/005_soviet_collapse_ancient_restorations.txt:29` - `APX_restore_itil_council`
- `common/national_focus/005_soviet_collapse_ancient_restorations.txt:42` - `APX_toll_law_debate`
- `common/national_focus/005_soviet_collapse_ancient_restorations.txt:56` - `APX_ferry_house_registers`
- `common/national_focus/005_soviet_collapse_ancient_restorations.txt:70` - `APX_caspian_road_markets`
- `common/national_focus/005_soviet_collapse_ancient_restorations.txt:84` - `APX_customs_workshop_compact`
- `common/national_focus/005_soviet_collapse_ancient_restorations.txt:98` - `APX_volga_toll_guard`
- `common/national_focus/005_soviet_collapse_ancient_restorations.txt:115` - `APX_guard_the_crossings`
...
- `common/national_focus/005_soviet_collapse_ancient_restorations.txt:845` - `ANX_restore_the_khwarazm_shah_council`
- `common/national_focus/005_soviet_collapse_ancient_restorations.txt:858` - `ANX_canal_law_records`
- `common/national_focus/005_soviet_collapse_ancient_restorations.txt:1254` - `ABX_restore_the_alan_war_council`
- `common/national_focus/005_soviet_collapse_ancient_restorations.txt:1267` - `ABX_tower_law_registers`
...
Additional trees with low direct expansion/decision surface should be reviewed together: `SDZ`, `DHC`, `KHC`, `SZA`, `UWD`, `ADX`, `AOX`, `GAC`, `IUL`.
...
- Moderate/low: Central Asia 4, Moldova 3, ARD 3, internal republic 2, Caucasus 2, AEX 2, TNC 2, AAX 2, ancient restoration trees 2 each
...
2. Give low-link chaos countries visible route-specific aggression: claims, coring, war-goal preparation, assault columns, or conquest decisions. Start with `BBH`, `UDC`, `MRC`, `SDZ`, `DHC`, `KHC`, `SZA`, `UWD`, and `ADX`.
