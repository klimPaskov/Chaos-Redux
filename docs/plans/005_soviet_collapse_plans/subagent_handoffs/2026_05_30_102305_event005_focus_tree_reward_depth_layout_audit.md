...
| Full custom/high-chaos splinters | FTH, AEX, TNC, AAX, BBH, AOX, UDC, SDZ, GAC, DHC, KHC, FEV, SZA, UWD, MRC, IUL, ADX, ARD, NLC, each 47 focuses in `005_soviet_collapse_custom_splinters.txt` | Present but not aggressive enough | These are no longer tiny stubs, but most still use generic identity helpers and flat stockpile/building rewards. Only a subset has focus-level war goals; most need stronger direct aggression, postwar, or decision packages. |
...
| Ancient restorations | APX/SOG/ANX/ABX, 16 focuses each in `005_soviet_collapse_ancient_restorations.txt` | Shallow | Claims and museum/archivist decision tooltips exist, but the trees are still compact restoration stubs, not full ancient-restoration country identities. |
...
2. Full 47-focus custom splinters still need more high-chaos aggression: `FTH_soviet_collapse_focus_tree` at `:4`, `AEX` at `:4346`, `TNC` at `:5472`, `AAX` at `:6606`, `BBH` at `:7722`, `AOX` at `:8923`, `UDC` at `:10164`, `SDZ` at `:11361`, `GAC` at `:12602`, `DHC` at `:13781`, `KHC` at `:14982`, `FEV` at `:16176`, `SZA` at `:17349`, `UWD` at `:18525`, `MRC` at `:19727`, `IUL` at `:20905`, `ADX` at `:22060`, `ARD` at `:23202`, and `NLC` at `:24399`.
...
4. Expand APX/SOG/ANX/ABX ancient restorations beyond 16-focus stubs with real branch families.
