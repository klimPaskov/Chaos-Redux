...
| Full custom splinter high-chaos successors | Full 47-focus trees: `FTH`, `AEX`, `TNC`, `AAX`, `BBH`, `AOX`, `UDC`, `SDZ`, `GAC`, `DHC`, `KHC`, `FEV`, `SZA`, `UWD`, `MRC`, `IUL`, `ADX`, `ARD`, `NLC` | Partial | Most have branches, endpoints, and some aggression hooks. Many still share the same generic helper spine and need distinct OP identity payoffs. |
