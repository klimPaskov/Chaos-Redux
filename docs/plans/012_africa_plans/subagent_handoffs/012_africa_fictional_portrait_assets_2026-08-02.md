...
The v3 manifest now records per-row apparent gender, a fictional personal-name status, and the single absurd visual signature used for review. All six remain male-presenting or explicitly nonhuman male-coded; no female portrait or female character consumer is introduced.
