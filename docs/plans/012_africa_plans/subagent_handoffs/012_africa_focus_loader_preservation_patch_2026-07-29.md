...
- South Africa's exile-patron succession saves the prior host as a chain-local completion source and copies its completed continental focuses into the successor tree.
...
- `common/scripted_effects/012_africa_rsa_effects.txt`
  - `africa_rsa_transfer_host_to_exile_patron`
...
- RSA succession provides `copy_completed_from = event_target:africa_focus_completion_source` before old-host cleanup can invalidate the source.
