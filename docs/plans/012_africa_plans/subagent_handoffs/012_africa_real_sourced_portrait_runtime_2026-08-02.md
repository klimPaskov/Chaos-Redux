...
The Merina DDS remains a valid source-locked asset installation, but it is not a current sovereign-role approval. The male-only runtime trigger holds the female historical role until a separately reviewed male source or accepted successor contract exists. No generated male substitute is inferred from the installed female asset.
