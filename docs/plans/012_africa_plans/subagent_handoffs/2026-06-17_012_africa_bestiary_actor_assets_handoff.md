...
| `GHC` | leader portrait | `$imagegen` | `docs/assets/012_africa/bestiary_actor_assets/source_png/leader_012_africa_ghc_great_herds_compact_source.png` | `docs/assets/012_africa/bestiary_actor_assets/processed_png/leader_012_africa_ghc_great_herds_compact_processed.png` | `gfx/leaders/012_africa/leader_012_africa_ghc_great_herds_compact.dds` | source `1080x1456`; final `156x210` | Institutional nonhuman compact-speaker portrait with migration medallions and corridor markers. |
