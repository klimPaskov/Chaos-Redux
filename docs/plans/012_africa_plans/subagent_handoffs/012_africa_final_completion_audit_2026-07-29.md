...
| Documentation cleanup plan | Accepted. `docs/events/012_africa/overview.md` is the release-candidate source of truth and explicitly rejects a full-completion claim. |
