...
p=Path('docs/plans/3d_model_workflow_plans/adapter_recovery_drafts/fourth_tranche').resolve();sys.path.insert(0,str(p));sys.path.insert(1,str(p.parent));sys.path.insert(2,str(Path('.tools/3d_pipeline/tests').resolve()))
