...
@mcp.tool()
def chaosx_blender_hoi4_repair_explicit_vertex_remap(job_id: str, blend_rel: str, checkpoint_rel: str, expected_source_sha256: str, remap_spec: Dict[str, Any]) -> Dict[str, Any]:
    """Exact source-vertex fan copies/coincident aliases with explicit corner remaps; no inferred weld or weights."""
    return _run(job_id,"repair_explicit_vertex_remap",{"blend_rel":blend_rel,"checkpoint_rel":checkpoint_rel,"expected_source_sha256":expected_source_sha256,"remap_spec":remap_spec})
