...
The labels below match the final English focus titles. Every focus has its own stable `94x86` icon contract. Visual direction follows its lane: survival, government, laboratory economy, conventional security, cloning, robotics, paleogenetics, xenobiology, quantum transit, temporal operations, alien technology, biological warfare, diplomacy, integration, world conquest, or singularity.
...
| 086 | `KRG_arm_the_alien_cohorts` — Arm the Alien Cohorts | 49,12 / D105 | 084 + 085 | ALI weaponization, a valid D’Rhondan contact receipt, and laser production | Reconcile the shared alien-infantry runtime and authorize bounded Alien Laser Weapon production. Every cohort still arrives through the paid landing API. | P decisive target/material surplus; X attrition or shortage |
...
- Project capstones unlock paid production and operations. They never create recurring free formations. Clone Infantry, Autonomous Robots, Paleogenetic Creatures, Xenobiological Assault Organisms, Portal Raiders, and Temporal Guards scale through their actual manpower, equipment, fuel, and production requirements instead of live family caps. Alien Infantry remains landing-only through its exact 2,000-laser reservation, and biological warfare uses the canonical agent and stockpile lifecycle rather than a division cap. The one-time opening conventional package remains clamped to 1–8, while later growth remains paid.
