...
- **Canonical lifecycle:** Event 016 seeds anthrax, plague, tularemia, or smallpox through <code>bio_lifecycle_reset_seed_record</code> and <code>bio_lifecycle_dispatch_seed</code> using <code>constant:bio_lifecycle_agent.{anthrax,plague,tularemia,smallpox}</code>. Weekly deaths flow through <code>bio_lifecycle_register_current_agent_weekly_deaths</code>; attribution condemnation through <code>bio_lifecycle_register_attribution_condemnation</code>. Existing compatibility effects such as <code>apply_anthrax_contamination_scaled</code> are not a second lifecycle.
- **Canonical consequences:** reuse <code>bio_register_state_civilian_deaths</code>, <code>bio_register_condemnation_source</code>, the shared <code>Deaths</code> accumulation, contamination effects, outbreak flags, treatment/quarantine systems, and <code>Condemnation</code>. Zombies remain a separate agent system.
