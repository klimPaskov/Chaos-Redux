...
| `KRG_alien_arms_plan` | Sovereign KRG, completed audit, operational alien-arms weaponization, high-energy deployment, and rocketry or teleportation weaponization | Alien-arms operations cease or `KRG_arm_the_exotic_guard` completes | Safe; high-energy and delivery gates remain. |
