...
- Verified laser-fire, movement, idle, and death audio has provenance, checksums, timing notes, and alien-only consumer bindings; strict selection/acknowledgement/impact/special audio roles remain unresolved.
