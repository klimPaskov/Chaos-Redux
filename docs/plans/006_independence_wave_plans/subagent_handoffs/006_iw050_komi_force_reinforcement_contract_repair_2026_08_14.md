...
A full read-only crosswalk over all 206 rows now matches the accepted force-profile, military-tradition, navy/air inheritance, research-sensitivity, and reinforcement-pathway mappings. The focused row assertions confirm IW-050 `p50` as profile `4`, tradition `55`, mask `647`, inheritance mask `0`, and IW-055 `p55` as profile `4`, tradition `43`, mask `403`, inheritance mask `0`.
