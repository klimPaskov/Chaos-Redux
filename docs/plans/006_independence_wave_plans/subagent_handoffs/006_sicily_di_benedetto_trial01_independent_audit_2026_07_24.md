...
The metadata records processor `the retired portrait-processing utility` version `5.0`, current processor SHA-256 `c6e78c01c025ad57fef8dc25eb79bd216ff9809df27e4c758eb9ec72594a3963`, `source_kind = real`, crop `(0,1,1080,1455)`, and output size `156x210`.
