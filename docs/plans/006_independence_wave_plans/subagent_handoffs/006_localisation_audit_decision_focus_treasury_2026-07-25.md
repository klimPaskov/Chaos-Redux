...
5. Documentation owner: reconcile the ten-entry runtime gate with `docs/events/006_independence_wave/overview.md:13,17,85` and `docs/plans/006_independence_wave_plans/006_independence_wave_resume_packet.md:11,84,153,173`, and remove the duplicate IW-006 admission sentence in the trigger comment.
