...
The registry preserves 149 `can_plan_independence_wave_package_iw_*` gates and the two explicit regional reservation-mutex triggers for states 354 and 441. Each source section is labelled inside the registry so regional ownership and research comments remain traceable.
