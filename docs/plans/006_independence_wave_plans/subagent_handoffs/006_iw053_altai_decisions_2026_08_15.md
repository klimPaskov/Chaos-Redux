...
The final `hoi4.probability_inspect` returned `PROBABILITY_SOURCE_INSPECTED` with `poolComplete = true`, 11 candidates, 16 required inputs, 0 unresolved inspect items, and 0 available candidates in the empty MCP fixture. The final source hash was `a20e6880c29a5c69ec6ca9ff02a92d65b9a29b62751eade47b9a45dea34b60c9`. Artifact: `hoi4-agent://workspace/mod_chaos_redux_ea3b2d67c2c0/artifact/034162c53f73b86d6a3f3e491ce8392e57d55ab6d02fab76d4fb9b33984eef4c/5473b5e8111d3e188f0a87d3d6dca79fe8a8731ffc549be281e6585dea286779/probability-inspect-a20e6880c29a.json`.

Direct `hoi4.probability_evaluate` against named scenario set `E6_IW053_ALT_PACKAGE_EMPTY_FIXTURE_2026_08_15` and scenario `ALT_EMPTY_PACKAGE_FIXTURE` returned `PROBABILITY_ANALYZED_PARTIAL` for all 11 candidates with 146 unresolved or bounded items. The adapter reported all candidates never eligible in the empty state, which is an expected fixture result rather than proof of dead source. JSON artifact: `hoi4-agent://workspace/mod_chaos_redux_ea3b2d67c2c0/artifact/e5fddb75ee058081029904a7886e8c9d6b22d52385aa16a2a665a1247b28bd2d/cbba4f209cbbbd5407d2dcbcd676e4633a8b6c21a0ab86bdacadeb4c96a06802/probability-cb615457cb26f775e100d0b9.json`.
