...
| Current scenario system docs | `docs/systems/event_system/triggerable_scenarios.md` and `docs/events/006_independence_wave/systems/triggerable_scenario.md` | Patched to distinguish six numeric families from eight selectable modes and to retain the existing 32-cell validation target. |
...
- `docs/systems/event_system/triggerable_scenarios.md` and `docs/events/006_independence_wave/systems/triggerable_scenario.md` intentionally overlap. The former is the cross-scenario index, and the latter is the SCN-008 implementation contract. Both were retained and clarified.
