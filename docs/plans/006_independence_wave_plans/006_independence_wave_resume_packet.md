...
- The current portrait authority is the sourced-only workflow in the event-asset
  ...
  `docs/assets/006_independence_wave/portraits_generated_png/` now preserves 42
  larger pre-resize masters and 79 normalized pre-DDS PNGs with byte/hash
  manifests; candidates remain evidence only until independent review.
