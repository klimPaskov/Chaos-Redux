...
| IW-093 DOX | Signature focus/decision/idea/AI/icon tranche implemented; fail-closed | Preserve the exact new X-tag, state-274/Kumasi contract, high-chaos-only disposition, host-survival proof, visible values, route locks, and 57-icon shared package. Do not add runtime/SCN-008 attestation until the leader, flag, politics, starting-force, FORM-24, and final country audits pass. The 2026-07-18 Prempeh II candidate is rejected evidence, not a wireable portrait |
| IW-098 SOK | Signature focus/decision/idea/AI/icon tranche implemented; fail-closed | Preserve the dormant vanilla SOK identity, state-902 contract, automatic-if-not-living rule, Event-012 flags, the 17 June 1938 Hasan-to-Siddiq boundary, visible values, route locks, and 57-icon shared package. Do not replace living SOK history/tree or promote the package until the pre-cutover leader, flag, politics, starting-force, FORM-25, and final country audits pass |
