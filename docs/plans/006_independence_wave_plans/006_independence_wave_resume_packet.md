...
| IW-009 BAY | Gameplay retained; portrait ownership blocked | Preserve protected Rupprecht, sourced Heinrich Held, the Level 2 lane, incidents, and South German settlement. Epp is rejected because vanilla recruits `GER_franz_ritter_von_epp`; replace him with a different sourced real male Bavarian military leader, then re-audit before any admission |
