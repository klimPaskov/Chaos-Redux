...
| IW-093 DOX | Signature focus/decision/idea/AI/icon tranche, Prempeh II leadership, and opening politics implemented; fail-closed | Preserve the exact new X-tag, state-274/Kumasi contract, high-chaos-only disposition, host-survival proof, visible values, route locks, and 57-icon shared package. `e0e85c832` supplies the approved male HOI4-style Prempeh II runtime portrait; the package now recruits him only for the exact origin and initializes centralized institutional politics after setup admission. Do not add runtime/SCN-008 attestation until the exact flag, route politics, starting force, diplomacy, FORM-24 contract, and final country audits pass |
| IW-098 SOK | Signature focus/decision/idea/AI/icon tranche and post-cutover leadership/politics implemented; fail-closed | Preserve the dormant vanilla SOK identity, state-902 contract, automatic-if-not-living rule, Event-012 flags, the 17 June 1938 Hasan-to-Siddiq boundary, visible values, route locks, and 57-icon shared package. On/after the cutover Event 006 reuses vanilla Siddiq only for the exact origin; earlier dates remain fail-closed. Do not promote until the pre-cutover leader, exact flag, route politics, starting force, diplomacy, FORM-25, and final country audits pass |
