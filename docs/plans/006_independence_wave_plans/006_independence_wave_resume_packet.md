...
The current durable pre-DDS portrait shelf records 78 original-size PNG
source-derived masters directly in one flat directory after the CHU Bolgar v90
v1/v2/v3, ASY Haydo, and ASY Barsoum original-size repaint copies. The current
authority declares 73 indexed rows, with five older physical PNGs outside that
index (four ARX masters and the CHU Mirsaid master).
