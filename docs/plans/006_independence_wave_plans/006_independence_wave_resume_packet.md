...
The current durable pre-DDS portrait shelf records 77 original-size
source-derived masters directly in one flat directory after the CHU Bolgar v90
original-size repaint copy, with no nested folders, no normalized 156x210 PNGs,
...
- The current portrait authority is the sourced-only workflow in the event-asset
  ...
  `docs/assets/006_independence_wave/portraits_generated_png/` now records 77
  original-size pre-resize masters directly in one directory after the CHU Bolgar
  v90 copy, with no nested folders, normalized 156x210 PNGs, or
