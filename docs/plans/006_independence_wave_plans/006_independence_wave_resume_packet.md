...
The v47 focus audit closes a shared-tree import gap without changing route semantics: the IW-093 Asante and IW-098 Sokoto terminal and sibling focuses are now explicit root imports, so prerequisite traversal reaches all 111 shared focuses and all 184 direct focuses. The fresh 2026-08-03 focus receipt renders the current one-tree source and reports 184 regular nodes, 223 prerequisite connectors, 43 crossings, 7 node intersections, 28 long connectors, and 5 close same-row pairs. Geometry and probability follow-up remain separate parent-owned work rather than a package-admission shortcut. Evidence is `subagent_handoffs/006_event6_focus_render_current_2026_08_03.md` together with the dated v47/v70/v97 handoffs.
...
8. Preserve the current v97 focus-ownership audit, v66 COR, v70 historical focus
   ...
   evidence. Record the fresh 2026-08-03 focus receipt and v111 geometry audit: 184 regular nodes, 223 prerequisite connectors, and 14 blocking diagnostics consisting of 43 crossings, 7 node intersections, 28 long connectors, and 5 close same-row pairs. Retain the v82 static after-state and v70 baseline as dated traceability. Do not rerun the earlier byte-limited focus inspection merely to repeat a completed source scan; re-audit only after the owning source changes, and
