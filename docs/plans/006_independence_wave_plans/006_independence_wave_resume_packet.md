...
| SCN-008 | Keep Universal Former Hosts distinct-target reservation enabled only for that rule. Keep Wars of Separation one viable host war per release. The 32 mode/intensity cells still need source/MCP evidence. |
...
| Decisions and localisation | Preserve v71's no-defect source result and v72's static localisation/catalog PASS, but keep their scenario, package, runtime, GUI/event-log, and catalog/source evidence gaps visible. |
...
8. Preserve the current v97 focus-ownership audit, v66 COR, v70 historical focus
   ...
   catalog/source, and 32-cell scenario gaps in the whole-event report.
