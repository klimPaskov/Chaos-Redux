...
Current routing authority is `subagent_handoffs/006_event_completion_audit_v32_2026_07_29.md`; older v31/v30 references below are retained only as dated traceability. The current shelf is 56 original-size masters in one flat directory.
...
Any remaining v23/v28/v30/v31, 49/50/51/54-master, or pre-repair wording later in this packet is
historical traceability rather than current authority. Use the v32 completion
...
- RHI and BAY Level 2 lanes, incidents, FORM-04 delegation, and the South German
  settlement remain implemented. Protected Matthes and Rupprecht, Josef Harpe,
  and Heinrich Held remain valid. Adenauer and Epp are sourced but rejected
  because vanilla already owns them as active GER characters, so both packages
  require different sourced replacements.
- SCO/WLS congress preparation repair remains implemented. Scotland keeps sourced
  Cunninghame Graham but requires a different sourced commander because vanilla
  owns Ironside as an active ENG character; Wales remains source-blocked. Their
...
- The current v31 completion authority and bounded post-v31 handoffs retain
