...
The current durable pre-DDS portrait shelf records 75 original-size PNG
source-derived masters directly in one flat directory after the CHU Bolgar v90
v1/v2 original-size repaint copies; the folder contains 77 files including its
README and manifest. There are no nested folders, no normalized 156x210 PNGs,
and no advisor or small/dossier derivatives authorized. The v90 Karim Tinchurin
source/repaint evidence remains `needs_user_review` with no DDS, `.gfx`,
character, or content-attestation promotion; see
...
handoff, the 63-master flat-shelf manifests, and the bounded 2026-07-28/29 handoffs
...
- The current portrait authority is the sourced-only workflow in the event-asset
  ...
  `docs/assets/006_independence_wave/portraits_generated_png/` now records 75
  original-size pre-resize PNG masters directly in one directory after the CHU
  Bolgar v90 v1/v2 copies; the folder contains 77 files including its README and
  manifest. There are no nested folders, normalized 156x210 PNGs, or
  advisor/small/dossier derivatives; `PRE_RESIZE_MANIFEST.md` records the
  byte/hash inventory. The v90 Karim Tinchurin source/repaint package is
  ...
  promotion. The source/repaint handoff is
  `subagent_handoffs/006_iw043_chu_bolgar_civic_portrait_source_v90_2026_08_01.md`.
