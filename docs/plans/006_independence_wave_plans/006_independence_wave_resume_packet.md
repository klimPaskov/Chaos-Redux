...
The durable pre-DDS portrait shelf now contains exactly 54 original-size
...
handoff, the 54-file flat-shelf manifests, and the bounded 2026-07-28 handoffs
...
- The current portrait authority is the sourced-only workflow in the event-asset
  ...
  54 original-size pre-resize masters directly in one directory, with no nested
