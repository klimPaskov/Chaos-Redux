...
The durable pre-DDS portrait shelf now contains exactly 51 original-size
...
Any remaining v23/v28, 49/50-master, or pre-repair wording later in this packet is
historical traceability rather than current authority. Use the v30 completion
handoff, the 51-file flat-shelf manifests, and the bounded 2026-07-28 handoffs
...
- The current portrait authority is the sourced-only workflow in the event-asset
  ...
  51 original-size pre-resize masters directly in one directory, with no nested
