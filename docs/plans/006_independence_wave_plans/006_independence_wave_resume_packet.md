...
| IW-093 DOX | Foundational adapter implemented; fail-closed | Preserve the exact new X-tag, state-274/Kumasi contract, high-chaos-only disposition, host-survival proof, and Event-012 origin separation. Do not add runtime/SCN-008 attestation until the complete Asante gameplay and visual package passes audit. The 2026-07-18 Prempeh II candidate is rejected evidence, not a wireable portrait |
| IW-098 SOK | Foundational additive adapter implemented; fail-closed | Preserve the dormant vanilla SOK identity, state-902 contract, automatic-if-not-living rule, Event-012 flags, and the 17 June 1938 Hasan-to-Siddiq boundary. Do not replace living SOK history/tree or promote the package until the pre-cutover leader, gameplay, and visual package passes audit |
