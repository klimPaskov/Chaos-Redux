...
- Event 006 formable/cosmetic identity tags scanned: **7**.
- Unique Event 006-owned identifiers checked together: **109**.
- All-length Event 006 custom cosmetic identifiers checked separately: **17**.
...
- Engine-, offline-wiki-, or OS-reserved three-character namespaces excluded: **AND, CON, GFX, LOG, NOT, NUL, NUM, OOB, PRN, RED, TAG**.
...
- Sibling local mod directories scanned: **5** (3d_pipeline, agentic_hoi4_modding, chaos_redux_music, ireland_total_overhaul, slop_redux).
...
- Other Chaos Redux country-tag definitions parsed: **51**.
- Other Chaos Redux alias/cosmetic/history/localisation/flag tag uses parsed: **1018**.
- Reserved-tag collisions: **17**.
...
- Collision-free unused `??X` replacement candidates: **440**.

## Reserved-tag collisions

| Event 006 | Identity | Conflicting registry | Definition |
| --- | --- | --- | --- |
| `DJX` / IW-088 | requires a named Tuareg confederation or regional Kel package | chaos_redux_non_event6 `chaos_redux` / country_history_filename | `C:\Users\klimp\OneDrive\Documents\Paradox Interactive\Hearts of Iron IV\mod\chaos_redux\history\countries\DJX - Unresearched Reservation.txt` |
| `DMX` / IW-091 | requires a named Toubou or Teda-Daza regional package | chaos_redux_non_event6 `chaos_redux` / country_history_filename | `C:\Users\klimp\OneDrive\Documents\Paradox Interactive\Hearts of Iron IV\mod\chaos_redux\history\countries\DMX - Unresearched Reservation.txt` |
| `DNX` / IW-092 | requires a named Atlas or Kabyle-adjacent regional package | chaos_redux_non_event6 `chaos_redux` / country_history_filename | `C:\Users\klimp\OneDrive\Documents\Paradox Interactive\Hearts of Iron IV\mod\chaos_redux\history\countries\DNX - Unresearched Reservation.txt` |
| `ENX` / IW-118 | requires a named local Maasai territorial section and concrete district | chaos_redux_non_event6 `chaos_redux` / country_history_filename | `C:\Users\klimp\OneDrive\Documents\Paradox Interactive\Hearts of Iron IV\mod\chaos_redux\history\countries\ENX - Unresearched Reservation.txt` |
| `EXX` / IW-128 | requires a named Nama community package | chaos_redux_non_event6 `chaos_redux` / country_history_filename | `C:\Users\klimp\OneDrive\Documents\Paradox Interactive\Hearts of Iron IV\mod\chaos_redux\history\countries\EXX - Unresearched Reservation.txt` |
| `EYX` / IW-129 | requires one named Ovambo kingdom or district package | chaos_redux_non_event6 `chaos_redux` / country_history_filename | `C:\Users\klimp\OneDrive\Documents\Paradox Interactive\Hearts of Iron IV\mod\chaos_redux\history\countries\EYX - Unresearched Reservation.txt` |
| `FPX` / IW-146 | requires a named Naga political package | chaos_redux_non_event6 `chaos_redux` / country_history_filename | `C:\Users\klimp\OneDrive\Documents\Paradox Interactive\Hearts of Iron IV\mod\chaos_redux\history\countries\FPX - Unresearched Reservation.txt` |
| `GDX` / IW-160 | requires a named Karen political and territorial package | chaos_redux_non_event6 `chaos_redux` / country_history_filename | `C:\Users\klimp\OneDrive\Documents\Paradox Interactive\Hearts of Iron IV\mod\chaos_redux\history\countries\GDX - Unresearched Reservation.txt` |
| `GGX` / IW-163 | requires a named Chin or Zo district and a self-chosen public name | chaos_redux_non_event6 `chaos_redux` / country_history_filename | `C:\Users\klimp\OneDrive\Documents\Paradox Interactive\Hearts of Iron IV\mod\chaos_redux\history\countries\GGX - Unresearched Reservation.txt` |
| `GHX` / IW-164 | requires route and community settlement to choose Arakan or Rakhine | chaos_redux_non_event6 `chaos_redux` / country_history_filename | `C:\Users\klimp\OneDrive\Documents\Paradox Interactive\Hearts of Iron IV\mod\chaos_redux\history\countries\GHX - Unresearched Reservation.txt` |
| `GLX` / IW-168 | requires a named Hmong regional package | chaos_redux_non_event6 `chaos_redux` / country_history_filename | `C:\Users\klimp\OneDrive\Documents\Paradox Interactive\Hearts of Iron IV\mod\chaos_redux\history\countries\GLX - Unresearched Reservation.txt` |
| `HHX` / IW-190 | requires named Pueblo members and explicit consent | chaos_redux_non_event6 `chaos_redux` / country_history_filename | `C:\Users\klimp\OneDrive\Documents\Paradox Interactive\Hearts of Iron IV\mod\chaos_redux\history\countries\HHX - Unresearched Reservation.txt` |
| `HMX` / IW-195 | requires one named Garifuna community and coast | chaos_redux_non_event6 `chaos_redux` / country_history_filename | `C:\Users\klimp\OneDrive\Documents\Paradox Interactive\Hearts of Iron IV\mod\chaos_redux\history\countries\HMX - Unresearched Reservation.txt` |
| `HQX` / IW-199 | requires named regional Quechua members | chaos_redux_non_event6 `chaos_redux` / country_history_filename | `C:\Users\klimp\OneDrive\Documents\Paradox Interactive\Hearts of Iron IV\mod\chaos_redux\history\countries\HQX - Unresearched Reservation.txt` |
| `HTX` / IW-202 | requires named Gran Chaco member peoples | chaos_redux_non_event6 `chaos_redux` / country_history_filename | `C:\Users\klimp\OneDrive\Documents\Paradox Interactive\Hearts of Iron IV\mod\chaos_redux\history\countries\HTX - Unresearched Reservation.txt` |
| `HWX` / IW-205 | requires named Amazonian river peoples and one anchor | chaos_redux_non_event6 `chaos_redux` / country_history_filename | `C:\Users\klimp\OneDrive\Documents\Paradox Interactive\Hearts of Iron IV\mod\chaos_redux\history\countries\HWX - Unresearched Reservation.txt` |
| `HXX` / IW-206 | requires a named historical maroon community | chaos_redux_non_event6 `chaos_redux` / country_history_filename | `C:\Users\klimp\OneDrive\Documents\Paradox Interactive\Hearts of Iron IV\mod\chaos_redux\history\countries\HXX - Unresearched Reservation.txt` |
...
| FORM-48 | Pacific Regional Federation | `PFX` |
| FORM-39 | Melanesian Federation | `MFX` |

All 7 tags are X-ending, unique against the 102 country reservations, present in the reviewed cosmetic registry, and used by an exact Event 006 `set_cosmetic_tag` adapter.

## All-length custom cosmetic coverage

Event 006 defines 17 custom cosmetic identifiers, including the six three-character family colors and route identifiers longer than three characters.

`KCX NUX LCX RLX MIX PFX MFX CHU_independence_wave_middle_volga_congressX CHU_independence_wave_volga_bulgariaX CHU_independence_wave_volga_federationX VOLGA_URAL_FEDERATIONX IDEL_URAL_COMPACTX ASY_independence_wave_national_councilX ASY_independence_wave_church_compactX ASY_independence_wave_civic_federationX ASY_independence_wave_security_guardianshipX MESOPOTAMIAN_FEDERATIONX`

Exact custom cosmetic surfaces parsed from vanilla, Workshop, archives, sibling mods, and non-Event 006 Chaos Redux: **0**.

Custom cosmetic identifier collisions

No Event 006 custom cosmetic identifier collides with the scanned installed registries.
...
| `CHU` | IW-043 Volga Bulgaria | `RG-MIDDLE-VOLGA-KAZAN` | True | False | False | `fail_closed` |
| `CHU` | IW-046 Chuvashia | `RG-MIDDLE-VOLGA-KAZAN` | True | False | False | `fail_closed` |

Both shared-tag pairs use one reservation group per tag, so the frozen planner cannot select both identities together. No shared-tag row is admitted. Fail-closed rows: IW-096, IW-107, IW-043, IW-046. The legacy generic content-ready flag has zero grants.
...
`AUX IDX IEX IFX IGX IHX IIX IOX IPX IQX IRX ISX ITX IUX IVX IWX IXX IYX IZX JAX JBX JCX JDX JEX JFX JHX JIX JJX JKX JLX JMX JNX JOX JPX JQX JRX JSX JTX JUX JVX JWX JXX JYX JZX KAX KBX KDX KEX KFX KGX KHX KIX KJX KKX KLX KMX KNX KOX KPX KQX KRX KSX KUX KVX KWX KXX KYX KZX LAX LBX LDX LEX LFX LGX LHX LIX LJX LKX LLX LMX LNX LOX LPX LQX LRX LSX LTX LVX LWX LXX LYX LZX MBX MCX MDX MGX MHX MJX MKX MLX MMX MNX MOX MPX MQX MRX MSX MTX MUX MVX MWX MXX MYX MZX NBX NCX NDX NEX NFX NGX NHX NIX NJX NKX NLX NMX NNX NOX NPX NQX NRX NSX NTX NVX NWX NXX NYX NZX OAX OBX OCX ODX OEX OFX OGX OHX OIX OJX OKX OLX OMX ONX OOX OPX OQX ORX OSX OTX OUX OVX OWX OXX OYX OZX PAX PBX PCX PDX PEX PGX PIX PJX PKX PLX PMX PNX POX PPX PQX PRX PSX PTX PUX PVX PWX PXX PYX PZX QAX QBX QCX QDX QEX QFX QGX QHX QIX QJX QKX QLX QMX QNX QOX QPX QQX QRX QSX QTX QUX QVX QWX QXX QYX QZX RAX RBX RCX RDX REX RFX RGX RHX RIX RJX RKX RMX RNX ROX RPX RQX RRX RSX RUX RVX RWX RXX RYX RZX SBX SCX SDX SFX SGX SIX SJX SKX SLX SMX SNX SOX SPX SQX SRX SSX STX SUX SVX SWX SXX SYX SZX TAX TBX TCX TDX TFX TGX THX TIX TJX TKX TLX TNX TOX TPX TQX TRX TSX TTX TUX TVX TWX TXX TYX TZX UAX UBX UCX UDX UEX UFX UGX UHX UIX UJX UKX ULX UMX UNX UOX UPX UQX URX USX UTX UUX UVX UWX UXX UYX UZX VAX VBX VCX VDX VEX VFX VGX VHX VJX VKX VLX VMX VNX VOX VPX VQX VRX VSX VTX VUX VVX VWX VXX VYX VZX WAX WBX WCX WDX WEX WFX WGX WHX WIX WJX WKX WLX WMX WNX WOX WPX WQX WRX WSX WTX WUX WVX WWX WXX WYX WZX XAX XBX XCX XDX XEX XFX XGX XHX XIX XJX XKX XLX XMX XNX XOX XPX XQX XRX XSX XTX XUX XVX XWX XXX XYX XZX YAX YBX YCX YDX YEX YFX YGX YHX YIX YJX YKX YLX YMX YNX YOX YPX YQX YRX YSX YTX YUX YVX YWX YXX YYX YZX ZAX ZBX ZCX ZDX ZEX ZFX ZGX ZHX ZIX ZJX ZKX ZLX ZMX ZNX ZOX ZPX ZQX ZRX ZSX ZTX ZUX ZVX ZWX ZXX ZYX ZZX`
...
- Audit script SHA-256: `70005faad0705dc6320a614ec1aef39b1a34d4e5fedebc719beab124e8083908`
...
- Candidate matrix SHA-256: `2e814225999b83ec5a2aebf2aa0925151e459fa0bbcdf6c19288d16b6d4799d1`
- Formable-family matrix SHA-256: `816162e3ffd6ce702bfcab591fc85bc49c875343a6d857fa80475e6c2af23169`
- Formable base-localisation inventory SHA-256: `259cb096750f51674bc6bb69dc63e4ebfaa56386e35079bd0e98ec5b88362b16`
...
- Parsed sibling-mod tag-surface inventory SHA-256: `2393422a0e744c73ad03ec6385afaecaa0b1373ad44c5a7f12b3d9821e0cfdeb`
- Parsed non-Event 006 Chaos Redux tag-surface inventory SHA-256: `004e62d28c4ad404e524e817a8016e234b4b84dc7affa099748c2837cd915f80`
- ZIP archive content inventory SHA-256: `c190bac538705eeb79d7dd04e5f87c0fd59c7c7688856f30c419450d8029305c`
- Runtime attestation source SHA-256: `b88374050525a7679eb91076b853839fc755bf57114c2b10efd9e05c3e757329`
- Package-origin wrapper source inventory SHA-256: `029362e14f50320959b14f4f849ef2ff7d2106262b391b9271c04d43ca9864e4`
- Scenario block source SHA-256: `89869ec462fe3554d1e16b7ef43094e0ab3057bf96c4f8fcfca330697fc94518`
