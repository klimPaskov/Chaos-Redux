...
| IW-093 DOX and IW-098 SOK | Foundational scripted adapters implemented; both remain fail-closed | Exact dormant-tag/origin/anchor predicates, setup/final-validation/cleanup dispatch, host-capital survival proofs, Kumasi/Sokoto capital hooks, date-aware Sokoto succession hooks, and Event-012-preserving cleanup exist. Runtime content attestation and SCN-008 admission remain absent. The Prempeh II deterministic candidate is rejected/unwired because it failed the painted-colour HOI4 visual standard; Hasan and exact period flag identities remain blocked. No advisor assets belong to either package |
...
| Static visual package | Materially produced | Static icon families, report scenes, country flags, FORM-01 through FORM-05 flag packages, the audited HBX/PFX Pacific flag package, the final IW-043/IW-058 package assets, and two Event 006 super-event images exist. The bounded package contains 27 final static icons (including the three-state Assyria achievement triplet), eight all-male institutional portraits, ten flat flags, and two report images. HAW/FSM use vanilla flags; HBX uses the researched flat 1911 Bear Flag; PFX uses the audited flat ImageGen flag. Exactly zero custom Event 006 advisor icons/assets/sprites/portrait blocks are present; protected BAY/RHI hashes remain unchanged. Gameplay advisor offices are asset-neutral |
...
| `006_iw093_iw098_signature_packages_improvement_addendum_2026_07_18.md` | Accepted next-tranche design; implementation partial | Defines the Asante and Sokoto value systems, concrete transaction costs, route locks, AI, host relations, FORM-24/25 disposition, origin separation, and zero-advisor-asset boundary. Foundational scripted adapters exist, but complete gameplay and admission remain queued |
| `006_iw093_iw098_country_package_readiness_audit_2026_07_18.md` and scripted architecture handoff | Current fail-closed evidence | Exact DOX/SOK identity and map bindings pass; the foundational package triggers/effects/dispatch are implemented without granting runtime content attestation. FORM-24/25, country content, SCN-008 admission, and final assets remain blocked |
| `006_iw093_iw098_asset_source_research_2026_07_18.md` and `iw093_asante_prempeh_ii_2026_07_18/` | Current research and rejection evidence | Prempeh II source/provenance is valid, but the deterministic portrait candidate failed the painted-colour HOI4 visual standard and is unwired. Hasan/Siddiq and exact period flag blockers remain explicit; no advisor assets were produced |
