...
| Static visual package | Non-portrait assets materially produced; grounded portrait replacement active | Static icons, report scenes, researched/generated flat flags, formable flags, super-event images, and the Statehood Ledger status-panel/animation package remain. The reference shelf preserves 44 pre-resize and 81 normalized source-derived portrait PNGs, including the unapproved IW-093 and IW-018 Vernè/Pinna candidates and their provenance boundaries. Scotland, Brittany, Frisia, Rhineland, Corsica, Sicily, and California have independently approved and wired sourced real-male, identity-preserving HOI4 repaints and complete package audits; protected Rupprecht and Matthes remain unchanged. Every other grounded generated, generic, or photographic runtime portrait remains rejected as readiness evidence until a complete sourced roster passes independent review. Adenauer, Epp, and Ironside remain rejected because vanilla actively owns them. Exactly zero custom Event 006 advisor icons or advisor portrait/sprite blocks are present |
...
| Documentation and workbook alignment | Pacific and bounded IW-043/IW-058 tranches reconciled; overall completion audit pending | The shared Event Details, all five evolution mirrors, Liberations cluster text, and SCN-008 workbook fields exactly match their in-game localisation. The 2026-07-26 catalog audit `006_catalog_alignment_v12_2026_07_26.md` records 25/25 exact field passes with no workbook or CSV changes. Package IDs remain deliberately absent from the generic Event Details under the accepted catalog direction. Parent-wide package and completion work remains outstanding |
