...
| IW-002/006/009/010 | Gameplay retained; runtime admission closed | Ironside and Epp remain rejected because vanilla recruits them as active ENG/GER characters. IW-002 Saunders Lewis trials 01 and 02 and Lewis Pugh Evans trial 01 passed broad style/framing gates but failed the separate likeness gate and remain unwired; Evans trial 02 is a source-only retry pending correct commander-family processing and audit. IW-006 has the independently approved and wired Jules Destrée civic portrait but still lacks a sourced commander. IW-009's protected Rupprecht remains approved, while the Dollmann and Lossow source attempts are safety-blocked with no generated output. IW-010 retains two unresolved grounded roles |
