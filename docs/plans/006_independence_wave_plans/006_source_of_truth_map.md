...
| IW-018 ARX and IW-019 ASX | Gameplay retained; runtime admission closed | ASX passes a bounded static gameplay audit and all three current subjects pass ownership review; Luigi Rizzo has no vanilla character or portrait owner. Its installed treatments still fail the painted-style gate. ARX retains sourced Emilio Lussu but its crown-route and command roles remain unresolved, and Lussu also needs a compliant refinish. FORM-05 gameplay remains implemented, while both IDs stay outside runtime attestation |
