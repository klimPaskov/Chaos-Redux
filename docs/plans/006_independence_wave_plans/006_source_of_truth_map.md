...
| IW-007 AGX | Admitted after current package and portrait audits | The complete Frisia package passes the bounded identity, state-36/RG-36, HOL-survival, Event-5 collision, setup, p7 force, focus, decision, AI, cleanup, localisation, researched flag, and portrait audits. Douwe Kalma and Pieter Reenalda candidate 02 are sourced real male figures with independently approved source-preserving HOI4 repaints; Reenalda candidate 01 remains rejected. IW-007 is exact compile-time attested; every live allocation proof remains mandatory |
...
| IW-002/006/009/010 | Gameplay retained; runtime admission closed | Ironside and Epp remain rejected because vanilla recruits them as active ENG/GER characters. IW-002 Saunders Lewis trials 01 and 02 and Lewis Pugh Evans trials 01 and 02 passed broad provenance/style/framing gates but failed the separate likeness gate and remain unwired. The rights-clear 1973 Saunders source is comparison evidence only: preserving it would retain the wrong 1936 age, while reconstructing a younger face would violate the source-locked identity gate. IW-006 has the independently approved and wired Jules Destrée civic portrait, but Herman Baltia trial 01 failed likeness and stable-consumer transfer and remains unwired. Jules-Joseph Pire is also disallowed because vanilla defines and recruits `BEL_jules_pire`; a different sourced Walloon commander is required. IW-009's protected Rupprecht remains approved, while the Dollmann and Lossow source attempts are safety-blocked with no generated output. IW-010 retains two unresolved grounded roles |
...
| --- | --- | --- | --- |
The exact compile-time set contains IW-001 Scotland, IW-004 Brittany, IW-007 Frisia, IW-008 Rhineland, IW-017 Corsica, and IW-019 Sicily.
IW-002, IW-006, IW-009, IW-010, IW-018, IW-043,
...
| RHI/BAY Level 2 implementation and final admission audits | IW-008 admitted; IW-009 gameplay retained but visually closed | `006_iw008_rhineland_country_package_reaudit_2026_07_24.md`, the Wilhelm Marx audit, the von Zangen audit and transfer re-audit, and the reconciled portrait packages are the current admission authority for RHI. BAY retains its complete gameplay, protected Rupprecht, and approved Heinrich Held portrait. The rights-clear Dollmann source trial was blocked by ImageGen safety before generation because the archival identity crop contains prohibited source-visible insignia; it produced no candidate or runtime asset. BAY still requires a different approved source-locked commander repaint, runtime wiring, and a fresh package audit |
