...
| Static visual package | Non-portrait assets materially produced; portrait replacement active | Static icons, report scenes, researched/generated flat flags, formable flags, and super-event images remain. All 24 current sourced treatments fail the final painted-style gate; 21 subjects remain source/ownership-valid for refinish, while Adenauer, Epp, and Ironside also fail ownership. Generated portrait files for grounded polities remain runtime artifacts awaiting sourced replacement and are not visual-readiness evidence. Exactly zero custom Event 006 advisor icons/assets/sprites/portrait blocks are present; protected BAY/RHI hashes remain unchanged |
