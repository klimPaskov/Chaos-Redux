...
| RHI/BAY Level 2 implementation and final admission audits | IW-008 admitted; IW-009 gameplay retained but visually closed | `006_iw008_rhineland_country_package_reaudit_2026_07_24.md`, the Wilhelm Marx audit, the von Zangen audit and transfer re-audit, and the reconciled portrait packages are the current admission authority for RHI. BAY retains its complete gameplay, protected Rupprecht, and Heinrich Held's independently approved source-locked HOI4 repaint. Held's exact-pixel crop record is current and the approved evidence DDS is byte-identical to the stable runtime civic-leader DDS. Dollmann trial 02 proved an exact archival crop but ImageGen remained safety-blocked. Lossow trial 02 then completed exact-crop ImageGen and deterministic commander processing and passed independent likeness/style review, but failed the separate provenance gate because the Commons/Bain source establishes only `PD-US` and no exact object-level archive identity. Dollmann and Lossow were not converted or wired. BAY still requires a fully cleared source-locked commander repaint and a fresh package audit |
