...
| IW-001/002/006/008/009/010 | Gameplay retained; runtime admission closed | The stable Event 6 tokens identify Victor Morven Fortune for SCO, Karl Jarres for RHI, and Eugen Ritter von Schobert for BAY; their source-ready masters have no vanilla/current ownership hits. Ironside, Adenauer, and Epp remain rejected historical evidence because vanilla recruits them as active ENG/GER characters. WLS, AFX, and AJX retain rights- or source-review gaps. The deterministic Solinas/Harpe finish trial preserved identity but remained visibly photographic and is rejected. These six IDs remain outside runtime content attestation pending complete sourced rosters, compliant HOI4-painted results, and package re-audits |
...
| IW-018 ARX and IW-019 ASX | Gameplay retained; runtime admission closed | ASX passes a bounded static gameplay audit. The Sturzo, Lanza di Scalea, and Rizzo trial refinishes independently pass source, identity, male-only, head-and-shoulders, and HOI4-painted-style review, but they are not yet runtime admission evidence. Rizzo is correctly depicted as a naval admiral and may remain the straits-security route leader; the current character file also misuses him as an army corps commander. ASX stays closed until that army slot is assigned to a sourced real Sicilian army officer, the approved portraits are wired to role-correct consumers, and a fresh package audit passes. ARX retains sourced Emilio Lussu but its crown-route and command roles remain unresolved, and Lussu also needs a compliant refinish. FORM-05 gameplay remains implemented, while both IDs stay outside runtime attestation |
...
| Static visual package | Non-portrait assets materially produced; grounded portrait replacement active | Static icons, report scenes, researched/generated flat flags, formable flags, and super-event images remain. Brittany, Frisia, and Corsica each have an independently approved and wired pair of sourced real-male, identity-preserving HOI4 repaints; protected Rupprecht and Matthes remain unchanged. Every other grounded generated, generic, or photographic runtime portrait remains rejected as readiness evidence until a complete sourced roster passes independent review. Adenauer, Epp, and Ironside remain rejected because vanilla actively owns them; Jarres, Schobert, and Fortune are the source-ready replacement identities but still lack approved finishes. Sicily's Sturzo, Lanza di Scalea, and Rizzo trial refinishes pass independent visual/provenance review but remain unwired pending role-correct separation of Rizzo from the army command slot. Exactly zero custom Event 006 advisor icons/assets/sprites/portrait blocks are present |
...
| --- | --- | --- | --- |
The exact compile-time set contains IW-004 Brittany, IW-007 Frisia, and IW-017
Corsica. IW-001, IW-002, IW-006, IW-008, IW-009, IW-010, IW-018, IW-019, IW-043,
...
Three attested IDs can supply the minimum three-country automatic wave only
when all three independently pass their live host, anchor, reservation,
...
| Mediterranean IW-017/IW-018/IW-019 and FORM-05 audit chain | IW-017 admitted; IW-018/IW-019 gameplay retained but visually closed | `006_iw017_postwire_country_package_audit_2026_07_22.md` is the current admission authority for COR after the independent portrait audits. `006_iw017_iw019_country_package_audit_2026_07_22.md` remains current for ASX static gameplay and source-ownership coverage, while `006_sicily_trial01_portrait_visual_provenance_audit_2026_07_22.md` approves the three trial refinishes as images only. ASX still requires a sourced army commander separate from naval route leader Luigi Rizzo, role-correct wiring, and a fresh package audit. ARX still requires sourced crown-route and command roles. FORM-05 charter and congress gameplay remains implemented |
