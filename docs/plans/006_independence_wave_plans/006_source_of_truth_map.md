...
| IW-093 DOX and IW-098 SOK | Signature focus/decision/idea/AI/icon, leadership/opening-politics, command, and one-time starting-force tranches implemented; both remain fail-closed | Exact dormant-tag/origin/anchor predicates, setup/final-validation/cleanup dispatch, host-capital survival proofs, visible values, 43 focuses, 16 paid decisions, four staged ideas, ten AI profiles, and 57 registered static icons exist. Prempeh II has an approved male HOI4-style portrait and two Event 006 leader roles; post-cutover SOK reuses vanilla Siddiq without duplication. Four distinct male fictional commanders have full and 65x67 HOI4 portraits. Actual corps roles gate canonical force rows 93/98, and current-generation receipts prevent repeat force creation. Runtime content attestation and SCN-008 admission remain absent. Pre-cutover Hasan, exact period flags, route politics, diplomacy, and FORM-24/25 readiness remain blocked. No advisor assets belong to either package |
