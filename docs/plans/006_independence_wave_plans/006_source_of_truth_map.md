...
| IW-173 HAW | Gameplay retained; visual admission withdrawn | Vanilla defines the real David Kalakaua Kawananakoa but maps his sprite to generic `Portrait_Asia_Generic_land_5.dds`. Trial 01 used the correct attributed 1925 archival male photograph, an explicit crop, source-locked ImageGen repaint, and deterministic 156×210 processing. Independent review passed provenance, HOI4 style, framing, male-only, and consumer-boundary gates but failed exact likeness because clipped source highlights forced reconstruction of identity-bearing facial geometry. No DDS was created or wired; a stronger archival source of the actual man is required before re-admission |
| IW-179 FSM | Gameplay retained; visual admission withdrawn | FORM-48 country and formable surfaces remain implemented, but the generated congress chair is not valid for grounded Micronesia. IW-179 remains outside runtime content attestation until a sourced real-male replacement passes review |
...
| Static visual package | Non-portrait assets materially produced; grounded portrait replacement active | Static icons, report scenes, researched/generated flat flags, formable flags, and super-event images remain. Scotland, Brittany, Frisia, Rhineland, Corsica, Sicily, and California have independently approved and wired sourced real-male, identity-preserving HOI4 repaints and complete package audits; protected Rupprecht and Matthes remain unchanged. Every other grounded generated, generic, or photographic runtime portrait remains rejected as readiness evidence until a complete sourced roster passes independent review. Adenauer, Epp, and Ironside remain rejected because vanilla actively owns them. Exactly zero custom Event 006 advisor icons/assets/sprites/portrait blocks are present |
...
| --- | --- | --- | --- |
The exact compile-time set contains IW-001 Scotland, IW-004 Brittany, IW-007 Frisia, IW-008 Rhineland, IW-009 Bavaria, IW-017 Corsica, IW-019 Sicily, and IW-184 California.
IW-002, IW-006, IW-010, IW-018, IW-043,
...
Eight attested IDs can supply the three-, four-, five-, and seven-country automatic waves only when the required number independently pass their live host, anchor, reservation, Event-5 collision, chaos-band, force, and transaction gates.
...
The ten-country automatic bands remain unavailable until at least two additional packages are admitted.
...
are currently unreachable under the canonical eight-package gate, and no full
...
| Older audio notes say `6002` derivatives, wrappers, or gameplay firing are absent | Partly superseded. Slot 24, audio 6002, five predicates, Event Log payload, and queued settings-aware playback are implemented. Its hidden-formable and ten-country paths remain unreachable under the current eight-package gate, while FORM-42 remains fail-closed. Audio 6001 and all slot-23 runtime dispatch remain absent, while its dormant ASSET-005 DDS and sprite registration are retained |
| Earlier AFX source says its Level 2 implementation restored runtime admission | Historical implementation evidence only. IW-006 remains outside the canonical eight-package content-attestation set until its grounded roster and complete package receive a fresh audit |
...
| Older curator status for BRI and AJX | BRI is admitted under the current source-locked portrait and package audits. AJX implementation evidence remains useful, but IW-010 is outside the canonical eight-package gate until both grounded roles and the complete package pass current audits |
| Pacific admission handoffs say HOLD/FAIL-CLOSED | The current IW-184 post-wire package audit supersedes HBX's prior withdrawal and records a full static/package PASS with William D. Stephens. HAW and FSM remain outside the canonical eight-package gate. IW-184 attestation and its Event 005-aware capacity witness are implemented, while live allocation evidence remains pending. |
...
| IW-043/IW-058 improvement addendum says neither package is admitted and all assets are absent | Partly superseded implementation evidence. Final CHU/ASY assets and operational transactions exist, but IW-043 and IW-058 remain outside the canonical eight-package content-attestation set |
...
2. Preserve the canonical eight-package content-attestation set consisting of IW-001, IW-004, IW-007, IW-008, IW-009, IW-017, IW-019, and IW-184. Preserve the allocator's
