...
| IW-093 DOX and IW-098 SOK | Signature focus/decision/idea/AI/icon tranche plus bounded leadership/opening politics implemented; both remain fail-closed | Exact dormant-tag/origin/anchor predicates, setup/final-validation/cleanup dispatch, host-capital survival proofs, visible values, 43 focuses, 16 paid decisions, four staged ideas, ten AI profiles, and 57 registered static icons exist. Prempeh II has an approved male HOI4-style portrait and two Event 006 leader roles; post-cutover SOK reuses vanilla Siddiq without duplication. Both receive centralized institutional opening politics only after admitted setup. Runtime content attestation and SCN-008 admission remain absent. Pre-cutover Hasan, exact period flags, route politics, starting forces, diplomacy, and FORM-24/25 readiness remain blocked. No advisor assets belong to either package |
...
| `006_iw093_iw098_signature_packages_improvement_addendum_2026_07_18.md` | Accepted design; signature tranche implemented, country admission partial | Defines the Asante and Sokoto value systems, concrete transaction costs, route locks, AI, host relations, FORM-24/25 disposition, origin separation, and zero-advisor-asset boundary. The focus/decision/idea/AI/icon tranche is implemented; identity, force, formable, and admission work remains queued |
| `006_iw093_iw098_country_package_audit_2026_07_18.md` and scripted architecture handoff | Historical fail-closed evidence pending the 2026-07-19 audit | Exact DOX/SOK identity and map bindings, package triggers/effects/dispatch, 43 focuses, 16 decisions, four ideas, ten AI profiles, and 57 wired icons pass bounded source review without granting runtime content attestation. Prempeh II is resolved separately; FORM-24/25, pre-cutover Hasan, flags, starting forces, politics, and SCN-008 admission remain blocked |
...
| `006_iw093_iw098_country_package_reaudit_2026_07_19.md` | Current bounded country-package evidence | Confirms identity/map/focus/decision/idea/AI/icon coverage, records the parent leadership and opening-politics remediation, and preserves the remaining Hasan, flag, force, diplomacy, FORM-24/25, route-politics, and admission blockers |
