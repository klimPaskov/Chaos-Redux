...
| RHI/BAY Level 2 implementation and final admission audits | IW-008 admitted; IW-009 gameplay retained but visually closed | `006_iw008_rhineland_country_package_reaudit_2026_07_24.md`, the Wilhelm Marx audit, the von Zangen audit and transfer re-audit, and the reconciled portrait packages are the current admission authority for RHI. BAY retains its complete gameplay, protected Rupprecht, and approved Heinrich Held portrait, but its commander replacement still requires an approved source-locked repaint, runtime wiring, and a fresh package audit |
