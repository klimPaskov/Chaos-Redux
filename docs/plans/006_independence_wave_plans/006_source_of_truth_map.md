...
| IW-001/002/004/006/007/008/009/010 | Gameplay retained; runtime admission closed | AGX's two-person sourced roster passes its bounded static package audit. SCO, RHI, and BAY each retain valid sourced roles but require different sourced replacements for Ironside, Adenauer, and Epp because vanilla recruits those men as active ENG/GER characters. WLS, BRI, AFX, and AJX retain other unresolved grounded roles. All eight IDs remain outside runtime content attestation pending exact roster completion and package re-audit |
| IW-017 COR, IW-018 ARX, and IW-019 ASX | Gameplay retained; runtime admission closed | COR and ASX have complete sourced male rosters and pass their bounded static package audits; Luigi Rizzo has no vanilla character or portrait owner. ARX retains sourced Emilio Lussu but its crown-route and command roles remain unresolved. FORM-05 gameplay remains implemented, while all three IDs stay outside the deliberately empty runtime attestation pending parent admission work |
...
| Static visual package | Non-portrait assets materially produced; portrait replacement active | Static icons, report scenes, researched/generated flat flags, formable flags, and super-event images remain. The current sourced-treatment ledger has 24 source/visual treatments: 21 pass subject ownership, while Adenauer, Epp, and Ironside are retained only as rejected evidence because vanilla recruits them. Generated portrait files for grounded polities remain runtime artifacts awaiting sourced replacement and are not visual-readiness evidence. Exactly zero custom Event 006 advisor icons/assets/sprites/portrait blocks are present; protected BAY/RHI hashes remain unchanged |
...
Ironside; processing or pixel equality does not override those rejections.
...
| `006_iw093_iw098_country_package_audit_2026_07_18.md` and scripted architecture handoff | Historical fail-closed evidence superseded by the 2026-07-19 leadership/force tranche and 2026-07-22 source gate | Exact DOX/SOK identity and map bindings, package triggers/effects/dispatch, 43 focuses, 16 decisions, four ideas, ten AI profiles, and 57 wired icons passed bounded source review without granting runtime content attestation. Later gameplay includes Prempeh II, date-aware Siddiq reuse, four male corps commanders, and exact one-time force mapping, but only Prempeh II has compliant sourced portrait evidence. FORM-24/25, both Sokoto leaders, all four commanders, flags, and SCN-008 admission remain blocked |
| `006_iw093_iw098_source_reaudit_2026_07_19.md` and `iw093_asante_prempeh_ii_2026_07_18/` | Current sourced-visual evidence for Prempeh II only | The TNA/OGL Prempeh II source anchors the approved identity-preserving male HOI4 portrait, runtime DDS, sprite, dormant character, manifest, prompt, and comparison sheet in `e0e85c832`. The rejected grayscale predecessor remains evidence only. Vanilla Siddiq is a generic portrait rather than sourced likeness evidence; Hasan, Siddiq, and exact period Asante/Sokoto flag geometry remain blocked. No advisor assets were produced |
