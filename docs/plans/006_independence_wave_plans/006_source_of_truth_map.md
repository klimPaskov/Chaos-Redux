...
| Static visual package | Non-portrait assets materially produced; grounded portrait replacement active | Static icons, report scenes, researched/generated flat flags, formable flags, super-event images, and the Statehood Ledger status-panel/animation package remain. The reference shelf preserves 43 pre-resize and 80 normalized source-derived portrait PNGs, including the unapproved IW-093 and IW-018 Vernè candidates and their provenance boundaries. Scotland, Brittany, Frisia, Rhineland, Corsica, Sicily, and California have independently approved and wired sourced real-male, identity-preserving HOI4 repaints and complete package audits; protected Rupprecht and Matthes remain unchanged. Every other grounded generated, generic, or photographic runtime portrait remains rejected as readiness evidence until a complete sourced roster passes independent review. Adenauer, Epp, and Ironside remain rejected because vanilla actively owns them. Exactly zero custom Event 006 advisor icons or advisor portrait/sprite blocks are present |
