...
- Opinion and assets: `common/opinion_modifiers/fallout_old_doctor_trial_opinion_modifiers.txt`, `interface/fallout_world_end.gfx`, `gfx/event_pictures/old_doctor_trial/report_event_fallout_old_doctor_trial.dds`, and `docs/assets/901_old_doctor_trial/`.
