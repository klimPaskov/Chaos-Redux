...
- Candidate row: `common/scripted_effects/fallout_consolidated_effects.txt`, candidate `324`.
...
- Constants: `fallout_event_324_*` groups in `common/script_constants/fallout_consolidated_constants.txt`.
