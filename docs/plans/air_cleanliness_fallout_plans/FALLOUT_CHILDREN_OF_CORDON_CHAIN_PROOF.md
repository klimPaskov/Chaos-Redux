...
The chain is Fallout-owned and dormant. Gameplay source lives in `events/fallout_world_end_events.txt`, `common/scripted_triggers/fallout_consolidated_triggers.txt`, `common/scripted_effects/fallout_consolidated_effects.txt`, the Children of the Cordon constants, the dedicated dynamic modifiers, and the candidate producer block in `common/scripted_effects/fallout_consolidated_effects.txt`.
