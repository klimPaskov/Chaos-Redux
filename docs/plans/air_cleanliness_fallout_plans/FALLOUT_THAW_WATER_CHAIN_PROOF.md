...
- Constants: `common/script_constants/fallout_world_end_thaw_water_constants.txt`
- Dynamic modifiers: `common/dynamic_modifiers/fallout_world_end_thaw_water_dynamic_modifiers.txt`
- Triggers: `common/scripted_triggers/fallout_world_end_thaw_water_event_triggers.txt`
- Effects: `common/scripted_effects/fallout_world_end_thaw_water_event_effects.txt`
...
- Localisation: `localisation/english/fallout_world_end_thaw_water_l_english.yml`
- Asset wiring: `interface/fallout_world_end.gfx`, `gfx/event_pictures/fallout_world_end/report_event_fallout_thaw_water.dds`, and the dedicated source and manifest package
