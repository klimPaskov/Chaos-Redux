...
- Asset wiring: `interface/fallout_world_end.gfx`, `gfx/event_pictures/fallout/report_event_fallout_thaw_water.dds`, and the dedicated source and manifest package
