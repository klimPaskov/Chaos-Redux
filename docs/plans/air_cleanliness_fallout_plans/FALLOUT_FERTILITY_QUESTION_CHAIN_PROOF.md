...
- Opinion and assets: `common/opinion_modifiers/fallout_fertility_question_opinion_modifiers.txt`, `interface/fallout_world_end.gfx`, `gfx/event_pictures/fallout/report_event_fallout_fertility_question.dds`, and `docs/assets/894_fertility_question/`.
