...
| Doctor's Coup art and workbook | `docs/assets/705_doctors_coup/manifest.md`, `interface/fallout_world_end.gfx`, `gfx/event_pictures/fallout_doctors_coup/report_event_fallout_doctors_coup.dds`, `docs/spreadsheets/chaos_redux_events_catalog.xlsx`, and exported row `FALLOUT-705` at `docs/spreadsheets/chaos_redux_events_catalog.csv:771` |
...
| The Adaptation Rite opinion and assets | `common/opinion_modifiers/fallout_adaptation_rite_opinion_modifiers.txt`, `docs/assets/908_adaptation_rite/manifest.md`, `interface/fallout_world_end.gfx`, and `gfx/event_pictures/adaptation_rite/report_event_fallout_adaptation_rite.dds` |
...
| Children of Two Settlements opinion and assets | `common/opinion_modifiers/fallout_children_of_two_settlements_opinion_modifiers.txt`, `docs/assets/915_children_of_two_settlements/manifest.md`, `interface/fallout_world_end.gfx`, and `gfx/event_pictures/children_of_two_settlements/report_event_fallout_children_of_two_settlements.dds` |
