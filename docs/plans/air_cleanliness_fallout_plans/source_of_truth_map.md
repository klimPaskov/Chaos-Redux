...
The reviewed global-survival pilot currently includes Shelter Marriage Law candidate `303`, Black Start candidate `310`, First Streetlight candidate `317`, Working Elevator candidate `324`, Sealed Warehouse candidate `331`, Dead City Permit candidate `338`, and their dedicated specs, proofs, localisation, Event Log, and asset packages.
The current documented pilot total is twenty-two rows and 226 defined blocks, all dormant and outside release-floor credit.
...
The historical pilot-count wording above is superseded by the Dead City Permit correction.
The current reviewed total is twenty-two rows and 226 defined blocks, all dormant and outside release-floor credit.
