...
Status: current implementation map, reconciled 2026-08-01 after The Pirate Amnesty tranche. Fallout remains incomplete and dormant where the proof ledger says so.
...
| Air Winter phases and consequences | `docs/systems/air_cleanliness/winter.md` and tranche proofs | `common/scripted_effects/air_cleanliness_winter_effects.txt`, `common/scripted_effects/air_cleanliness_winter_visual_effects.txt`, Air Winter constants, decisions, mapmodes, and ordinary-map entities |
| Fallout request and transition | `FALLOUT_TRANSITION_ARCHITECTURE.md` and current status | `common/scripted_effects/fallout_world_end_effects.txt`, `common/scripted_triggers/fallout_world_end_triggers.txt`, and the post-consequence blocks in `events/fallout_world_end_events.txt` |
...
The Open the Sealed City workbook row is recorded with identity `FALLOUT-740` and `Needs Testing` status.
...
| Mountain Pass Census art | `docs/assets/635_mountain_pass_census/manifest.json`, `interface/fallout_world_end.gfx`, and `gfx/event_pictures/fallout/report_event_fallout_mountain_pass_census.dds` |
...
| The Second Dust Bowl art | `docs/assets/656_second_dust_bowl/manifest.md`, `docs/assets/656_second_dust_bowl/gfx_handoff.md`, `interface/fallout_world_end.gfx`, and `gfx/event_pictures/fallout/report_event_fallout_second_dust_bowl.dds` |
...
| Doctor's Coup gameplay | `events/fallout_world_end_events.txt`, `common/scripted_triggers/fallout_world_end_doctors_coup_event_triggers.txt`, `common/scripted_effects/fallout_world_end_doctors_coup_event_effects.txt`, and `common/dynamic_modifiers/fallout_world_end_doctors_coup_dynamic_modifiers.txt` |
| Doctor's Coup constants and registry | `common/script_constants/fallout_world_end_doctors_coup_constants.txt`, `common/script_constants/fallout_world_end_event_constants.txt`, and `common/scripted_effects/fallout_world_end_event_candidate_effects.txt` |
| Doctor's Coup localisation and Event Log | `localisation/english/fallout_world_end_doctors_coup_l_english.yml`, `common/scripted_localisation/fallout_world_end_doctors_coup_event_log_scripted_localisation.txt`, and `common/scripted_localisation/chaosx_scripted_localisation_events_log.txt` |
| Doctor's Coup art and workbook | `docs/assets/705_doctors_coup/manifest.md`, `interface/fallout_world_end.gfx`, `gfx/event_pictures/fallout/report_event_fallout_doctors_coup.dds`, `docs/spreadsheets/chaos_redux_events_catalog.xlsx`, and exported row `FALLOUT-705` at `docs/spreadsheets/chaos_redux_events_catalog.csv:771` |
...
| The Returning Disease gameplay | `events/fallout_world_end_events.txt`, `common/scripted_triggers/fallout_world_end_returning_disease_event_triggers.txt`, `common/scripted_effects/fallout_world_end_returning_disease_event_effects.txt`, and `common/dynamic_modifiers/fallout_world_end_returning_disease_dynamic_modifiers.txt` |
| The Returning Disease constants and registry | `common/script_constants/fallout_world_end_returning_disease_constants.txt`, `common/script_constants/fallout_world_end_event_constants.txt`, and `common/scripted_effects/fallout_world_end_event_candidate_effects.txt` |
| The Returning Disease localisation and Event Log | `localisation/english/fallout_world_end_returning_disease_l_english.yml`, `common/scripted_localisation/fallout_world_end_returning_disease_event_log_scripted_localisation.txt`, and `common/scripted_localisation/chaosx_scripted_localisation_events_log.txt` |
| The Returning Disease art and workbook | `docs/assets/712_returning_disease/manifest.md`, `interface/fallout_world_end.gfx`, `gfx/event_pictures/fallout/report_event_fallout_returning_disease.dds`, and `docs/spreadsheets/chaos_redux_events_catalog.xlsx` |
...
| The Engineer Franchise art and workbook | `docs/assets/796_engineer_franchise/manifest.md`, `interface/fallout_world_end.gfx`, `gfx/event_pictures/fallout/report_event_fallout_engineer_franchise.dds`, `docs/spreadsheets/chaos_redux_events_catalog.xlsx`, and exported row `FALLOUT-796` |
...
| Load Shedding gameplay | `events/fallout_world_end_events.txt`, `common/scripted_triggers/fallout_world_end_load_shedding_event_triggers.txt`, `common/scripted_effects/fallout_world_end_load_shedding_event_effects.txt`, and `common/dynamic_modifiers/fallout_world_end_load_shedding_dynamic_modifiers.txt` |
| Load Shedding constants and registry | `common/script_constants/fallout_world_end_load_shedding_constants.txt`, `common/script_constants/fallout_world_end_event_constants.txt`, and `common/scripted_effects/fallout_world_end_event_candidate_effects.txt` |
...
| Load Shedding art and workbook | `docs/assets/803_load_shedding/manifest.md`, `interface/fallout_world_end.gfx`, `gfx/event_pictures/fallout/report_event_fallout_load_shedding.dds`, `docs/spreadsheets/chaos_redux_events_catalog.xlsx`, and exported row `FALLOUT-803` |
...
| Reactor Shift art and workbook | `docs/assets/810_reactor_shift/manifest.md`, `interface/fallout_world_end.gfx`, `gfx/event_pictures/fallout/report_event_fallout_reactor_shift.dds`, `docs/spreadsheets/chaos_redux_events_catalog.xlsx`, and exported row `FALLOUT-810` |
...
| Patent After the End art and workbook | `docs/assets/817_patent_after_end/manifest.md`, `interface/fallout_world_end.gfx`, `gfx/event_pictures/fallout/report_event_fallout_patent_after_end.dds`, `docs/spreadsheets/chaos_redux_events_catalog.xlsx`, and exported row `FALLOUT-817` |
...
| The Grid Vote art and workbook | `docs/assets/824_grid_vote/manifest.md`, `interface/fallout_world_end.gfx`, `gfx/event_pictures/fallout/report_event_fallout_grid_vote.dds`, `docs/spreadsheets/chaos_redux_events_catalog.xlsx`, and exported row `FALLOUT-824` |
...
| The Failed Calculation art and workbook | `docs/assets/831_failed_calculation/manifest.md`, `interface/fallout_world_end.gfx`, `gfx/event_pictures/fallout/report_event_fallout_failed_calculation.dds`, `docs/spreadsheets/chaos_redux_events_catalog.xlsx`, and exported row `FALLOUT-831` |
...
| Laboratory Citizenship art and workbook | `docs/assets/838_laboratory_citizenship/manifest.md`, `interface/fallout_world_end.gfx`, `gfx/event_pictures/fallout/report_event_fallout_laboratory_citizenship.dds`, `docs/spreadsheets/chaos_redux_events_catalog.xlsx`, and exported row `FALLOUT-838` |
...
| The Machine Suggests art and workbook | `docs/assets/845_machine_suggests/manifest.md`, `interface/fallout_world_end.gfx`, `gfx/event_pictures/fallout/report_event_fallout_machine_suggests.dds`, `docs/spreadsheets/chaos_redux_events_catalog.xlsx`, and exported row `FALLOUT-845` |
...
| The First Regional Standard gameplay | `events/fallout_world_end_events.txt`, `common/scripted_triggers/fallout_world_end_first_regional_standard_event_triggers.txt`, `common/scripted_effects/fallout_world_end_first_regional_standard_event_effects.txt`, and `common/dynamic_modifiers/fallout_world_end_first_regional_standard_dynamic_modifiers.txt` |
| The First Regional Standard constants and registry | `common/script_constants/fallout_world_end_first_regional_standard_constants.txt`, `common/script_constants/fallout_world_end_event_constants.txt`, and `common/scripted_effects/fallout_world_end_event_candidate_effects.txt` |
...
| The First Regional Standard art and workbook | `docs/assets/852_first_regional_standard/manifest.md`, `interface/fallout_world_end.gfx`, `gfx/event_pictures/fallout/report_event_fallout_first_regional_standard.dds`, `docs/spreadsheets/chaos_redux_events_catalog.xlsx`, and exported row `FALLOUT-852` |
...
| The Repair Charter art and workbook | `docs/assets/859_repair_charter/manifest.md`, `interface/fallout_world_end.gfx`, `gfx/event_pictures/fallout/report_event_fallout_repair_charter.dds`, `docs/spreadsheets/chaos_redux_events_catalog.xlsx`, and exported row `FALLOUT-859` |
...
| The Power as Citizenship art and workbook | `docs/assets/866_power_citizenship/manifest.md`, `interface/fallout_world_end.gfx`, `gfx/event_pictures/fallout/report_event_fallout_power_citizenship.dds`, `docs/spreadsheets/chaos_redux_events_catalog.xlsx`, and exported row `FALLOUT-866` |
...
| The Name We Choose art and workbook | `docs/assets/873_name_we_choose/manifest.md`, `interface/fallout_world_end.gfx`, `gfx/event_pictures/fallout/report_event_fallout_name_we_choose.dds`, `docs/spreadsheets/chaos_redux_events_catalog.xlsx`, and exported row `FALLOUT-873` |
...
| The Clinic or Council gameplay | `events/fallout_world_end_events.txt`, `common/scripted_triggers/fallout_world_end_clinic_or_council_event_triggers.txt`, `common/scripted_effects/fallout_world_end_clinic_or_council_event_effects.txt`, and `common/dynamic_modifiers/fallout_world_end_clinic_or_council_dynamic_modifiers.txt` |
| The Clinic or Council constants and registry | `common/script_constants/fallout_world_end_clinic_or_council_constants.txt`, `common/script_constants/fallout_world_end_event_constants.txt`, and `common/scripted_effects/fallout_world_end_event_candidate_effects.txt` |
...
| The Clinic or Council art and workbook | `docs/assets/880_clinic_or_council/manifest.md`, `interface/fallout_world_end.gfx`, `gfx/event_pictures/fallout/report_event_fallout_clinic_or_council.dds`, `docs/spreadsheets/chaos_redux_events_catalog.xlsx`, and exported row `FALLOUT-880` |
...
| The Mixed Settlement Petition art and workbook | `docs/assets/887_mixed_settlement/manifest.md`, `interface/fallout_world_end.gfx`, `gfx/event_pictures/fallout/report_event_fallout_mixed_settlement.dds`, `docs/spreadsheets/chaos_redux_events_catalog.xlsx`, and exported row `FALLOUT-887` |
...
| The Fertility Question art and workbook | `docs/assets/894_fertility_question/manifest.md`, `interface/fallout_world_end.gfx`, `gfx/event_pictures/fallout/report_event_fallout_fertility_question.dds`, `docs/spreadsheets/chaos_redux_events_catalog.xlsx`, and exported row `FALLOUT-894` |
...
| The Old Doctor's Trial opinion and assets | `common/opinion_modifiers/fallout_old_doctor_trial_opinion_modifiers.txt`, `docs/assets/901_old_doctor_trial/manifest.md`, `interface/fallout_world_end.gfx`, and `gfx/event_pictures/fallout/report_event_fallout_old_doctor_trial.dds` |
...
| The Adaptation Rite gameplay | `events/fallout_world_end_events.txt`, `common/scripted_triggers/fallout_world_end_adaptation_rite_event_triggers.txt`, `common/scripted_effects/fallout_world_end_adaptation_rite_event_effects.txt`, and `common/dynamic_modifiers/fallout_world_end_adaptation_rite_dynamic_modifiers.txt` |
| The Adaptation Rite constants and registry | `common/script_constants/fallout_world_end_adaptation_rite_constants.txt`, `common/script_constants/fallout_world_end_event_constants.txt`, and `common/scripted_effects/fallout_world_end_event_candidate_effects.txt` |
| The Adaptation Rite localisation and Event Log | `localisation/english/fallout_world_end_adaptation_rite_l_english.yml`, `common/scripted_localisation/fallout_world_end_adaptation_rite_event_log_scripted_localisation.txt`, and `common/scripted_localisation/chaosx_scripted_localisation_events_log.txt` |
| The Adaptation Rite opinion and assets | `common/opinion_modifiers/fallout_adaptation_rite_opinion_modifiers.txt`, `docs/assets/908_adaptation_rite/manifest.md`, `interface/fallout_world_end.gfx`, and `gfx/event_pictures/fallout/report_event_fallout_adaptation_rite.dds` |
...
| Children of Two Settlements gameplay | `events/fallout_world_end_events.txt`, `common/scripted_triggers/fallout_world_end_children_of_two_settlements_event_triggers.txt`, `common/scripted_effects/fallout_world_end_children_of_two_settlements_event_effects.txt`, and `common/dynamic_modifiers/fallout_world_end_children_of_two_settlements_dynamic_modifiers.txt` |
| Children of Two Settlements constants and registry | `common/script_constants/fallout_world_end_children_of_two_settlements_constants.txt`, `common/script_constants/fallout_world_end_event_constants.txt`, and `common/scripted_effects/fallout_world_end_event_candidate_effects.txt` |
| Children of Two Settlements localisation and Event Log | `localisation/english/fallout_world_end_children_of_two_settlements_l_english.yml`, `common/scripted_localisation/fallout_world_end_children_of_two_settlements_event_log_scripted_localisation.txt`, and `common/scripted_localisation/chaosx_scripted_localisation_events_log.txt` |
| Children of Two Settlements opinion and assets | `common/opinion_modifiers/fallout_children_of_two_settlements_opinion_modifiers.txt`, `docs/assets/915_children_of_two_settlements/manifest.md`, `interface/fallout_world_end.gfx`, and `gfx/event_pictures/fallout/report_event_fallout_children_of_two_settlements.dds` |
...
| The Cohort's First Ballot gameplay | `events/fallout_world_end_events.txt`, `common/scripted_triggers/fallout_world_end_cohorts_first_ballot_event_triggers.txt`, `common/scripted_effects/fallout_world_end_cohorts_first_ballot_event_effects.txt`, and `common/dynamic_modifiers/fallout_world_end_cohorts_first_ballot_dynamic_modifiers.txt` |
| The Cohort's First Ballot constants and registry | `common/script_constants/fallout_world_end_cohorts_first_ballot_constants.txt`, `common/script_constants/fallout_world_end_event_constants.txt`, and `common/scripted_effects/fallout_world_end_event_candidate_effects.txt` |
