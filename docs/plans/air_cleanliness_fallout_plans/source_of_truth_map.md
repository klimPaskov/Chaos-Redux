...
| Reviewed global-survival pilot contract | `specs/13_reviewed_global_survival_pilots.md`, `specs/14_reviewed_global_survival_generation.md`, `specs/15_reviewed_global_survival_education.md`, and the reviewed addenda | candidate 269, 282, and 289 constants, registry rows, delayed effects, event blocks, Event Log histories, localisation, and dedicated asset packages |
