...
| Fallout event scheduler | `01_living_world_event_ecosystem.md`, `FALLOUT_EVENT_SCHEDULER_NUMERICAL_CONTRACT_PROPOSAL.md`, `FALLOUT_EVENT_SCHEDULER_PROOF.md`, and `FALLOUT_EVENT_RELEASE_AUDIT_CONTRACT.md` | Fallout constants, coordinator effects and triggers, candidate registry, delayed queue, ordinary receipt, dispatch envelope, and dormant release audit |
