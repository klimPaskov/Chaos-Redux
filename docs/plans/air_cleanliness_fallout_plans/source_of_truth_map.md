...
The historical pilot-count wording above is superseded by the Dead City Permit and Manual Nobody Read corrections.
The current reviewed total is twenty-three rows and 233 defined blocks, all dormant and outside release-floor credit.
