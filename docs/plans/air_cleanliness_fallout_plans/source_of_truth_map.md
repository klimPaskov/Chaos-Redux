...
| Fallout event scheduler | `01_living_world_event_ecosystem.md`, `FALLOUT_EVENT_SCHEDULER_NUMERICAL_CONTRACT_PROPOSAL.md`, `FALLOUT_EVENT_SCHEDULER_PROOF.md`, `FALLOUT_EVENT_RELEASE_AUDIT_CONTRACT.md`, `2026-07-26_major_arc_candidate_reservation_addendum.md`, `FALLOUT_YEAR_ZERO_MAJOR_ARC_STAGE_PILOT_PROOF.md`, and `2026-07-26_relationship_candidate_reservation_addendum.md` | Fallout constants, coordinator effects and triggers, candidate registry, delayed queue, ordinary receipt, major-arc and bilateral reservation substrates, Year Zero major-stage dispatch, dispatch envelope, and dormant release audit |
