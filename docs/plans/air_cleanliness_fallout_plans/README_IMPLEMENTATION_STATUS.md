...
The old-world diplomacy proof gate also remains unresolved. Market access is no longer one of its missing surfaces. Docking validation, lend lease, ordinary trade, intelligence, and expeditionary return still block map return until their required postconditions are genuinely satisfied.
