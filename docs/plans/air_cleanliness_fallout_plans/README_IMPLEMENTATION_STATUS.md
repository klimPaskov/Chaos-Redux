...
The latest dormant tranche is The New Year Without Fireworks at `chaosx.fallout.649` through `chaosx.fallout.655`, candidate `649`, transaction `710064`, route `7164`, and Event Log history `9170`. It adds one East Asian country-only row with four human and hidden-AI-parity branches, deterministic 21-day result and 330-day anniversary callback grading, Deaths-backed failure, durable ledgers, cleanup, dedicated localisation, Event Log routing, dedicated report art, and a workbook catalogue row. The reviewed ordinary pilot now has `64` rows and `530` defined blocks. Countable release-floor credit remains `0 of 660` while both scheduler activation flags are unset. The chain remains dormant while scheduler dispatch, host authority, save recovery, delayed queue delivery, multiplayer behavior, runtime Event Log delivery, and player-visible art remain unproven.
