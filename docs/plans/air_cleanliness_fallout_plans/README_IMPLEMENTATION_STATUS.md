...
The latest dormant tranche is The Battalion's Bread List at `chaosx.fallout.677` through `chaosx.fallout.683`, candidate `677`, transaction `710068`, route `7168`, and survivor Event Log history `9174`. Its source package defines one Food Compact granary-state row that requires a current Work for Rations policy receipt, minimum Cohesion, a meaningful fielded army, produced Air Winter evidence, and at least one complete affordable branch. The protected issue, equal measure, field requisition, and rear-echelon stand-down routes share deterministic `28` day result and `210` day callback contracts, hidden-AI parity, bounded Deaths failure, building damage, military readiness, civil-military ledgers, cleanup, dedicated localisation, survivor Event Log routing, dedicated report art, and a reviewed source specification. Stand-down uses a durable one-use personnel receipt and does not delete a division or refund equipment. The reviewed ordinary pilot now has `68` rows and `558` defined blocks through `chaosx.fallout.683`. Countable release-floor credit remains `0 of 660` while both scheduler activation flags are unset. The wider pilot still has stale cleanup and live option-competition priority gaps in earlier reviewed rows. Scheduler dispatch, host authority, save recovery, delayed queue delivery, multiplayer behavior, runtime Event Log delivery, Deaths readback, player-visible art, and the exact all-valid-province sweep remain unproven.
