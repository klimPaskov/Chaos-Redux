...
The Fallout lock now disables Air Cleanliness durably and clears already-applied Air Cleanliness state modifiers and country pressure ideas immediately. A failed dormant manual sweep restores the ordinary modifier surface before the regular mechanic resumes.
