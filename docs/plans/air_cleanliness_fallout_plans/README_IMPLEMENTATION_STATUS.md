...
11. Complete the accepted Ash-week orientation contract with the other nineteen blocks, exact capital repair, regional and memory coverage, government and character registries, callers, logs, details, and audits. Do not wire its caller until successor allocation, player continuation, and the required candidate registries are proven. Do not enable the living-world scheduler. The schema-3 live ledger and national pilot remain dormant.
