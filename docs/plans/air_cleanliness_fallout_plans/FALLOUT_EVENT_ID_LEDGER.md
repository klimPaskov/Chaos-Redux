...
Defined living-world pilot blocks: `24`, covering the dormant food-security blocks at `100` through `106`, the River Intake blocks at `107` through `113` and `121`, the hidden food companions at `123` through `126`, and the hidden water companions at `1009` through `1013`.
