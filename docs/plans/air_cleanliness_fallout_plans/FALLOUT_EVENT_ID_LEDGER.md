...
The Returning Disease is the Quarantine follow-up to a closed Doctor's Coup memory. It selects one current native Air Winter state where recurring fever pressure is meaningful and freezes owner, controller, generation, shelter, supply, adaptation, exposure, disease, public-health, grievance, treatment capacity, border trust, aid dependence, concealment pressure, and cause-memory receipts. Seal the Infected District, Send Targeted Care Teams, Request the Aid Convoy, and Keep the Outbreak Off the Books share a `24` day result and `210` day callback. Results and callbacks change Air Winter, Supply Access, Medicine, Recognition, Cohesion, public health, grievance, treatment capacity, border trust, aid dependence, concealment pressure, cause memory, bounded Deaths loss, and infrastructure. The chain preserves the Quarantine government archetype, writes survivor-country Event Log memory only, uses dedicated report art, and remains dormant behind the unset scheduler activation flags. Its dedicated proof is `FALLOUT_RETURNING_DISEASE_CHAIN_PROOF.md`.

The Clean Certificate is the Quarantine follow-up to a closed Returning Disease memory. It selects one current native Air Winter state where the North Gate and Ash Ward registers can support a trusted movement seal and freezes owner, controller, generation, shelter, supply, adaptation, exposure, disease, public-health, grievance, inspection capacity, public trust, route dependence, appeal backlog, and cause-memory receipts. Public Service, Paid Inspection, Political Leverage, and Regional Standard share a `30` day result and `180` day certification review. Results and callbacks change Air Winter, Supply Access, Food, Medicine, Scrap, Fuel, Power, Recognition, Cohesion, public health, grievance, inspection capacity, public trust, route dependence, appeal backlog, cause memory, bounded Deaths loss, and certificate memories. The chain preserves the Quarantine government archetype, writes survivor-country Event Log memory only, uses dedicated report art, and remains dormant behind the unset scheduler activation flags. Its dedicated proof is `FALLOUT_CLEAN_CERTIFICATE_CHAIN_PROOF.md`.

Border Inspection Crisis follows a closed Clean Certificate memory. It selects the lowest current native Air Winter state with a foreign neighbor and freezes both state identities, owners, controllers, generation, Air Winter, Supply Access, public-health ledgers, border trust, trade dependency, crossing backlog, and cause memory. Close the Crossing, Admit a Joint Team, Issue Relief Exemptions, and Deploy a Military Screen share a `30` day result and `180` day seasonal review. Results and callbacks change Air Winter, Supply Access, Medicine, Recognition, Cohesion, public health, grievance, border guard capacity, border trust, trade dependency, crossing backlog, bilateral opinion, cause memory, and bounded Deaths loss. The chain preserves the Quarantine government archetype, writes survivor-country Event Log memory only, uses dedicated report art, and remains dormant behind the unset scheduler activation flags. Its dedicated proof is `FALLOUT_BORDER_INSPECTION_CRISIS_CHAIN_PROOF.md`.

## Children of the Cordon tranche

Children of the Cordon follows a completed Border Inspection Crisis memory. It uses candidate `733`, transaction `710076`, route `7184`, history `9182`, and event ids `733` through `739`. The country-only row freezes Cohesion, Food, Shelter, Recognition, generation count, youth trust, and movement law without inventing a state or character target.

Rewrite the Movement Law, Open Service Travel, Continue the Strict Cordon, and Give the Wards Their Own Boards share a `32` day result and a `240` day cohort callback. Results and callbacks change survival resources, Cohesion, Stability, War Support, future-leader pool, youth trust, movement law, and government route. Failure uses the Fallout aftermath Deaths contract, while the maintained or failed modifier and history `9182` preserve the generation memory. The chain remains dormant behind the unset scheduler activation flags and its dedicated proof is `FALLOUT_CHILDREN_OF_CORDON_CHAIN_PROOF.md`.

Open the Sealed City follows a completed Border Inspection Crisis memory into the recovery years. It uses candidate `740`, transaction `710077`, route `7186`, history `9183`, and event ids `740` through `746`. The state-targeted row selects the lowest valid city or large-city state with current Air Winter ledgers, freezes Shelter, Supply Access, Reclamation, Exposure, Disease, infrastructure, population, Food, Medicine, Power, Recognition, and Cohesion, and preserves the Quarantine government archetype.

Reopen the Civic Blocks, Grant Scientific Access, Send a Salvage Command, and Build a Permanent Memorial District share a `35` day result and a `270` day recovery callback. Results and callbacks change Air Winter, Supply Access, Reclamation, Exposure, Disease, state infrastructure evidence, salvage access, memorial readiness, public trust, faction pressure, Cohesion, Stability, War Support, and bounded Deaths loss. The chain remains dormant behind the unset scheduler activation flags and its dedicated proof is `FALLOUT_OPEN_THE_SEALED_CITY_CHAIN_PROOF.md`.

Health Without Borders follows the completed Open the Sealed City memory into the fifth campaign year. It uses candidate `747`, transaction `710078`, route `7188`, history `9184`, and event ids `747` through `753`. The state-targeted row selects the lowest valid city or large-city state, freezes Shelter, Supply Access, Reclamation, Exposure, Disease, infrastructure, population, Food, Medicine, Power, Recognition, and Cohesion, and preserves the Quarantine government archetype.

Sign a Shared Health Compact, License Client Inspections, Adopt an Isolation Doctrine, and Expand Humanitarian Service share a `45` day result and a `365` day regional review. Results and callbacks change regional health ledgers, Air Winter, Supply Access, Shelter, Reclamation, Exposure, Disease, Food, Recognition, Cohesion, Stability, War Support, clinic capacity, border trust, and bounded Deaths loss. The chain remains dormant behind the unset scheduler activation flags and its dedicated proof is `FALLOUT_HEALTH_WITHOUT_BORDERS_CHAIN_PROOF.md`.

Regional Health Compact follows the completed Health Without Borders memory into a later-year bilateral corridor review. It uses candidate `754`, transaction `710079`, route `7190`, history `9185`, and event ids `754` through `760`. The state-targeted row selects the lowest current state with a foreign neighbor, freezes both sides, and preserves the Quarantine government archetype.

Share the Clinic Registers, Exchange Clinic Teams, Grant Corridor Authority, and Enforce a Border Quarantine share a `42` day result and a `300` day callback. Results and callbacks change Air Winter, Supply Access, health-authority ledgers, Corridor Security, Partner Trust, Refugee Pressure, Border Fatigue, bilateral opinion, Stability, War Support, and bounded Deaths loss. The chain remains dormant behind the unset scheduler activation flags and its dedicated proof is `FALLOUT_REGIONAL_HEALTH_COMPACT_CHAIN_PROOF.md`.

The Envoy at the Gate follows the Congo Green Basin mutant-polity memory into a first formal foreign contact. It uses candidate `761`, transaction `710080`, route `7192`, history `9186`, and event ids `761` through `767`. The state-targeted row selects the lowest current Basin state with a foreign neighbor, freezes both sides, and requires dedicated civic-legitimacy and external-pressure ledgers. Open recognition, voluntary medical inspection, symbolic meeting, and refusal share a `42` day result and a `300` day callback. Results and callbacks change Air Winter, Supply Access, envoy ledgers, bilateral opinion, Cohesion, Recognition, Stability, War Support, and bounded Deaths loss. The chain remains dormant behind the unset scheduler activation flags and its dedicated proof is `FALLOUT_MUTANT_ENVOY_GATE_CHAIN_PROOF.md`.
...
## The First Red Line tranche

The First Red Line adds dormant suffixes `684` through `690` with candidate id `684`, transaction key `710069`, route `7170`, and history `9175`.

The human opening is `684`, the hidden-AI opening is `685`, the human and hidden-AI delayed results are `686` and `687`, the human and hidden-AI callbacks are `688` and `689`, and cleanup is `690`.

The row requires a current-generation owner-controlled Quarantine state with a produced Air Winter snapshot, Shelter Capacity, Supply Access, Adaptation, bounded Exposure and Disease Pressure, surviving population, and at least one affordable branch. It chooses the lowest eligible native state id.

The chain carries Strict Cordon, Medical Checkpoints, Controlled Evacuation, and Local Self-Control branches with exact costs, deterministic result and callback grading, a 21-day result, a 180-day callback, bounded Deaths effects, infrastructure damage on result failure, Air Winter ledger effects, durable public-health and cause-memory ledgers, Event Log history `9175`, hidden-AI parity, dedicated report art, and authenticated cleanup. It does not request Fallout, register the Fallout consequence as an ordinary event, create a country, transfer population across states, or add a recurring scheduler.

The asset evidence is `docs/assets/684_first_red_line/` with source, processed PNG, runtime DDS, manifest hashes, and sprite `GFX_report_event_fallout_first_red_line`. The authoritative workbook is `docs/spreadsheets/chaos_redux_events_catalog.xlsx`, and exported row `FALLOUT-684` is present with `Needs Testing` status.
...
## The Returning Disease tranche

The Returning Disease adds dormant suffixes `712` through `718` with candidate id `712`, transaction key `710073`, route `7178`, and history `9179`.

The human opening is `712`, the hidden-AI opening is `713`, the human and hidden-AI delayed results are `714` and `715`, the human and hidden-AI callbacks are `716` and `717`, and cleanup is `718`.

The row requires a current-generation owner-controlled Quarantine state with a completed Doctor's Coup memory, a produced Air Winter snapshot, Shelter Capacity, Supply Access, Adaptation, bounded Exposure and Disease Pressure, surviving population, and at least one affordable branch. It chooses the lowest eligible native state id and freezes the state, owner, controller, generation, Air Winter values, public-health ledgers, grievance, treatment capacity, border trust, aid dependence, concealment pressure, and cause memory.

The chain carries Seal the Infected District, Send Targeted Care Teams, Request the Aid Convoy, and Keep the Outbreak Off the Books branches with exact costs, deterministic result and callback grading, a 24-day result, a 210-day second-winter callback, bounded Deaths effects, infrastructure damage on result failure, Air Winter and Supply Access ledger effects, Quarantine memory flags, Event Log history `9179`, hidden-AI parity, dedicated report art, and authenticated cleanup. It does not change the government archetype, request Fallout, register the Fallout consequence as an ordinary event, create a country, transfer population across states, or add a recurring scheduler.

The asset evidence is `docs/assets/712_returning_disease/` with source, processed PNG, runtime DDS, prompt, manifest, hashes, and review notes. The authoritative workbook is `docs/spreadsheets/chaos_redux_events_catalog.xlsx`, and exported row `FALLOUT-712` is present with `Needs Testing` status at CSV line `772`.

The chain remains dormant and outside release-floor credit. Both scheduler activation flags remain unset. Scheduler dispatch, host authority, save recovery, delayed queue delivery, multiplayer behavior, runtime Event Log rendering, player-visible art, and the exact engine-native all-valid-province thermonuclear sweep remain unproven. The manual survival contract remains a direct `90` to `95` percent prestrike population-loss band. The dedicated proof is `FALLOUT_RETURNING_DISEASE_CHAIN_PROOF.md`.

## The Clean Certificate tranche

The Clean Certificate adds dormant suffixes `719` through `725` with candidate id `719`, transaction key `710074`, route `7180`, and history `9180`.

The human opening is `719`, the hidden-AI opening is `720`, the human and hidden-AI delayed results are `721` and `722`, the human and hidden-AI seasonal reviews are `723` and `724`, and cleanup is `725`.

The row requires a current-generation owner-controlled Quarantine state with a completed Returning Disease memory, a produced Air Winter snapshot, Shelter Capacity, Supply Access, Adaptation, bounded Exposure and Disease Pressure, surviving population, and at least one affordable branch. It chooses the lowest eligible native state id and freezes the state, owner, controller, generation, Air Winter values, public-health ledgers, grievance, inspection capacity, public trust, route dependence, appeal backlog, and cause memory.

The chain carries Public Service, Paid Inspection, Political Leverage, and Regional Standard branches with exact costs, deterministic result and certification-review grading, a 30-day result, a 180-day review, bounded Deaths effects, Air Winter and Supply Access ledger effects, Quarantine certificate memories, Event Log history `9180`, hidden-AI parity, dedicated report art, and authenticated cleanup. It does not change the government archetype, request Fallout, register the Fallout consequence as an ordinary event, create a country, transfer population across states, or add a recurring scheduler.
