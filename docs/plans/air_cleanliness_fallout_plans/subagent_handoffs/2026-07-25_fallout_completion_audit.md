...
Relevant working-tree files were already modified during the audit: `common/scripted_effects/fallout_consolidated_effects.txt`, `FALLOUT_EVENT_ID_LEDGER.md`, and `source_of_truth_map.md`.
...
- Rehashed `common/scripted_effects/fallout_consolidated_effects.txt`; SHA-256 is `D803BD0972FCE3F69DB50829687A2C35733FCC5018CC7F582BB6A493216089E3`, matching the manual proof.
