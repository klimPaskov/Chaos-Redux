...
| S06-04 | Strategic raid, operative planting, battlefield dissemination, and sabotage preserve route identity and agent lifecycle. | Delivery adapters and tests. | in progress; strategic raids, four operative releases, four native exact-state battlefield land raids, and four exact-state food/water/medical sabotage decisions preserve route identity and enter the ordinary lifecycle; final cross-route package scenarios remain open |
