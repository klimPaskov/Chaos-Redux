...
Chaos Warfare doctrine is an escalation path. Theater Contamination and Terminal Hazard may increase biological seed potency, intensity growth, spread pressure, deaths, duration, medical saturation, preparation speed, and aggressive AI willingness. Terminal Hazard may reduce Condemnation after attribution, subject to public-harm floors. Doctrine may not reduce payload debit, evidence, attribution, deaths history, contamination history, medical history, confirmed-use history, domestic war-support penalties, accident risk already incurred, or biological-use counters.
