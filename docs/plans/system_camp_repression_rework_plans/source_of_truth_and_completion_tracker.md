...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `ASSET-SHARED-CATEGORY` | Category/open controls | `GFX_decision_category_repair_repression_ledger`, `GFX_decision_open_repression_ledger`; Gulag/Mass Repression and Colonial Labor Burden category icons only if separate categories are actually implemented. | [x] | [ ] | — | — | — |
...
| `DOC-SYSTEM` | Update current-system documentation with mechanics, interactions, tuning sources, state pools, cleanup, AI, GUI, assets/icons and paths, future suggestions, and abstract chem/bio boundary. | `docs/systems/cbrn_warfare/genocide/genocide_crisis_system.md`; related Deaths/Mengele/chemical/bio docs. | [x] | [ ] | — | — | — |
